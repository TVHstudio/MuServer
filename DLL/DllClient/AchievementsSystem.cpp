...
{
	gInterface.LoadImages("ZtTeam\\Interface\\achievement.tga", 100039, 0x2601, 0x2900, 1);
	gInterface.LoadImages("ZtTeam\\Interface\\as_arrow_top.tga", 100040, 0x2601, 0x2900, 1);
}
