...
void cAutoParty::Work()
{
	...
	gInterface.DrawFormat(eGold, StartX + 10, 110, 210, 3, g_ZtText.GetText(23));
	...
	{
		gInterface.DrawToolTip(StartX + MainWidth - 36-10, 67 + 29 + 2+20, g_ZtText.GetText(24));
	...
	int TitleText = gInterface.DrawFormat(eWhite, StartX + 10, 150, 210, 3, g_ZtText.GetText(25));
	TitleText += gInterface.DrawFormat(eWhite, StartX + 10, TitleText, 210, 3, g_ZtText.GetText(26));
	...
	gInterface.DrawFormat(eGold, StartX+12, ListDrawY + 100, 100, 1, g_ZtText.GetText(27));

	gInterface.DrawFormat(eGold, StartX+20+2, ListDrawY + 100, 100, 1, g_ZtText.GetText(28));

	gInterface.DrawFormat(eGold, StartX+95, ListDrawY + 100, 100, 1, g_ZtText.GetText(29));

	gInterface.DrawFormat(eGold, StartX+115, ListDrawY + 100, 100, 1, g_ZtText.GetText(30));

	gInterface.DrawFormat(eGold, StartX+170, ListDrawY + 100, 100, 1, g_ZtText.GetText(31));

	gInterface.DrawFormat(eGold, StartX+185, ListDrawY + 100, 100, 1, g_ZtText.GetText(32));

	gInterface.DrawFormat(eGold, StartX+200, ListDrawY + 100, 100, 1, g_ZtText.GetText(33));
	...
	gInterface.DrawFormat(eGold, StartX+100, StartY+277, 100, 1, g_ZtText.GetText(34), this->Page,10);
