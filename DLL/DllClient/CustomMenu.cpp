...
void CCustomMenu::Button(DWORD Event)
{
	...
	if(gInterface.CheckWindowZt(ztWinCustomMenu))
	{
		if(gInterface.ButtonZt(Event, eCUSTOM_MENU_CLOSE, false))
		{
			gInterface.CloseWindowZt(ztWinCustomMenu);
			return;
		}

		if(gInterface.ButtonZt(Event, eCUSTOM_MENU_CHANGE_CLASS, false))
		{
			gInterface.CloseWindowZt(ztWinCustomMenu);
			gInterface.OpenWindowZt(ztWinCustomMenuChangeClass);
			return;
		}

		if(gInterface.ButtonZt(Event, eCUSTOM_MENU_RESET, false))
		{
			gInterface.CloseWindowZt(ztWinCustomMenu);
			this->CGResetMenu();
			return;
		...
		if(gInterface.ButtonZt(Event, eCUSTOM_MENU_GRANDRESET, false))
		{
			gInterface.CloseWindowZt(ztWinCustomMenu);
			this->CGGrandMenu();
			return;
		...
		if(gInterface.ButtonZt(Event, eCUSTOM_MENU_PREMIUM, false))
		{
			gInterface.CloseWindowZt(ztWinCustomMenu);
		...
		if(gInterface.ButtonZt(Event, eCUSTOM_MENU_TELEPORT, false))
		{
			gInterface.CloseWindowZt(ztWinCustomMenu);
			g_ZtTeleportEvo.CGDialog();
			return;
		}

		if(gInterface.ButtonZt(Event, eCUSTOM_MENU_ACCSECURITY, false))
		{
			gInterface.CloseWindowZt(ztWinCustomMenu);
	...
	// -> Change Class
	if(gInterface.CheckWindowZt(ztWinCustomMenuChangeClass))
	{
		if(gInterface.ButtonZt(Event, eCHANGECLASS_CLOSE, false))
		{
			gInterface.CloseWindowZt(ztWinCustomMenuChangeClass);
			return;
		}
		// ----
		if(gInterface.ButtonZt(Event, eCHANGECLASS_CHECK1, false))
		{
		...
		if(gInterface.ButtonZt(Event, eCHANGECLASS_CHECK2, false))
		{
			if(gObjUser.ZtCred >= this->iChangeClassCreditPrice)
			{
		...
		// ----
		if(gInterface.ButtonZt(Event, eCHANGECLASS_DK, true))
		{
			this->CGChangeClass(CLASS_KNIGHT);
		}
		else if(gInterface.ButtonZt(Event, eCHANGECLASS_DW, true))
		{
			this->CGChangeClass(CLASS_WIZARD);
		}
		else if(gInterface.ButtonZt(Event, eCHANGECLASS_AE, true))
		{
			this->CGChangeClass(CLASS_ELF);
		}
		else if(gInterface.ButtonZt(Event, eCHANGECLASS_MG, true))
		{
			this->CGChangeClass(CLASS_MAGUMSA);
		}
		else if(gInterface.ButtonZt(Event, eCHANGECLASS_DL, true))
		{
		...
		if(gObjUser.SUM)
		{
			if(gInterface.ButtonZt(Event, eCHANGECLASS_SU, true))
			{
		...
		if(gObjUser.RF)
		{
			if(gInterface.ButtonZt(Event, eCHANGECLASS_RF, true))
			{
