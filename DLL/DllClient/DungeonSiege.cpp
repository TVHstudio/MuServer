...
void CDungeonSiege::BindImages()
{
	...
	gInterface.BindObject(ePT_DUNGEON_SIEGE_GUILD1, zt_SMITHY_TEXT, 170, 21, -1, -1);
	gInterface.BindObject(ePT_DUNGEON_SIEGE_GUILD2, zt_SMITHY_TEXT, 170, 21, -1, -1);
	gInterface.BindObject(ePT_DUNGEON_SIEGE_GUILD3, zt_SMITHY_TEXT, 170, 21, -1, -1);
	gInterface.BindObject(ePT_DUNGEON_SIEGE_GUILD4, zt_SMITHY_TEXT, 170, 21, -1, -1);
	gInterface.BindObject(ePT_DUNGEON_SIEGE_GUILD5, zt_SMITHY_TEXT, 170, 21, -1, -1);
	gInterface.BindObject(ePT_DUNGEON_SIEGE_GUILD6, zt_SMITHY_TEXT, 170, 21, -1, -1);
	gInterface.BindObject(ePT_DUNGEON_SIEGE_GUILD7, zt_SMITHY_TEXT, 170, 21, -1, -1);
	gInterface.BindObject(ePT_DUNGEON_SIEGE_GUILD8, zt_SMITHY_TEXT, 170, 21, -1, -1);
	gInterface.BindObject(ePT_DUNGEON_SIEGE_GUILD9, zt_SMITHY_TEXT, 170, 21, -1, -1);
	gInterface.BindObject(ePT_DUNGEON_SIEGE_GUILD10, zt_SMITHY_TEXT, 170, 21, -1, -1);
	...
	gInterface.BindObject(ePT_DUNGEON_SIEGE_GUILDOWNER, zt_SMITHY_TEXT, 170, 21, -1, -1);
}
...
void CDungeonSiege::Button(DWORD Event)
{
	...
	if(gInterface.ButtonZt(Event, ePT_DUNGEON_SIEGE_REG, true))
	{
	...
	else if(gInterface.ButtonZt(Event, ePT_DUNGEON_SIEGE_OK, false))
	{
		gInterface.CloseWindowZt(ObjWindowsZt::ztWinDungeonSiege);
	}
}
...
void CDungeonSiege::GCNpcInfo(PMSG_GC_DUNGEON_SIEGE_NPC* lpMsg)
{
	...
	gInterface.OpenWindowZt(ObjWindowsZt::ztWinDungeonSiege);
}
