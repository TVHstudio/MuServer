...
{
	gInterface.LoadImages("ZtTeam\\Interface\\EventTimer.tga", 100038, 0x2601, 0x2900, 1);
}
...
void cEventTimer::Draw()
{
	...
	else if(g_ZtLicense.GetCustom())
	{
		pDrawColorButton(0x7880, StartX, DrewY+10, 100, 215, NULL, NULL, Color4f(0, 0, 0, 255));
	}
	...
	else if(g_ZtLicense.CheckUser(eZtUB::NSGames))
	{
		pDrawColorButton(0x7880, StartX, DrewY+10, 100, 200, NULL, NULL, Color4f(0, 0, 0, 255));
	}
	else
	...
	gInterface.DrawFormat(eGold, StartX + 10, DrewY + 10 + 5, 60, 1, g_ZtText.GetText(35));
	...
	gInterface.DrawFormat(eGold, StartX + 10, DrewY + 10 + 5, 60, 1, g_ZtText.GetText(36));
	...
	gInterface.DrawFormat(eGold, StartX + 10, DrewY + 10 + 5, 60, 1, g_ZtText.GetText(37));
	if(CCStart > 300)
	{
		gInterface.DrawFormat(eWhite, StartX + 60+ipluxX, DrewY + 10 + 5, 60, 1, "%2d:%02d:%02d",BC_H,BC_M,BC_C);
	}
	...
	gInterface.DrawFormat(eGold, StartX + 10, DrewY + 10 + 5, 60, 1, g_ZtText.GetText(38));
	if(GDStart > 300)
	{
		gInterface.DrawFormat(eWhite, StartX + 60+ipluxX, DrewY + 10 + 5, 60, 1, "%2d:%02d:%02d",BC_H,BC_M,BC_C);
	}
	...
	DrewY += 15;
	// ----
	if(g_ZtLicense.CheckUser(eZtUB::Local) || g_ZtLicense.CheckUser(eZtUB::Gredy) || g_ZtLicense.CheckUser(eZtUB::GredyLocal) || g_ZtLicense.CheckUser(eZtUB::Gredy2) || g_ZtLicense.CheckUser(eZtUB::NSGames)
		|| g_ZtLicense.CheckUser(eZtUB::ulasevich) || g_ZtLicense.CheckUser(eZtUB::ulasevich2) || g_ZtLicense.GetCustom())
	{
	...
	gInterface.DrawFormat(eGold, StartX + 10, DrewY + 10 + 5, 60, 1, g_ZtText.GetText(39));
	if(WWStart > 300)
	{
		gInterface.DrawFormat(eWhite, StartX + 60+ipluxX, DrewY + 10 + 5, 60, 1, "%2d:%02d:%02d",BC_H,BC_M,BC_C);
	}
	...
	if(g_ZtLicense.CheckUser(eZtUB::Local) || g_ZtLicense.CheckUser(eZtUB::Gredy) || g_ZtLicense.CheckUser(eZtUB::GredyLocal) || g_ZtLicense.CheckUser(eZtUB::Gredy2) ||
		g_ZtLicense.CheckUser(eZtUB::Artem) || g_ZtLicense.CheckUser(eZtUB::Artem2) || g_ZtLicense.CheckUser(eZtUB::NSGames) || g_ZtLicense.CheckUser(eZtUB::ulasevich) || g_ZtLicense.CheckUser(eZtUB::ulasevich2) ||
		g_ZtLicense.GetCustom())
	{
		...
		DrewY += 15;
		// --> Devias Battle
		if(!g_ZtLicense.CheckUser(eZtUB::Artem) && !g_ZtLicense.CheckUser(eZtUB::Artem2) && !g_ZtLicense.CheckUser(eZtUB::NSGames))
		{
			TimeMain = TimeDevias;
			TimeH = (TimeMain/3600)%24;
			TimeM = (TimeMain/60)%60;
