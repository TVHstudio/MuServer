...
void InitScreenGlow(void)
{
    // cg_blur_steps = 8;	//4
	 ...
	 // VP LOADING
     if (!LoadProgram(&g_cgVP_GlowDarken, g_cgVertProfile, "Data/ZtTeam/cgprograms/glow_darken_vp.cg"))
          return;

     if (!LoadProgram(&g_cgVP_GlowBlur, g_cgVertProfile, "Data/ZtTeam/cgprograms/glow_blur_vp.cg"))
          return;

     if (!LoadProgram(&g_cgVP_GlowCombine, g_cgVertProfile, "Data/ZtTeam/cgprograms/glow_combine_vp.cg"))
          return;
	 ...
	 // FP LOADING
     if (!LoadProgram(&g_cgFP_GlowDarken, g_cgFragProfile, "Data/ZtTeam/cgprograms/glow_darken_fp.cg"))
          return;

     if (!LoadProgram(&g_cgFP_GlowBlur, g_cgFragProfile, "Data/ZtTeam/cgprograms/glow_blur_fp.cg"))
          return;

     if (!LoadProgram(&g_cgFP_GlowCombine, g_cgFragProfile, "Data/ZtTeam/cgprograms/glow_combine_fp.cg"))
          return;
