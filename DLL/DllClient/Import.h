...
#define pWhisperChatRecv		((void(__cdecl*)(CHAT_WHISPER_ZT * pRequest)) 0x006400C0)
...
#define pDrawZttraColor			((void(__cdecl*)(DWORD, float, float, float, float, float, float, float, float, DWORD)) 0x637A60)
...
//00788E1C;00788A1E - рост?ни?межд?строками чата

//00788F96 - рисует? текс?лого?
//00788F54 - рисует золото?ча?
//00788D64 - цвет золотого чата
//00788D46 - цвет фона золотого чата



//00788D41 - перехват ?проверка

//78BF00 - функция возвра?ет ко?цвет?

// EBP 0x0018E4B8
// 00995637

//00788DD9 - прыгае?если не?данной категори?



/*
	00788D5D      68 FF000000   PUSH 0FF	-насышенность
	00788D62      68 FF000000   PUSH 0FF	-сини?
	00788D67      6A 00         PUSH 0		-зелены?
	00788D69      68 FF000000   PUSH 0FF	-красны?
*/
...
// ----------------------------------------------------------------------------------------------
#define pChatDrawInterface ((int(*)()) 0x785670)
// ----------------------------------------------------------------------------------------------
#define pDrawInterfaceNumBer   ((double(__stdcall*)(float X, float Y, int num, float size)) 0x00854E90)
// ----------------------------------------------------------------------------------------------
#define BeginBitmap				((void(*)()) 0x637770)
#define EndOpengl				((void(*)()) 0x6366F0)
#define sub_4D5EC0R				((int(*)())  0x4D5EC0)
// ----------------------------------------------------------------------------------------------
#define pDrawImage				((int(__cdecl*)(int a1, float a2, float a3, float a4, float a5, float a6, float a7, float a8, float a9, char a10, char a11, float a12)) 0x637C60)
// ----------------------------------------------------------------------------------------------
#define pChaosBoxState *(BYTE*)(*(DWORD*)(0x98670C4) + 0xC8)	//no check 1.04E
