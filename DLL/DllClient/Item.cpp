...
void Item::LoadModels()
{
	pInitModelData();
	 //----
	//New Jewels
	char JewelDir[] = "Data\\ZtTeam\\Jewels\\";
	...
	//Wings 4 rd
	char WingsDir[]		= "Data\\ZtTeam\\Wings4\\";
	...
	#endif
	//Wings 2.5 
	char Wings2_5Dir[]		= "Data\\ZtTeam\\Wings2_5\\";
	...
	//Wings 5 rd
	char Wings5Dir[] = "Data\\ZtTeam\\Wings5\\";
...
#ifdef _COINS_
	//char CoinDir[] = "Data\\ZtTeam\\Coins\\";
	...
	char StormWingSetDir[] = "Data\\ZtTeam\\Items\\StormWingSet(BM)\\";
	char CerberusSetDir[] = "Data\\ZtTeam\\Items\\CerberusSet(GM)\\";
	char UpperKeysSetDir[] = "Data\\ZtTeam\\Items\\UpperKeysSet(HE)\\";
	char HellKnightSetDir[] = "Data\\ZtTeam\\Items\\HellKnightSet(DM)\\";
	char EmbisyeonSetDir[] = "Data\\ZtTeam\\Items\\EmbisyeonSet(LE)\\";
	char SuccubusSetDir[] = "Data\\ZtTeam\\Items\\SuccubusSet(Sum)\\";
	//StormWingSet(BM)
	...
	//Weapons
	pLoadModel(ITEM2(5,41), "Data\\ZtTeam\\Weapon\\ApocalypseStaff\\", "Staff26",  -1 );
	pLoadModel(ITEM2(4,30), "Data\\ZtTeam\\Weapon\\DraconicBow\\", "BowDraconic", -1 );
	//pLoadModel(ITEM2(0,41), "Data\\ZtData\\Item\\test\\", "Sword100",  -1 );

	pLoadModel(ITEM2(0,41), "Data\\ZtTeam\\Weapon\\NagaSword\\", "Sword37",  -1 );

	pLoadModel(ITEM2(2,20), "Data\\ZtTeam\\Weapon\\SepScepetr\\", "Staff20",  -1);
	pLoadModel(ITEM2(5,42), "Data\\ZtTeam\\Weapon\\SpiritStick\\", "Staff38",  -1);
	pLoadModel(ITEM2(0,42), "Data\\ZtTeam\\Weapon\\StormSword\\", "Sword33",  -1);
	//Shield
	
	pLoadModel(ITEM2(6,30), "Data\\ZtTeam\\Shield\\EmbisyeonShield(LE)\\", "Shield27",  -1 );
	pLoadModel(ITEM2(6,31), "Data\\ZtTeam\\Shield\\HellKnightShield(DM)\\", "Shield26",  -1 );
	pLoadModel(ITEM2(6,32), "Data\\ZtTeam\\Shield\\LazyWingShield(BM)\\", "Shield23",  -1);
	pLoadModel(ITEM2(6,33), "Data\\ZtTeam\\Shield\\ShieldofDivine\\", "ShieldofDivine",  -1);
	...
	pLoadModel(ITEM2(9,90), "Data\\Player\\", "PantMale61",  -1);
	pLoadModel(ITEM2(14,195), "Data\\ZtTeam\\stone\\", "suho",  -1);

#endif
#ifdef NEWWINGS6
	//if( g_ZtLicense.ActiveUser == Local2 ||	g_ZtLicense.ActiveUser == PrideMu ||		g_ZtLicense.ActiveUser == Local3||		g_ZtLicense.ActiveUser ==PrideMuLocal)	{
	//if(g_ZtLicense.ActiveUser == PrideMu ||		g_ZtLicense.ActiveUser ==PrideMuLocal||		g_ZtLicense.ActiveUser == Local2 || g_ZtLicense.ActiveUser == Local3)
	//{
	pLoadModel(ITEM2(12,195), "Data\\ZtTeam\\Wings6\\", "Wing186", -1);
	pLoadModel(ITEM2(12,196), "Data\\ZtTeam\\Wings6\\", "Wing191", -1);
	//}
	//}
#endif
	//14 	 	"suho" 			"Data\\ZtTeam\\stone\\"		"ZtTeam\\stone\\"
#ifdef EXCLUSIVE_AMYLET
	pLoadModel(ITEM2(13,147), "Data\\ZtTeam\\stone\\", "suho",  -1);
	pLoadModel(ITEM2(13,148), "Data\\ZtTeam\\stone\\", "suho",  -1);
pLoadModel(ITEM2(13,149), "Data\\ZtTeam\\stone\\", "suho",  -1);
pLoadModel(ITEM2(13,150), "Data\\ZtTeam\\stone\\", "suho",  -1);
pLoadModel(ITEM2(13,151), "Data\\ZtTeam\\stone\\", "suho",  -1);
pLoadModel(ITEM2(13,152), "Data\\ZtTeam\\stone\\", "suho",  -1);

pLoadModel(ITEM2(13,153), "Data\\ZtTeam\\stone\\", "suho",  -1);
pLoadModel(ITEM2(13,154), "Data\\ZtTeam\\stone\\", "suho",  -1);
pLoadModel(ITEM2(13,155), "Data\\ZtTeam\\stone\\", "suho",  -1);
pLoadModel(ITEM2(13,156), "Data\\ZtTeam\\stone\\", "suho",  -1);
	...
	{
		#if(ENABLE_PETZT)
		if(g_PetZt.IsPet(ITEM2(gConfig.Item[i].Type,gConfig.Item[i].Index), true))
		{
			continue;
		}
		#endif
	...
	//InitModel(LOAD_ITEM(12,189), "DW_Wings5", "ZtTeam\\Wings5\\", "Data\\ZtTeam\\Wings5\\"); 
	//InitModel(LOAD_ITEM(12,190), "DK_Wings5", "ZtTeam\\Wings5\\", "Data\\ZtTeam\\Wings5\\");
	//InitModel(LOAD_ITEM(12,191), "Elf_Wings5", "ZtTeam\\Wings5\\", "Data\\ZtTeam\\Wings5\\");
	//InitModel(LOAD_ITEM(12,192), "MG_Wings5", "ZtTeam\\Wings5\\", "Data\\ZtTeam\\Wings5\\");
	//InitModel(LOAD_ITEM(12,193), "MG_Wings5_2", "ZtTeam\\Wings5\\", "Data\\ZtTeam\\Wings5\\");
	//InitModel(LOAD_ITEM(12,194), "DL_Wings5", "ZtTeam\\Wings5\\", "Data\\ZtTeam\\Wings5\\");
	...
	//Weapons
	//pLoadModel(ITEM2(5,100), "Data\\ZtTeam\\Weapon\\ApocalypseStaff\\", "Staff26",  -1 );
	//pLoadModel(ITEM2(4,30), "Data\\ZtTeam\\Weapon\\DraconicBow\\", "BowDraconic", -1 );
	//pLoadModel(ITEM2(0,40), "Data\\ZtTeam\\Weapon\\NagaSword\\", "Sword37",  -1 );
	//pLoadModel(ITEM2(2,20), "Data\\ZtTeam\\Weapon\\SepScepetr\\", "Staff20",  -1);
	//pLoadModel(ITEM2(5,41), "Data\\ZtTeam\\Weapon\\SpiritStick\\", "Staff38",  -1);
	//pLoadModel(ITEM2(0,41), "Data\\ZtTeam\\Weapon\\StormSword\\", "Sword33",  -1);
	//Shield
	//pLoadModel(ITEM2(6,30), "Data\\ZtTeam\\Shield\\EmbisyeonShield(LE)\\", "Shield27",  -1 );
	//pLoadModel(ITEM2(6,31), "Data\\ZtTeam\\Shield\\HellKnightShield(DM)\\", "Shield26",  -1 );
	//pLoadModel(ITEM2(6,32), "Data\\ZtTeam\\Shield\\LazyWingShield(BM)\\", "Shield23",  -1);
	//pLoadModel(ITEM2(6,33), "Data\\ZtTeam\\Shield\\ShieldofDivine\\", "ShieldofDivine",  -1);
	////Stone
	//pLoadModel(ITEM2(14,208), "suho", "Data\\ZtTeam\\stone\\", -1); // Mix Stone


	//Talisman System
	//char TalismanDir[] = "Data\\ZtTeam\\Talismans\\";
...
#if(RF_NEW_GLOV)
	pLoadModel(ITEM2(0,114), "Data\\ZtData\\Item\\BloodyDragon_RF\\GloveMaleBloodyDragon\\", "Sword34", -1);
	pLoadModel(GLOV1, "Data\\ZtData\\Item\\BloodyDragon_RF\\GloveMaleBloodyDragon\\", "SwordL34", -1);
	pLoadModel(GLOV2, "Data\\ZtData\\Item\\BloodyDragon_RF\\GloveMaleBloodyDragon\\", "SwordR34", -1);
#endif
...
void Item::LoadTextures()
{
	...
	// ----
	//New Jewels
	char JewelFolder[]	= "ZtTeam\\Jewels\\";
	...
	//Wings 4 rd
	char WingsFolder[]	= "ZtTeam\\Wings4\\";
	...
	#endif
	//Wings 2.5 
	char WingsFolder2[]	= "ZtTeam\\Wings2_5\\";
	...
	//Wings 5 rd
	char Wings5Folder[] = "ZtTeam\\Wings5\\";
	...
	//pLoadTexture(ITEM2(12,196), "Data\\ZtTeam\\Wings6\\", GL_REPEAT, GL_NEAREST, GL_TRUE); // Wing02.bmd		
	
	#ifdef _GRAND_SYSTEM_

	//GrandHero Item
	char StormWingSetFol[] = "ZtTeam\\Items\\StormWingSet(BM)\\";
	char CerberusSetFol[] = "ZtTeam\\Items\\CerberusSet(GM)\\";
	char UpperKeysSetFol[] = "ZtTeam\\Items\\UpperKeysSet(HE)\\";
	char HellKnightSetFol[] = "ZtTeam\\Items\\HellKnightSet(DM)\\";
	char EmbisyeonSetFol[] = "ZtTeam\\Items\\EmbisyeonSet(LE)\\";
	char SuccubusSetFol[] = "ZtTeam\\Items\\SuccubusSet(Sum)\\";
	//StormWingSet(BM)
	...
	//Weapons
	pLoadTexture(ITEM2(5,41), "ZtTeam\\Weapon\\ApocalypseStaff\\", GL_REPEAT, GL_NEAREST, GL_TRUE);
	pLoadTexture(ITEM2(4,30), "ZtTeam\\Weapon\\DraconicBow\\", GL_REPEAT, GL_NEAREST, GL_TRUE);
	pLoadTexture(ITEM2(0,41), "ZtTeam\\Weapon\\NagaSword\\", GL_REPEAT, GL_NEAREST, GL_TRUE);
	pLoadTexture(ITEM2(2,20), "ZtTeam\\Weapon\\SepScepetr\\", GL_REPEAT, GL_NEAREST, GL_TRUE);
	pLoadTexture(ITEM2(5,42), "ZtTeam\\Weapon\\SpiritStick\\", GL_REPEAT, GL_NEAREST, GL_TRUE);
	pLoadTexture(ITEM2(0,42), "ZtTeam\\Weapon\\StormSword\\", GL_REPEAT, GL_NEAREST, GL_TRUE);
	//Shield
	pLoadTexture(ITEM2(6,30), "ZtTeam\\Shield\\EmbisyeonShield(LE)\\", GL_REPEAT, GL_NEAREST, GL_TRUE);
	pLoadTexture(ITEM2(6,31), "ZtTeam\\Shield\\HellKnightShield(DM)\\", GL_REPEAT, GL_NEAREST, GL_TRUE);
	pLoadTexture(ITEM2(6,32), "ZtTeam\\Shield\\LazyWingShield(BM)\\", GL_REPEAT, GL_NEAREST, GL_TRUE);
	pLoadTexture(ITEM2(6,33), "ZtTeam\\Shield\\ShieldofDivine\\", GL_REPEAT, GL_NEAREST, GL_TRUE);
	//RF
	...
	pLoadTexture(ITEM2(14,195),"ZtTeam\\stone\\", GL_REPEAT, GL_NEAREST, GL_TRUE);
#endif
#ifdef NEWWINGS6
	//if(g_ZtLicense.ActiveUser == PrideMu ||		g_ZtLicense.ActiveUser ==PrideMuLocal||		g_ZtLicense.ActiveUser == Local2 || g_ZtLicense.ActiveUser == Local3)
	//{
	pLoadTexture(ITEM2(12,195), "ZtTeam\\Wings6\\", GL_REPEAT, GL_NEAREST, GL_TRUE); // Wing186.bmd.bmd	
	pLoadTexture(ITEM2(12,196), "ZtTeam\\Wings6\\", GL_REPEAT, GL_NEAREST, GL_TRUE); // Wing02.bmd	
	//}
#endif
#ifdef EXCLUSIVE_AMYLET
	pLoadTexture(ITEM2(13,147),"ZtTeam\\stone\\", GL_REPEAT, GL_NEAREST, GL_TRUE);
	pLoadTexture(ITEM2(13,148),"ZtTeam\\stone\\", GL_REPEAT, GL_NEAREST, GL_TRUE);
	pLoadTexture(ITEM2(13,149),"ZtTeam\\stone\\", GL_REPEAT, GL_NEAREST, GL_TRUE);
	pLoadTexture(ITEM2(13,150),"ZtTeam\\stone\\", GL_REPEAT, GL_NEAREST, GL_TRUE);
	pLoadTexture(ITEM2(13,151),"ZtTeam\\stone\\", GL_REPEAT, GL_NEAREST, GL_TRUE);

	pLoadTexture(ITEM2(13,152),"ZtTeam\\stone\\", GL_REPEAT, GL_NEAREST, GL_TRUE);
	pLoadTexture(ITEM2(13,153),"ZtTeam\\stone\\", GL_REPEAT, GL_NEAREST, GL_TRUE);
	pLoadTexture(ITEM2(13,154),"ZtTeam\\stone\\", GL_REPEAT, GL_NEAREST, GL_TRUE);
	pLoadTexture(ITEM2(13,155),"ZtTeam\\stone\\", GL_REPEAT, GL_NEAREST, GL_TRUE);
	pLoadTexture(ITEM2(13,156),"ZtTeam\\stone\\", GL_REPEAT, GL_NEAREST, GL_TRUE);
#endif
	...
	//14 	195 	"suho" 			"Data\\ZtTeam\\stone\\"		"ZtTeam\\stone\\"
	//ArmorMale61.bmd
	//ITEM2(0,43), "Data\\ZtTeam\\Items\\RFsw\\", "Sword34"
	////Mix Stone
	//pLoadTexture(ITEM2(14,208), "ZtTeam\\stone\\",  GL_REPEAT, GL_NEAREST, GL_TRUE);

	//Wings 5 Level
	//char Wings5kFol[] = "ZtTeam\\Wings5\\";
...
#if(RF_NEW_GLOV)
	//pLoadTexture(ITEM2(0,114), "ZtData\\Item\\BloodyDragon_RF\\GloveMaleBloodyDragon\\", GL_REPEAT, GL_NEAREST, GL_TRUE);
	//pLoadTexture(GLOV1, "ZtData\\Item\\BloodyDragon_RF\\GloveMaleBloodyDragon\\", GL_REPEAT, GL_NEAREST, GL_TRUE);
	//pLoadTexture(GLOV2, "ZtData\\Item\\BloodyDragon_RF\\GloveMaleBloodyDragon\\", GL_REPEAT, GL_NEAREST, GL_TRUE);
#endif
...
bool Item::IsCustomJewels(WORD ItemID, bool Preview)
{
	...
	if(!g_ZtLicense.CheckUser(MedoniAndrei))
	{
...
//#endif
	...
	#if(ENABLE_PETZT)
	g_PetZt.PreviewCharSet(lpObj, CharSet, Object, Mode);
	#endif	

	#if(DEV_CAPE)
	//gCapeAnimation.DrawViewPort((DWORD)lpObj, (DWORD)CharSet, (DWORD)Object);
	#endif
