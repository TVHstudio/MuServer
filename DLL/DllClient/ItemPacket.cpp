...
void CItemPacket::ItemLoad()
{
	//SetRange((LPVOID)0x007E3D6A, 3, ASM::NOP);
	...
	SetOp((LPVOID)0x007D9FAC, this->Hook, ASM::CALL);
	SetOp((LPVOID)0x0083384E, this->Hook, ASM::CALL);

	#if(DEV_ITEM_LEVEL)
	/*
	SetRange((LPVOID)(0x0047428E+6), 3, ASM::NOP);
	SetRange((LPVOID)(0x004F4295+6), 3, ASM::NOP);
	SetRange((LPVOID)(0x0051BC8D+6), 3, ASM::NOP);
	SetRange((LPVOID)(0x00780CAE+6), 3, ASM::NOP);
	SetRange((LPVOID)(0x00780E40+6), 3, ASM::NOP);
	SetRange((LPVOID)(0x00799EA0+6), 3, ASM::NOP);
	SetRange((LPVOID)(0x007D9B5C+6), 3, ASM::NOP);
	SetRange((LPVOID)(0x007DA9F4+6), 3, ASM::NOP);
	SetRange((LPVOID)(0x007DFAF3+6), 3, ASM::NOP);
	SetRange((LPVOID)(0x007E0484+6), 3, ASM::NOP);
	SetRange((LPVOID)(0x007E3D64+6), 3, ASM::NOP);	//JMP 5ADA5F70
	SetRange((LPVOID)(0x00834E45+6), 3, ASM::NOP);
	SetRange((LPVOID)(0x00836FE5+6), 3, ASM::NOP);
	SetRange((LPVOID)(0x008382F6+6), 3, ASM::NOP);
	SetRange((LPVOID)(0x00839CCC+6), 3, ASM::NOP);
	SetRange((LPVOID)(0x0083A2EE+6), 3, ASM::NOP);
	SetRange((LPVOID)(0x0083AAC5+6), 3, ASM::NOP);
	SetRange((LPVOID)(0x008FF344+6), 3, ASM::NOP);
	SetRange((LPVOID)(0x0095F5C4+6), 3, ASM::NOP);
	SetRange((LPVOID)(0x0096818C+6), 3, ASM::NOP);
	SetRange((LPVOID)(0x00968B1C+6), 3, ASM::NOP);
	*/
	#endif
...
char *CItemPacket::ItemConvert(LPVOID This, unsigned __int8 a2, unsigned __int8 a3, char a4, char a5, char a6, char a7, char a8, char a9, int a10)
{
  ...
  *(WORD *)(v14 + 71) = a9 & 0xF;
  ...
  v14[96] = 0;
  *(DWORD *)(v14 + 103) = 1;
  sub_7E2150((int)v14, a4, a6, a7);//sub_7E2150((int)v14, a4, a6, a7);
...
int CItemPacket::Hook(LPVOID This, LPVOID lp)
{
 ...
 BYTE byLevel = *((BYTE *)lp + 1);

 BYTE btLevelMax = ( (v8 & 0xC0) == 0xC0 ) ? TRUE : FALSE;

 BYTE ResultLevel = ((signed int)byLevel >> 3);
 ...
 lpItem->Level = 0;
 lpItem->Level |= ResultLevel * 8;



 //BYTE byLevel = 19;//*((BYTE *)lp + 1);
// lpItem->Level = ((signed int)byLevel >> 3);
 //lpItem->Level = 0;
 //lpItem->Level |= byLevel * 8;
 //lpItem->Level |= 1 * 128;
 //lpItem->Level |= 1 * 4;
 //lpItem->Level |= 3 & 3;
...
bool CItemPacket::MoveItem(char a4, char a5, signed __int16 *a6, char a7, char a8)
{
  ...
  if ( sub_967FB0(a6) )
	...
	BYTE btLevel = ((signed int)*(DWORD*)(a6 + 2) >> 3);
	...
	pMsg.source_item_num = a5;
	pMsg.sItemInfo[0] = *a6 & 0xFF;
	pMsg.sItemInfo[1] = *(DWORD*)(a6 + 1) & 0xFF;//*(DWORD*)(a6 + 1) & 0xFF;
	pMsg.sItemInfo[2] = *((BYTE *)a6 + 22);
	pMsg.sItemInfo[3] = *((BYTE *)a6 + 23);
	pMsg.sItemInfo[4] = *((BYTE *)a6 + 24);
	pMsg.sItemInfo[5] = v35;
