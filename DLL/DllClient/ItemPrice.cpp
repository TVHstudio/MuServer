...
void ItemPrice::Load()
{
	this->ReadList("Data\\ZtTeam\\PriceManager.ini");
	// ----
...
void ItemPrice::ShowSellPrice(DWORD a1, const char *a2, char *Price)
{
	...
	{
		pShowPrice(a1, g_ZtText.GetText(88), Price);
		return;
	}
	// ----
	switch (gItemPrice.ShowType)	//-> Need Recode
	{
		...
		case ePrice::eCredit:
		{
			pShowPrice(a1, g_ZtText.GetText(89), Price);
		}
		break;
		// --
		case ePrice::eWCoin:
		{
			pShowPrice(a1, g_ZtText.GetText(90), Price);
		}
		break;
		// --
		case ePrice::eWCoinP:
		{
			pShowPrice(a1, g_ZtText.GetText(91), Price);
		}
		break;
		// --
		case ePrice::eGoblinPoint:
		{
			pShowPrice(a1, g_ZtText.GetText(92), Price);
		}
		break;
		// --
		default:
		{
			...
			{
				pShowPrice(a1, g_ZtText.GetText(88), 0);
			}
			else
			{
				pShowPrice(a1, g_ZtText.GetText(88), Price);
...
void ItemPrice::ShowBuyPrice(DWORD a1, const char *a2, char *Price)
{
	...
	if (!gItemPrice.Enable || !gItemPrice.ShowItem)
	{
		pShowPrice(a1, g_ZtText.GetText(93), Price);
	...
	case ePrice::eZen:
	{
		if (v14 < 1000000000)
		{
			if (v14 < 1000000)
			{
				if (v14 < 1000)
				{
					pShowPrice(a1, g_ZtText.GetText(94), v12);
				}
				else
				{
					pShowPrice(a1, g_ZtText.GetText(95), v13, v12);
				}
			}
			else
			{
				pShowPrice(a1, g_ZtText.GetText(96), v11, v13, v12);
			}
		}
		else
		{
			...
			{
				pShowPrice(a1, g_ZtText.GetText(97), 2, v11, v13, v12);
			}
			else
			{
				pShowPrice(a1, g_ZtText.GetText(97), 1, v11, v13, v12);
			}		 
		}
	}
		break;
	...
	case ePrice::eCredit:
	{
		if (v14 < 1000000000)
		{
			if (v14 < 1000000)
			{
				if (v14 < 1000)
				{
					pShowPrice(a1, g_ZtText.GetText(98), v12);
				}
				else
				{
					pShowPrice(a1, g_ZtText.GetText(99), v13, v12);
				}
			}
			else
			{
				pShowPrice(a1, g_ZtText.GetText(100), v11, v13, v12);
			}
		}
		else
		{
			pShowPrice(a1, g_ZtText.GetText(101), v11, v13, v12);
		}
	}
		break;
		// --
	case ePrice::eWCoin:
	{
		if (v14 < 1000000000)
		{
			if (v14 < 1000000)
			{
				if (v14 < 1000)
				{
					pShowPrice(a1, g_ZtText.GetText(102), v12);
				}
				else
				{
					pShowPrice(a1, g_ZtText.GetText(103), v13, v12);
				}
			}
			else
			{
				pShowPrice(a1, g_ZtText.GetText(104), v11, v13, v12);
			}
		}
		else
		{
			pShowPrice(a1, g_ZtText.GetText(105), v11, v13, v12);
		}
	}
	break;
		// --
	case ePrice::eWCoinP:
	{
		if (v14 < 1000000000)
		{
			if (v14 < 1000000)
			{
				if (v14 < 1000)
				{
					pShowPrice(a1, g_ZtText.GetText(106), v12);
				}
				else
				{
					pShowPrice(a1, g_ZtText.GetText(107), v13, v12);
				}
			}
			else
			{
				pShowPrice(a1, g_ZtText.GetText(108), v11, v13, v12);
			}
		}
		else
		{
			pShowPrice(a1, g_ZtText.GetText(109), v11, v13, v12);
		}
	}
	break;
		// --
	case ePrice::eGoblinPoint:
	{
		if (v14 < 1000000000)
		{
			if (v14 < 1000000)
			{
				if (v14 < 1000)
				{
					pShowPrice(a1, g_ZtText.GetText(110), v12);
				}
				else
				{
					pShowPrice(a1, g_ZtText.GetText(111), v13, v12);
				}
			}
			else
			{
				pShowPrice(a1, g_ZtText.GetText(112), v11, v13, v12);
			}
		}
		else
		{
			pShowPrice(a1, g_ZtText.GetText(113), v11, v13, v12);
		}
	}
	break;
		// --
