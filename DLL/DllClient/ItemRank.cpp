...
void ItemRank::SetOptionText(int ItemID, int Line, WORD OptionID, BYTE Arg4, int Arg5)	//bool Arg4
{
	...
	if(gItem.IsWings2_5(ItemID,false))
	{
		switch(OptionID)
		{
			case eItemOption::IgnorOpDefense: pSetItemTextLine(Line, g_ZtText.GetText(84), 4);	break;
			case eItemOption::ReturnAttack:   pSetItemTextLine(Line, g_ZtText.GetText(85), 4);	break;
			case eItemOption::CompleteLife:   pSetItemTextLine(Line, g_ZtText.GetText(86), 4);	break;
			case eItemOption::CompleteMana:   pSetItemTextLine(Line, g_ZtText.GetText(87), 4);	break;
		}
	...
	else if(gItem.IsWings4(ItemID,false))
	{
		switch(OptionID)
		{
			case eItemOption::IgnorOpDefense: pSetItemTextLine(Line, g_ZtText.GetText(84), 8);	break;
			case eItemOption::ReturnAttack:   pSetItemTextLine(Line, g_ZtText.GetText(85), 8);	break;
			case eItemOption::CompleteLife:   pSetItemTextLine(Line, g_ZtText.GetText(86), 8);	break;
			case eItemOption::CompleteMana:   pSetItemTextLine(Line, g_ZtText.GetText(87), 8);	break;
		}
