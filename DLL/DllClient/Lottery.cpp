...
{
	pLoadImage("ZtData\\Interface\\Lottery\\Converted\\vq1.tga", zt_LOTTERY_SPIN, 0x2601, 0x2900, 1, 0);
	pLoadImage("ZtData\\Interface\\Lottery\\close.tga", zt_LOTTERY_CLOSE, 0x2601, 0x2900, 1, 0);

	pLoadImage("ZtData\\Interface\\Lottery\\main.jpg", zt_LOTTERY_MAIN, GL_LINEAR, GL_CLAMP, 1, 0);
}

void CLottery::BindIMG()
{
	gInterface.BindObject(eLOTTERY_SPIN, zt_LOTTERY_SPIN, 640, 440, -1, -1);
	gInterface.BindObject(eLOTTERY_CLOSE, zt_LOTTERY_CLOSE, 14, 16, -1, -1);
	gInterface.BindObject(eLOTTERY_MAIN, zt_LOTTERY_MAIN, 640, 440, -1, -1);
	// ----
	return;
...
void CLottery::DrawMain()
{
	...
	gInterface.DrawGUI(eLOTTERY_MAIN, 0, 0);
	...
	*/
	...
	//if(!gInterface.CheckWindowZt(ObjWindowsZt::ztWinLottery))
	//{
	//	return;
	//}
...
void CLottery::Button(DWORD Event)
{
	...
	if(gInterface.Button(Event, ObjWindowsZt::ztWinLottery, eLOTTERY_PLAY, 0))
	{
		this->CGLotteryPlay();
	}
	else if(gInterface.Button(Event, ObjWindowsZt::ztWinLottery, eLOTTERY_CLOSE, 0))
	{
		gInterface.CloseWindowZt(ObjWindowsZt::ztWinLottery);
		this->ClearDraw();
	}
	else if(gInterface.Button(Event, ObjWindowsZt::ztWinLottery, eLOTTERY_PAGEUP, 0))
	{
	...
	else if(gInterface.Button(Event, ObjWindowsZt::ztWinLottery, eLOTTERY_PAGEDN, 0))
	{
...
void CLottery::GCLotteryData(PMSG_LOTTERY_DATA* lpMsg)
{
	...
	gInterface.OpenWindowZt(ObjWindowsZt::ztWinLottery);
}
