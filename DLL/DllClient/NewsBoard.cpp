...
void NewsBoard::ReqOpenMain()
{
	...
	//{
	//	gInterface.OpenWindowZt(ztWinNews);
	//	return;
	//}
	// ----
...
void NewsBoard::DrawNewsWindow()
{
	...
	if( gInterface.IsWorkZone(eNEWS_CLOSE) )
	{
		...
		gInterface.DrawToolTip(gInterface.Data[eNEWS_CLOSE].X + 5, gInterface.Data[eNEWS_CLOSE].Y + 25, g_ZtText.GetText(78));
	}
	// ----
	gInterface.DrawFormat(eGold, StartX + 10, 110, 210, 3, g_ZtText.GetText(78));
	// ----
	...
	else
	{
		...
		gInterface.DrawFormat(eWhite, StartX + 8, gInterface.Data[eNEWS_FOOTER].Y + 20, 210, 3, g_ZtText.GetText(79));
...
bool NewsBoard::EventNewsWindow_Main(DWORD Event)
{
	...
	// ----
	if( gInterface.ButtonZt(Event, eNEWS_CLOSE, false ) )
	{
	...
	// ----
	if( gInterface.ButtonZt(Event, eNEWS_BACK, false ) && gInterface.Data[eNEWS_MAIN].Attribute != 0)
	{
		gInterface.Data[eNEWS_MAIN].Attribute = 0;
		return true;
	}
