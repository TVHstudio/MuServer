...
{
	//return 640.0;
	return (float)((double)(unsigned int)/*width*/ztWinWidth * a1 / ztWinWidth);//640
}

double Start::Crack_sub_636450(float a1)
{
	//return 480.0;
	 return (float)((double)(unsigned int)/*height*/ztWinHeight * a1 / ztWinHeight);	//480
}
...
#if(DISABLE_C_INFO)
	SetRange((LPVOID)0x007D3830, 5, ASM::NOP);
#endif
...
void Start::Fix()
{
	...
	//SetByte((PVOID)(0x0095CD6D+2), 0x01);	//Mu Helper 1 level
	...
	static char * LogName		= "Data\\Logs\\Error.log";
	static char * LogName2		= "Data\\Logs\\Error_%d.log";
	static char * DumpName		= "Data\\Logs\\Error.dmp";
	static char * ScreenName	= "Data\\Images\\Screen(%02d_%02d-%02d_%02d)-%04d.jpg";
	// ----
	...
	SetRange((PVOID)0x005B9EBA, 5, ASM::NOP);
	 ...
	 #if(DEV_FPS)
	 SetByte((LPVOID)(0x004DA3AC + 3), 0x1F);	 // -> fps  0x1F
	 #endif
...
int Start::GameLoad()
{
	...
	ztWinWidth  = pWinWidth;
	ztWinHeight = pWinHeight;
