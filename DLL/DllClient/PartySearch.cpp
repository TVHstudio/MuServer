...
{
	pLoadImage("ZtTeam\\Interface\\PartySearch_Title.tga", zt_PT_SEARCH_TITLE, 0x2601, 0x2900, 1, 0);
}
// ----------------------------------------------------------------------------------------------
...
void PartySearch::BindImages()
{
	...
	gInterface.BindObject(ePT_SEARCH_USER_INFOBG, zt_PT_SEARCH_TITLE, 170, 21, -1, -1);
...
void PartySearch::DrawMaster()
{
	...
	if( gInterface.IsWorkZone(ePT_SEARCH_MASTER_CLOSE) )
	{
		...
		gInterface.DrawToolTip(gInterface.Data[ePT_SEARCH_MASTER_CLOSE].X + 5, gInterface.Data[ePT_SEARCH_MASTER_CLOSE].Y + 25, g_ZtText.GetText(24));
	}
	// ----
	gInterface.DrawFormat(eGold, StartX + 10, 110, 210, 3, g_ZtText.GetText(118));
	// ---- 

	// -> Content

	ContentY += 35;
	gInterface.DrawCheckLine(this->ActiveSystem, ePT_SEARCH_MASTER_POINT, ePT_SEARCH_MASTER_CHECK1, NULL, ContentX, ContentY, eWhite, g_ZtText.GetText(116));

	ContentY += 10;
	gInterface.DrawGUI(ePT_SEARCH_MASTER_DIV, ContentX, ContentY);

	ContentY += 20; 
	gInterface.PartUPandDN(ePT_SEARCH_MASTER_POINT, ePT_SEARCH_MASTER_PAGEUP, ePT_SEARCH_MASTER_PAGEDN, NULL, ContentX, ContentY, eWhite, this->MaxLevel, g_ZtText.GetText(117));

	ContentY += 10;
	gInterface.DrawGUI(ePT_SEARCH_MASTER_DIV, ContentX, ContentY);

	ContentY += 20;
	gInterface.DrawCheckLine(this->bOnlyOneClass, ePT_SEARCH_MASTER_POINT, ePT_SEARCH_MASTER_CHECK3, NULL, ContentX, ContentY, eWhite, g_ZtText.GetText(119));

	ContentY += 10;
	gInterface.DrawGUI(ePT_SEARCH_MASTER_DIV, ContentX, ContentY);

	ContentY += 20;
	gInterface.DrawCheckLine(this->bDarkWizard, ePT_SEARCH_MASTER_POINT, ePT_SEARCH_MASTER_CHECK4, ePT_SEARCH_MASTER_LINE, ContentX, ContentY, eWhite, g_ZtText.GetText(60));

	ContentY += 20;
	gInterface.DrawCheckLine(this->bDarkKnight, ePT_SEARCH_MASTER_POINT, ePT_SEARCH_MASTER_CHECK5, ePT_SEARCH_MASTER_LINE, ContentX, ContentY, eWhite, g_ZtText.GetText(63));

	ContentY += 20;
	gInterface.DrawCheckLine(this->bElf, ePT_SEARCH_MASTER_POINT, ePT_SEARCH_MASTER_CHECK6, ePT_SEARCH_MASTER_LINE, ContentX, ContentY, eWhite, g_ZtText.GetText(66));

	ContentY += 20;
	gInterface.DrawCheckLine(this->bMagicGladiator, ePT_SEARCH_MASTER_POINT, ePT_SEARCH_MASTER_CHECK7, ePT_SEARCH_MASTER_LINE, ContentX, ContentY, eWhite, g_ZtText.GetText(69));

	ContentY += 20;
	gInterface.DrawCheckLine(this->bDarkLord, ePT_SEARCH_MASTER_POINT, ePT_SEARCH_MASTER_CHECK8, ePT_SEARCH_MASTER_LINE, ContentX, ContentY, eWhite, g_ZtText.GetText(71));

	if(gObjUser.SUM)
	{
		ContentY += 20;
		gInterface.DrawCheckLine(this->bSummoner, ePT_SEARCH_MASTER_POINT, ePT_SEARCH_MASTER_CHECK9, NULL, ContentX, ContentY, eWhite, g_ZtText.GetText(73));
	}

	if(gObjUser.RF)
	{
		ContentY += 20;
		gInterface.DrawCheckLine(this->bAllClass, ePT_SEARCH_MASTER_POINT, ePT_SEARCH_MASTER_CHECK2, ePT_SEARCH_MASTER_LINE, ContentX, ContentY, eWhite, g_ZtText.GetText(76));
	}

	// -> End
	gInterface.DrawGUI(ePT_SEARCH_MASTER_FINISH, ButtonX, gInterface.Data[ePT_SEARCH_MASTER_FOOTER].Y + 10);
	gInterface.DrawFormat(eWhite, StartX + 8, gInterface.Data[ePT_SEARCH_MASTER_FOOTER].Y + 20, 210, 3, g_ZtText.GetText(120));
...
void PartySearch::DrawUser()
{
	...
	if( gInterface.IsWorkZone(ePT_SEARCH_USER_CLOSE) )
	{
		...
		gInterface.DrawToolTip(gInterface.Data[ePT_SEARCH_USER_CLOSE].X + 5, gInterface.Data[ePT_SEARCH_USER_CLOSE].Y + 25, g_ZtText.GetText(24));
	}
	// ----

	gInterface.DrawFormat(eGold, ContentX + 10, ContentY + 10, 210, 3, g_ZtText.GetText(141));
	...
	ListDrawX += 50;
	gInterface.DrawFormat(eGold, ListDrawX, ListDrawY + 20, 100, 1, g_ZtText.GetText(30));

	ListDrawX += 50;
	gInterface.DrawFormat(eGold, ListDrawX, ListDrawY + 20, 100, 1, g_ZtText.GetText(31));

	ListDrawX += 15;
	gInterface.DrawFormat(eGold, ListDrawX, ListDrawY + 20, 100, 1, g_ZtText.GetText(32));

	ListDrawX += 20;
	gInterface.DrawFormat(eGold, ListDrawX, ListDrawY + 20, 100, 1, g_ZtText.GetText(33));

	ListDrawX += 35;
	gInterface.DrawFormat(eGold, ListDrawX, ListDrawY + 20, 100, 1, g_ZtText.GetText(142));
	...
	gInterface.DrawFormat(eGold, ContentX+97, ContentY + 329, 100, 1, g_ZtText.GetText(34), this->Page+1,this->MaxParty/10+1);
	...
	if(this->InfoDraw)
	{
		...
		sprintf(NeedInfoText, g_ZtText.GetText(143));
		strcat(NeedInfoText, "\n");
		strcat(NeedInfoText, g_ZtText.GetText(161));
		strcat(NeedInfoText, "\n");
		...
		{
			strcat(NeedInfoText, g_ZtText.GetText(144));
			strcat(NeedInfoText, "\n");
			BrCount++;
		}
		if(this->Party[this->InfoUP].dk)
		{
			strcat(NeedInfoText,g_ZtText.GetText(145));
			strcat(NeedInfoText, "\n");
			BrCount++;
		}
		if(this->Party[this->InfoUP].ee)
		{
			strcat(NeedInfoText,g_ZtText.GetText(146));
			strcat(NeedInfoText, "\n");
			BrCount++;
		}
		if(this->Party[this->InfoUP].mg)
		{
			strcat(NeedInfoText,g_ZtText.GetText(147));
			strcat(NeedInfoText, "\n");
			BrCount++;
		}
		if(this->Party[this->InfoUP].dl)
		{
			strcat(NeedInfoText,g_ZtText.GetText(148));
			strcat(NeedInfoText, "\n");
			BrCount++;
		}
		if(this->Party[this->InfoUP].su && gObjUser.SUM)
		{
			strcat(NeedInfoText,g_ZtText.GetText(149));
			strcat(NeedInfoText, "\n");
			BrCount++;
		}
		if(this->Party[this->InfoUP].rf && gObjUser.RF)
		{
			strcat(NeedInfoText,g_ZtText.GetText(150));
			strcat(NeedInfoText, "\n");
			BrCount++;
		}
...
{
	if(gInterface.Button(Event, ztWinPTSearchMaster, ePT_SEARCH_MASTER_CLOSE, 0))
	{
		gInterface.CloseWindowZt(ztWinPTSearchMaster);
	}
	if(gInterface.Button(Event, ztWinPTSearchMaster, ePT_SEARCH_MASTER_FINISH, 0))
	{
	...
	if(gInterface.Button(Event, ztWinPTSearchMaster, ePT_SEARCH_MASTER_PAGEUP, 0))
	{
		if(this->ActiveSystem)
		{
			this->MaxLevel +=10;
			if(this->MaxLevel > gMaxLevel)
			{
				this->MaxLevel = gMaxLevel;
			}
		}
	}
	if(gInterface.Button(Event, ztWinPTSearchMaster, ePT_SEARCH_MASTER_PAGEDN, 0))
	{
		if(this->ActiveSystem)
		{
			this->MaxLevel -= 10;
	...
	// --
	if(gInterface.Button(Event, ztWinPTSearchMaster, ePT_SEARCH_MASTER_CHECK1, 0))
	{
	...
	// --
	if(gInterface.Button(Event, ztWinPTSearchMaster, ePT_SEARCH_MASTER_CHECK2, 0))	// All Classs
	{
		if(this->ActiveSystem)
		{
	...
	// --
	if(gInterface.Button(Event, ztWinPTSearchMaster, ePT_SEARCH_MASTER_CHECK3, 0))	// Only Gold Party
	{
		if(this->ActiveSystem)
		{
	...
	// --
	if(gInterface.Button(Event, ztWinPTSearchMaster, ePT_SEARCH_MASTER_CHECK4, 0))	// Dark Wizard
	{
		if(this->ActiveSystem)
		{
			this->bOnlyOneClass = false;
	...
	// --
	if(gInterface.Button(Event, ztWinPTSearchMaster, ePT_SEARCH_MASTER_CHECK5, 0))	// Dark Knight
	{
		if(this->ActiveSystem)
		{
			this->bOnlyOneClass = false;
	...
	// --
	if(gInterface.Button(Event, ztWinPTSearchMaster, ePT_SEARCH_MASTER_CHECK6, 0))	// Elf
	{
		if(this->ActiveSystem)
		{
			this->bOnlyOneClass = false;
	...
	// --
	if(gInterface.Button(Event, ztWinPTSearchMaster, ePT_SEARCH_MASTER_CHECK7, 0))	// Magic
	{
		if(this->ActiveSystem)
		{
			this->bOnlyOneClass = false;
	...
	// --
	if(gInterface.Button(Event, ztWinPTSearchMaster, ePT_SEARCH_MASTER_CHECK8, 0))	// dl
	{
		if(this->ActiveSystem)
		{
			this->bOnlyOneClass = false;
	...
	// --
	if(gInterface.Button(Event, ztWinPTSearchMaster, ePT_SEARCH_MASTER_CHECK9, 0))	// sum
	{
		if(this->ActiveSystem)
		{
			this->bOnlyOneClass = false;
	...
	if(gInterface.CheckWindowZt(ztWinPTSearchUser))
	{
		for(int i = 0; i < 10; i++)
		{
			if(gInterface.Button(Event, ztWinPTSearchUser, ePT_SEARCH_USER_PAGEUP1 + i, true))
			{
				int up = i + (  this->Page  * 10 );
				//Packet send	
	...
	if( gInterface.Button(Event, ztWinPTSearchUser, ePT_SEARCH_USER_L, false ) )
	{
		if(this->Page != 0)
		{
			this->Page--;
	...
	else if( gInterface.Button(Event, ztWinPTSearchUser, ePT_SEARCH_USER_R, false ) )
	{
	...
	if(gInterface.Button(Event, ztWinPTSearchUser, ePT_SEARCH_USER_CLOSE, 0))
	{
...
void PartySearch::GC_Recv(LPBYTE aRecv)
{
	...
	if(!gInterface.CheckWindowZt(ztWinPTSearchUser))
	{
		gInterface.OpenWindowZt(ztWinPTSearchUser);
	}
}
// ----------------------------------------------------------------------------------------------
