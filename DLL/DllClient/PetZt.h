...
#define MAX_PETZT_EFFECT		1000
#define PETZT_PATH				".\\Data\\ZtData\\PetZt.dat"
// -------------------------------------------------------------------------------
...
public:
	...
	static PETZT_DATA* GetPetData(int ItemID, bool Preview);
	...
	PETZT_OPTION m_Option[MAX_PETZT_OPTION];
	PETZT_EFFECT m_Effect[MAX_PETZT_EFFECT];
};
