...
void Protocol::DataRecv(DWORD Case, LPBYTE Data, int Len, int aIndex)
{
	...
	if(ProtocolType == 0xC1)
	{
		...
		#if(ENABLE_PETZT)
		//case 0x25:
		//	g_PetZt.RefreshViewPortItem((DWORD)Data);
		//	break;
		#endif
#if(CUSTOM_POSTITEM)
		case 0x78:
...
#if(CUSTOM_ZT_CHAT==TRUE)
				g_InfoLog.GCChatWhisperRecv((CHAT_WHISPER_ZT*)Data);
#endif
			}
			break;
		case 0xF1:
		...
		case 0xFB:
			{
				...
				case 0x09:
					{
						g_PremiumSystemZt.GC_RecvInfo((GC_PREMIUM_SEND*)Data);	
					};
					break;
#endif
				case 14:
				...
				case 16:
					...
					break;
				case 17:
					g_ZtLicense.GCLicenseUser((PMSG_LICENSE_DATA*) Data);
					break;
				case 18:
					gMonsterQuest.RecvKill((GCMonsterQuestKill *) Data);
					break;
				...
				case 0xAD:
					g_PremiumSystemZt.GC_Config((GC_PREMIUM_CONFIG*)Data);
					break;
...
#endif
				case 0xC0:
					g_ZtLicense.GC_UserConfigRecv((PMSG_USERCONFIG*)Data);
					break;
#if(CUSTOM_ZT_QUEST_SYSTEM==TRUE)
				case 0xC3:
					{
						g_ZtWinQuestSystem.GC_MiniInfoRecvZt((GC_ZtWinMiniInfoZt*)Data);
					}
					break;
				case 0xC4:
					{
						g_ZtWinQuestSystem.GC_Start((GC_ZtWinStart*)Data);
					}
					break;
#endif
				...
				case 0xDE:
					gProtocol.GCRecvValueMenu((PMSG_REQ_VALUE_MENU*)Data);
					break;
				#endif
				#if(CUSTOM_MAP_TELEPORT)
				case 0xE2:
					g_MapTeleport.GCAnsSelect((PMSG_ANS_MAPTELEPORT_SELECT*)Data);
					break;
				#endif
				#if(FIX_OBJECT_VIEWE)
				case 0xE9:
					g_ObjectViewe.GCIndexLive((PMSG_OBJECT_LIVE*)Data);
					break;
				#endif
				//#if(ENABLR_DEN_DEV)
				//case 0xEB:
				//	gObjUser.MiniMapSpotRecv((MINIMAP_SPOT_SEND*)Data);
				//	break;
				//#endif
				}
			}
		...
		case 0x3F:
			{
				...
				case 0x01:
					g_PersonalShopZt.GC_ResultPrice((PMSG_ANS_PSHOP_SETITEMPRICE*) Data);
					break;
#endif
				}
			}
		...
		case 0xEC:
			{
				...
				case 0x01:
					#if(DEV_PLAYERSHOP)
					g_ItemMarket.GCAnsItemBuy((PMSG_ANS_MARKET_BUY*)Data);
					#endif
					break;
				};
			}
...
#if(CUSTOM_PERONAL_ZT==TRUE)
				case 0x05:
					g_PersonalShopZt.GC_PSRecv((PMSG_ANS_BUYLIST_FROM_PSHOP*) Data);
					break;
#endif
				}
			}
		...
		case 0xFA:
			{
...
#if(CUSTOM_PERONAL_ZT==TRUE)
				case 0x09:
					g_PersonalShopZt.GC_Recv(Data);
					break;
				case 0x0A:
					g_PersonalShopZt.GC_RecvUpdatePSInvValue(Data);
					break;
				case 0x0B:
					g_PersonalShopZt.GC_RecvUpdatePSInvTargetValue(Data);
					break;
#endif
				case 0x0C:
				...
				case 0x0F:
					g_ZtTeleport.GCWindows((PMSG_GC_TELEPORTWIN*)Data);
					break;
#endif
#if(CUSTOM_ZT_TELEPORT_EVO==TRUE)
				case 0x12:
					g_ZtTeleportEvo.GCWindows((PMSG_GC_TELEPORTWINEVO*)Data);
					break;
#endif
				case 0xBF:
					{
				...
				case 0xCC:
					{
						g_ZtWinQuestSystem.GC_RecvMain((GC_MainPacket*)Data);
					}
					break;
				case 0xCD:
					{
						g_ZtWinQuestSystem.GC_MiniInfoRecv((GC_ZtWinMiniInfo*)Data);
					}
					break;
#endif
				#if(CUSTOM_MAP_TELEPORT)
				case 0xE1:
					g_MapTeleport.GCAnsData((PMSG_ANS_MAPTELEPORT_DATA*)Data);
					break;
				#endif
				#if(ENABLR_DEN_DEV)
				case 0xEB:
				...
				case 0xED:
					g_MiniMapZt.CGMapRecv(Data);
					break;
				#endif
				#if(DEV_PLAYERSHOP)
				case 0xF5:
					g_ItemMarket.GCAnsItemList((PMSG_ANS_MARKET_ITEM*)Data);
					break;
				#endif	
...
void Protocol::RecvConfig(EX_GC_CONFIG_SEND * Data)
{
	...
	gMultiWarehouse = Data->MultiWarehouse;

	gMaxLevel = Data->MaxLevel;
}
...
void Protocol::AutoLogin()
{
	...
	int Enable = GetPrivateProfileIntA("ZtTeam","Enable",0,".\\AutoLogin.ini");
	...
	GetPrivateProfileStringA("ZtTeam", "Account", NULL, acc, sizeof(acc), ".\\AutoLogin.ini");
	GetPrivateProfileStringA("ZtTeam", "Password", NULL, pas, sizeof(pas), ".\\AutoLogin.ini");
#endif
...
void Protocol::GCRecvValueMenu(PMSG_REQ_VALUE_MENU* lpMsg)
{
	if(!lpMsg->ValueOpen)
	{
		return;
	...
	if(lpMsg->ValueOpen == 1)
	{
		...
		gInterface.OpenWindowZt(ObjWindowsZt::ztWinValueMenu);
	}

	if(lpMsg->ValueOpen == 2)
	{
		#if(DELETE_GUILDBANK_BT)	
		gInterface.SetBankHook(true);
		#endif
		...
		gInterface.OpenWindowZt(ObjWindowsZt::ztWinGuildValueMenu);
	}
}

void Protocol::CGSendValueMenu(int ValueType, int ValueNum)
{
	PMSG_ANS_VALUE_MENU pMsg;
	pMsg.h.set((LPBYTE)&pMsg, 0xFB, 0xDE, sizeof(pMsg));
	pMsg.ValueOpen = ValueType;
	pMsg.ValueNumber = ValueNum;
	this->DataSend((LPBYTE)&pMsg, pMsg.h.size);
}
...
void CGSendMultiChar(int Page)
{
	...
	pMsg.h.set((LPBYTE)&pMsg, 0xFB, 0xF0, sizeof(pMsg));
	pMsg.Page = Page;
