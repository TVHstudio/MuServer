...
{
	gInterface.LoadImages("ZtTeam\\QuestSystem\\Buttons\\NewTable.tga", 100000, 0x2601, 0x2900, 1);

	gInterface.LoadImages("ZtTeam\\QuestSystem\\Buttons\\B1On.tga", 100001, 0x2601, 0x2900, 1);
	gInterface.LoadImages("ZtTeam\\QuestSystem\\Buttons\\B2On.tga", 100002, 0x2601, 0x2900, 1);
	gInterface.LoadImages("ZtTeam\\QuestSystem\\Buttons\\B3On.tga", 100003, 0x2601, 0x2900, 1);
	gInterface.LoadImages("ZtTeam\\QuestSystem\\Buttons\\B4On.tga", 100004, 0x2601, 0x2900, 1);
	gInterface.LoadImages("ZtTeam\\QuestSystem\\Buttons\\B5On.tga", 100005, 0x2601, 0x2900, 1);
	gInterface.LoadImages("ZtTeam\\QuestSystem\\Buttons\\B6On.tga", 100006, 0x2601, 0x2900, 1);
	gInterface.LoadImages("ZtTeam\\QuestSystem\\Buttons\\B7On.tga", 100007, 0x2601, 0x2900, 1);
	gInterface.LoadImages("ZtTeam\\QuestSystem\\Buttons\\B8On.tga", 100008, 0x2601, 0x2900, 1);
	gInterface.LoadImages("ZtTeam\\QuestSystem\\Buttons\\B9On.tga", 100009, 0x2601, 0x2900, 1);
	gInterface.LoadImages("ZtTeam\\QuestSystem\\Buttons\\B10On.tga", 100010, 0x2601, 0x2900, 1);

	gInterface.LoadImages("ZtTeam\\QuestSystem\\Buttons\\B1Off.tga", 100011, 0x2601, 0x2900, 1);
	gInterface.LoadImages("ZtTeam\\QuestSystem\\Buttons\\B2Off.tga", 100012, 0x2601, 0x2900, 1);
	gInterface.LoadImages("ZtTeam\\QuestSystem\\Buttons\\B3Off.tga", 100013, 0x2601, 0x2900, 1);
	gInterface.LoadImages("ZtTeam\\QuestSystem\\Buttons\\B4Off.tga", 100014, 0x2601, 0x2900, 1);
	gInterface.LoadImages("ZtTeam\\QuestSystem\\Buttons\\B5Off.tga", 100015, 0x2601, 0x2900, 1);
	gInterface.LoadImages("ZtTeam\\QuestSystem\\Buttons\\B6Off.tga", 100016, 0x2601, 0x2900, 1);
	gInterface.LoadImages("ZtTeam\\QuestSystem\\Buttons\\B7Off.tga", 100017, 0x2601, 0x2900, 1);
	gInterface.LoadImages("ZtTeam\\QuestSystem\\Buttons\\B8Off.tga", 100018, 0x2601, 0x2900, 1);
	gInterface.LoadImages("ZtTeam\\QuestSystem\\Buttons\\B9Off.tga", 100019, 0x2601, 0x2900, 1);
	gInterface.LoadImages("ZtTeam\\QuestSystem\\Buttons\\B10Off.tga", 100020, 0x2601, 0x2900, 1);

	gInterface.LoadImages("ZtTeam\\QuestSystem\\Buttons\\AcceptOn.tga", 100021, 0x2601, 0x2900, 1);
	gInterface.LoadImages("ZtTeam\\QuestSystem\\Buttons\\AcceptOff.tga", 100022, 0x2601, 0x2900, 1);

	gInterface.LoadImages("ZtTeam\\QuestSystem\\Buttons\\RewardOn.tga", 100023, 0x2601, 0x2900, 1);
	gInterface.LoadImages("ZtTeam\\QuestSystem\\Buttons\\RewardOff.tga", 100024, 0x2601, 0x2900, 1);

	gInterface.LoadImages("ZtTeam\\QuestSystem\\Buttons\\Color.tga", 100025, 0x2601, 0x2900, 1);
	gInterface.LoadImages("ZtTeam\\QuestSystem\\Buttons\\Left.tga", 100026, 0x2601, 0x2900, 1);
	gInterface.LoadImages("ZtTeam\\QuestSystem\\Buttons\\Right.tga", 100027, 0x2601, 0x2900, 1);

	gInterface.LoadImages("ZtTeam\\QuestSystem\\Border\\wing1.tga", 100028, 0x2601, 0x2900, 1);
	gInterface.LoadImages("ZtTeam\\QuestSystem\\Border\\wing2.tga", 100029, 0x2601, 0x2900, 1);
	gInterface.LoadImages("ZtTeam\\QuestSystem\\Border\\reward.tga", 100030, 0x2601, 0x2900, 1);	//Reward
	gInterface.LoadImages("ZtTeam\\QuestSystem\\Border\\price.tga", 100031, 0x2601, 0x2900, 1);		//Price
	gInterface.LoadImages("ZtTeam\\QuestSystem\\Border\\drop.tga", 100032, 0x2601, 0x2900, 1);		//Drop
	gInterface.LoadImages("ZtTeam\\QuestSystem\\Border\\kill.tga", 100033, 0x2601, 0x2900, 1);		//kill
	gInterface.LoadImages("ZtTeam\\QuestSystem\\Border\\info.tga", 100034, 0x2601, 0x2900, 1);		//Info Border
	gInterface.LoadImages("ZtTeam\\QuestSystem\\Border\\need.tga", 100035, 0x2601, 0x2900, 1);

	gInterface.LoadImages("ZtTeam\\QuestSystem\\Buttons\\Close.tga", 100036, 0x2601, 0x2900, 1);
}
				...
				case 0x02:
					{
						...
						{
							strncpy(this->Quest[i].Name,Recv->ztQuest[i].Name,50);
							strncpy(this->Quest[i].Info,Recv->ztQuest[i].Info,256);

							this->Quest[i].n = Recv->ztQuest[i].n;
							this->Quest[i].e = Recv->ztQuest[i].e;

							this->Quest[i].Finish = Recv->ztQuest[i].Finish;

							this->Quest[i].start = Recv->ztQuest[i].start;

							this->Quest[i].accept = Recv->ztQuest[i].accept;
							this->Quest[i].reward = Recv->ztQuest[i].reward;

							// ----

							for(int k = 0; k < 5; k++)
							{
								this->Quest[i].MissionType[k] = Recv->ztQuest[i].MissionType[k];
								this->Quest[i].MissionMain[k] = Recv->ztQuest[i].MissionMain[k];
								this->Quest[i].MissionLvL[k] = Recv->ztQuest[i].MissionLvL[k];
								this->Quest[i].MissionLuck[k] = Recv->ztQuest[i].MissionLuck[k];
								this->Quest[i].MissionExl[k] = Recv->ztQuest[i].MissionExl[k];
								this->Quest[i].MissionAnc[k] = Recv->ztQuest[i].MissionAnc[k];

								this->Quest[i].MissionCheck[k] = Recv->ztQuest[i].MissionCheck[k];

								strncpy(this->Quest[i].MissionName[k],Recv->ztQuest[i].MissionName[k],20);

								this->Quest[i].Count[k] = Recv->ztQuest[i].Count[k];
							}
							...
							for(int k = 0; k < 5; k++)
							{
								this->Quest[i].RewardType[k] = Recv->ztQuest[i].RewardType[k];
								this->Quest[i].RewardMain[k] = Recv->ztQuest[i].RewardMain[k];
								this->Quest[i].RewardLvL[k] = Recv->ztQuest[i].RewardLvL[k];
								this->Quest[i].RewardLuck[k] = Recv->ztQuest[i].RewardLuck[k];
								this->Quest[i].RewardExl[k] = Recv->ztQuest[i].RewardExl[k];
								this->Quest[i].RewardAnc[k] = Recv->ztQuest[i].RewardAnc[k];
							}
							...
							for(int k = 0; k < 5; k++)
							{
								this->Quest[i].PriceType[k] = Recv->ztQuest[i].PriceType[k];
								this->Quest[i].PriceMain[k] = Recv->ztQuest[i].PriceMain[k];
								this->Quest[i].PriceLvL[k] = Recv->ztQuest[i].PriceLvL[k];

								this->Quest[i].PriceDone[k] = Recv->ztQuest[i].PriceDone[k];

								this->Quest[i].PriceCheck[k] = Recv->ztQuest[i].PriceCheck[k];
							}

							// ----

							this->Quest[i].NeedLevel = Recv->ztQuest[i].NeedLevel;
							this->Quest[i].NeedReset = Recv->ztQuest[i].NeedReset;
							this->Quest[i].NeedGrand = Recv->ztQuest[i].NeedGrand;

							this->Quest[i].LevelDone = Recv->ztQuest[i].LevelDone;
							this->Quest[i].ResetDone = Recv->ztQuest[i].ResetDone;
							this->Quest[i].GrandDone = Recv->ztQuest[i].GrandDone;
						}
