...
#define RAGE_SYSTEM_DIR ".\\Data\\ZtTeam\\RageSystem.ini"
...
public:
	...
	void ResetRageDraw();
	bool ResetRageCheckAccept();
	void GCRageReset(PMSG_REQ_RESETRAGE* lpMsg);
	void Button(DWORD Event);
	bool m_ResetRageForWCoin;
	bool m_ResetRageForCredit;
