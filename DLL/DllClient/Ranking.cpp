...
{
	gInterface.LoadImages("ZtTeam\\Interface\\top.tga", 100037, 0x2601, 0x2900, 1);
...
void cRanking::Draw()
{
	...
	gInterface.DrawFormat(eGold, TitleX, TitleY, 100, 1, g_ZtText.GetText(48));

	TitleX += 20;
	gInterface.DrawFormat(eGold, TitleX, TitleY, 100, 1, g_ZtText.GetText(49));

	TitleX += 80;
	gInterface.DrawFormat(eGold, TitleX, TitleY, 100, 1, g_ZtText.GetText(50));

	TitleX += 70;
	gInterface.DrawFormat(eGold, TitleX, TitleY, 100, 1, g_ZtText.GetText(51));

	TitleX += 30;
	gInterface.DrawFormat(eGold, TitleX, TitleY, 100, 1, g_ZtText.GetText(52));

	TitleX += 30;
	gInterface.DrawFormat(eGold, TitleX, TitleY, 100, 1, g_ZtText.GetText(53));

	TitleX += 30;
	gInterface.DrawFormat(eGold, TitleX, TitleY, 100, 1, g_ZtText.GetText(54));

	TitleX += 45;
	gInterface.DrawFormat(eGold, TitleX, TitleY, 100, 1, g_ZtText.GetText(55));

	TitleX += 45;
	gInterface.DrawFormat(eGold, TitleX, TitleY, 100, 1, g_ZtText.GetText(56));

	TitleX += 45;
	gInterface.DrawFormat(eGold, TitleX, TitleY, 100, 1, g_ZtText.GetText(57));

	TitleX += 45;
	gInterface.DrawFormat(eGold, TitleX, TitleY, 100, 1, g_ZtText.GetText(58));

	TitleX += 45;
	gInterface.DrawFormat(eGold, TitleX, TitleY, 100, 1, g_ZtText.GetText(59));
	...
	gInterface.DrawFormat(eGold, StartX+100+ButX, StartY+277+ButY, 100, 1, g_ZtText.GetText(34), this->Page,4);
