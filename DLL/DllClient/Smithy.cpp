...
{
	gInterface.LoadImages("ZtTeam\\Interface\\newui_cha_textbox03.tga", zt_SMITHY_TEXT, 0x2601, 0x2900, 1);
	gInterface.LoadImages("ZtTeam\\Interface\\itembackpanel.tga", zt_SMITHY_ITEM, 0x2601, 0x2900, 1);
}
...
void CSmithy::BindImg()
{
	...
	gInterface.BindObject(eSMITHY_INFOBG, zt_NEWS_TITLE, 170, 21, -1, -1);
	gInterface.BindObject(eSMITHY_CLOSE, 0x7EC5, 36, 29, -1, -1);
	gInterface.BindObject(eSMITHY_BACK, 0x7A5E, 108, 29, -1, -1);
	gInterface.BindObject(eSMITHY_TEXT, zt_SMITHY_TEXT, 170, 21, -1, -1);
	gInterface.BindObject(eSMITHY_TEXT2, zt_SMITHY_TEXT, 170, 21, -1, -1);
	gInterface.BindObject(eSMITHY_TEXT3, zt_SMITHY_TEXT, 170, 21, -1, -1);
	gInterface.BindObject(eSMITHY_TEXT4, zt_SMITHY_TEXT, 170, 21, -1, -1);
	gInterface.BindObject(eSMITHY_TEXT5, zt_SMITHY_TEXT, 170, 21, -1, -1);
	gInterface.BindObject(eSMITHY_TEXT6, zt_SMITHY_TEXT, 170, 21, -1, -1);
	gInterface.BindObject(eSMITHY_TEXT7, zt_SMITHY_TEXT, 170, 21, -1, -1);
	gInterface.BindObject(eSMITHY_TEXT8, zt_SMITHY_TEXT, 170, 21, -1, -1);
	gInterface.BindObject(eSMITHY_TEXT9, zt_SMITHY_TEXT, 170, 21, -1, -1);
	gInterface.BindObject(eSMITHY_TEXT10, zt_SMITHY_TEXT, 170, 21, -1, -1);
	...
	gInterface.BindObject(eSMITHY_ITEM_BG, zt_SMITHY_ITEM, 152, 124, -1, -1);
}
...
void CSmithy::Draw()
{
	...
	else if(this->MainPage == SMITHY_OPTION)
	{
		...
		ContentY += 20;
		gInterface.DrawCheckLineZt(this->ItemLuck, eSMITHY_POINT, eSMITHY_CHECK0, eSMITHY_LINE, ContentX-30, ContentY, eWhite, "Luck Option +25%%");
		ContentY += 20;
		...
		{
			gInterface.DrawCheckLineZt(this->ItemOpt2, eSMITHY_POINT, eSMITHY_CHECK2, eSMITHY_LINE, ContentX-30, ContentY, eWhite, "Increase Attackin(Wizardy) speed +5");
			ContentY += 20;
			gInterface.DrawCheckLineZt(this->ItemOpt3, eSMITHY_POINT, eSMITHY_CHECK3, eSMITHY_LINE, ContentX-30, ContentY, eWhite, "Max Ag +50 Increased");
			ContentY += 20;
			gInterface.DrawCheckLineZt(this->ItemOpt4, eSMITHY_POINT, eSMITHY_CHECK4, eSMITHY_LINE, ContentX-30, ContentY, eWhite, "Ignor Optionent's defensive power by 3%%");
			ContentY += 20;
			gInterface.DrawCheckLineZt(this->ItemOpt5, eSMITHY_POINT, eSMITHY_CHECK5, eSMITHY_LINE, ContentX-30, ContentY, eWhite, "Mana +50 Increased");
			ContentY += 20;
			gInterface.DrawCheckLineZt(this->ItemOpt6, eSMITHY_POINT, eSMITHY_CHECK6, eSMITHY_LINE, ContentX-30, ContentY, eWhite, "HP +50 Increased");
		}
		else if(this->CheckWingLevel() == 3)
		{
			gInterface.DrawCheckLineZt(this->ItemOpt3, eSMITHY_POINT, eSMITHY_CHECK3, eSMITHY_LINE, ContentX-30, ContentY, eWhite, "Complete reco of Mana in 5%% rate");
			ContentY += 20;
			gInterface.DrawCheckLineZt(this->ItemOpt4, eSMITHY_POINT, eSMITHY_CHECK4, eSMITHY_LINE, ContentX-30, ContentY, eWhite, "Complete recoy of Life in 5%% rate");
			ContentY += 20;
			gInterface.DrawCheckLineZt(this->ItemOpt5, eSMITHY_POINT, eSMITHY_CHECK5, eSMITHY_LINE, ContentX-30, ContentY, eWhite, "Return the enemy attack power in 5%%");
			ContentY += 20;
			gInterface.DrawCheckLineZt(this->ItemOpt6, eSMITHY_POINT, eSMITHY_CHECK6, eSMITHY_LINE, ContentX-30, ContentY, eWhite, "Ignor openent defensive power by 5%%");
		}
		else if(this->CheckPend() == true)
		{
			gInterface.DrawCheckLineZt(this->ItemOpt1, eSMITHY_POINT, eSMITHY_CHECK1, eSMITHY_LINE, ContentX-30, ContentY, eWhite, "Excellent Damage rate +10%%");
			ContentY += 20;
			//if(this->itemdata[this->Item].Type == 5)
			//{
			//	gInterface.DrawCheckLineZt(this->ItemOpt2, eSMITHY_POINT, eSMITHY_CHECK2, eSMITHY_LINE, ContentX-30, ContentY, eWhite, "Increase Wizardry Damage +level/20");
			//	ContentY += 20;
			//	gInterface.DrawCheckLineZt(this->ItemOpt3, eSMITHY_POINT, eSMITHY_CHECK3, eSMITHY_LINE, ContentX-30, ContentY, eWhite, "Increase Wizardry Damage +2%%");
			//}
			//else
			{
				gInterface.DrawCheckLineZt(this->ItemOpt2, eSMITHY_POINT, eSMITHY_CHECK2, eSMITHY_LINE, ContentX-30, ContentY, eWhite, "Increase Damage +level/20");
				ContentY += 20;
				gInterface.DrawCheckLineZt(this->ItemOpt3, eSMITHY_POINT, eSMITHY_CHECK3, eSMITHY_LINE, ContentX-30, ContentY, eWhite, "Increase Damage +2%%");
			}	
			ContentY += 20;
			gInterface.DrawCheckLineZt(this->ItemOpt4, eSMITHY_POINT, eSMITHY_CHECK4, eSMITHY_LINE, ContentX-30, ContentY, eWhite, "Increase Attacking(Wizardy)speed +7");
			ContentY += 20;
			gInterface.DrawCheckLineZt(this->ItemOpt5, eSMITHY_POINT, eSMITHY_CHECK5, eSMITHY_LINE, ContentX-30, ContentY, eWhite, "Increases Life hunting monsters +life/8");
			ContentY += 20;
			gInterface.DrawCheckLineZt(this->ItemOpt6, eSMITHY_POINT, eSMITHY_CHECK6, eSMITHY_LINE, ContentX-30, ContentY, eWhite, "Increases Mana hunting monsters +Mana/8");
		}
		else if(this->itemdata[this->Item].Type > 5 || this->CheckRing() == true)
		{
			gInterface.DrawCheckLineZt(this->ItemOpt1, eSMITHY_POINT, eSMITHY_CHECK1, eSMITHY_LINE, ContentX-30, ContentY, eWhite, "Increase Max HP +4%%");
			ContentY += 20;
			gInterface.DrawCheckLineZt(this->ItemOpt2, eSMITHY_POINT, eSMITHY_CHECK2, eSMITHY_LINE, ContentX-30, ContentY, eWhite, "Increase Max Mana +4%%");
			ContentY += 20;
			gInterface.DrawCheckLineZt(this->ItemOpt3, eSMITHY_POINT, eSMITHY_CHECK3, eSMITHY_LINE, ContentX-30, ContentY, eWhite, "Damage Decrease +4%%");
			ContentY += 20;
			gInterface.DrawCheckLineZt(this->ItemOpt4, eSMITHY_POINT, eSMITHY_CHECK4, eSMITHY_LINE, ContentX-30, ContentY, eWhite, "Reflect Damage +5%%");
			ContentY += 20;
			gInterface.DrawCheckLineZt(this->ItemOpt5, eSMITHY_POINT, eSMITHY_CHECK5, eSMITHY_LINE, ContentX-30, ContentY, eWhite, "Defense success rate +10%%");
			ContentY += 20;
			gInterface.DrawCheckLineZt(this->ItemOpt6, eSMITHY_POINT, eSMITHY_CHECK6, eSMITHY_LINE, ContentX-30, ContentY, eWhite, "Increases Zen hunting monsters +30%%");
		}
		else
		{
			gInterface.DrawCheckLineZt(this->ItemOpt1, eSMITHY_POINT, eSMITHY_CHECK1, eSMITHY_LINE, ContentX-30, ContentY, eWhite, "Excellent Damage rate +10%%");
		   ...
		   g_ZtLicense.CheckUser(eZtUB::SILVER_Local) )
		{
			...
			gInterface.DrawFormat(eGold, ContentX+120, ContentY+5, 210, 1, "%d", (int)gObjUser.ZtCred);
		}
		else
		{
	...
	if(this->MainPage == SMITHY_OPTION)
	{
		...
		if(g_ZtLicense.CheckUser(eZtUB::Local)		  || 
		   ...
		   g_ZtLicense.CheckUser(eZtUB::SILVER_Local) )
		{
			if(this->GetItemPrice() > gObjUser.ZtCred)
			{
				bPrice = false;
			}
		}
...
{
	if(!gInterface.CheckWindowZt(ztWinSmithyCheck))
	{
		return false;
	}
...
void CSmithy::Button(DWORD Event)
{
		...
		THINNAKORN_MAC)
	{
		if(gInterface.CheckWindowZt(ztWinSmithyCheck))
		{
			if(gInterface.ButtonZt(Event, eSMITHY_CHECKWIN_OK, false))
			{
				this->CGCreateItem();		
				gInterface.CloseWindowZt(ztWinSmithyCheck);
			}
			if(gInterface.ButtonZt(Event, eSMITHY_CHECKWIN_CLOSE, false))
			{		
				gInterface.CloseWindowZt(ztWinSmithyCheck);
			}
			return;
	...
	if(this->MainPage == SMITHY_CLASS)
	{
		...
		{
			int objid = eSMITHY_TEXT+i;
			if(gInterface.ButtonZt(Event, objid, false))
			{
				this->Class = i;
	...
	else if(this->MainPage == SMITHY_ITEM)
	{
		...
		if(gInterface.ButtonZt(Event, eSMITHY_L, false))
		{
		...
		if(gInterface.ButtonZt(Event, eSMITHY_R, false))
		{
	...
	{
		if(gInterface.ButtonZt(Event, eSMITHY_PAGEUP, false) && this->ItemLevel < this->MaxLevel)
		{
			this->ItemLevel++;
		}
		if(gInterface.ButtonZt(Event, eSMITHY_PAGEDN, false) && this->ItemLevel > 0)
		{
			this->ItemLevel--;
		}
		if(gInterface.ButtonZt(Event, eSMITHY_PAGEUP2, false) && this->ItemAdd < 7)
		{
			this->ItemAdd++;
		}
		if(gInterface.ButtonZt(Event, eSMITHY_PAGEDN2, false) && this->ItemAdd > 0)
		{
			this->ItemAdd--;
		}
		if(gInterface.ButtonZt(Event, eSMITHY_CHECK0, false))
		{
		...
		if(gInterface.ButtonZt(Event, eSMITHY_CHECK1, false))
		{
		...
		if(gInterface.ButtonZt(Event, eSMITHY_CHECK2, false))
		{
		...
		if(gInterface.ButtonZt(Event, eSMITHY_CHECK3, false))
		{
		...
		if(gInterface.ButtonZt(Event, eSMITHY_CHECK4, false))
		{
		...
		if(gInterface.ButtonZt(Event, eSMITHY_CHECK5, false))
		{
		...
		if(gInterface.ButtonZt(Event, eSMITHY_CHECK6, false))
		{
	...
	if(this->MainPage == SMITHY_OPTION)
	{
		if(gInterface.ButtonZt(Event, eSMITHY_BT1, false))
		{
			this->MainPage--;
		}
		if(gInterface.ButtonZt(Event, eSMITHY_BT2, true))
		{
			if( /*g_ZtLicense.CheckUser(eZtUB::Local)  ||*/ 
				g_ZtLicense.CheckUser(eZtUB::Gredy)			|| 
				g_ZtLicense.CheckUser(eZtUB::Gredy2)		|| 
				...
				THINNAKORN_MAC)
			{
				gInterface.OpenWindowZt(ztWinSmithyCheck);
			}
			else
			{
				this->CGCreateItem();
	...
	{
		if(gInterface.ButtonZt(Event, eSMITHY_BACK, false))
		{
			if(this->MainPage == SMITHY_CLASS)
			{
				gInterface.CloseWindowZt(ztWinSmithy);
				this->CloseWindow();
			}
	...
	if(gInterface.ButtonZt(Event, eSMITHY_CLOSE, false))
	{
