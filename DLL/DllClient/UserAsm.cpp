...
Naked(CharacterInfoExtern)
{
	if(gGRANDRESET)
	{
		sprintf(CharacterInfoExtern_LevelBuff, g_ZtText.GetText(21), ReturnUserLevel(), gObjUser.Reset,gObjUser.GReset);
	}
	else
	{
		sprintf(CharacterInfoExtern_LevelBuff, g_ZtText.GetText(22), ReturnUserLevel(), gObjUser.Reset);
	}
