...
void cWinQuest::GetMemberInfoEx(GDSelectQuest *Recv, int aIndex)
{
	...
	{
		int iDamage = this->m_DBQuery.GetInt("Damage");	
		int iDefence = this->m_DBQuery.GetInt("Defence");	
		int iLife = this->m_DBQuery.GetInt("Life");	
		int iSD = this->m_DBQuery.GetInt("SD");	
		int iCrit = this->m_DBQuery.GetInt("Crit");
		int iExel = this->m_DBQuery.GetInt("Exel");
		int iDouble = this->m_DBQuery.GetInt("DD");
		int iIgnore = this->m_DBQuery.GetInt("Ignore");
		int iRef = this->m_DBQuery.GetInt("Ref");	
		int iExp = this->m_DBQuery.GetInt("Exp");
		int iDrop = this->m_DBQuery.GetInt("Dr");	
