...
public:
	...
	void	DG_ZtBuffLoad(PMSG_REQ_ZTBUFF_LOAD *aRecv, int uIndex);
	void	GD_ZtBuffSave(PMSG_REQ_ZTBUFF_SAVE *aRecv);
	...
	void	DG_ZtQuestSystemLoad(PMSG_REQ_ZTQUESTSYSTEM_LOAD *aRecv, int uIndex);
	void	GD_ZtQuestSystemSave(PMSG_REQ_ZTQUESTSYSTEM_SAVE *aRecv);
