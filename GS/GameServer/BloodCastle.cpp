...
static const int g_iBC_Party_EventPoint[MAX_USER_IN_PARTY]	= {5, 10, 15, 20, 30, 35, 40, 45, 50, 55 };
#else
...
int CBloodCastle::EnterUserBridge(int iBridgeIndex, int iUserIndex)
{
	...
	for ( int i=0;i<MAX_BLOOD_CASTLE_SUB_BRIDGE;i++)
	{
		...
		{
			if( i > ZtConfig.m_iBloodCastleMaxUser)
			{
				break;
			}
		}
...
int CBloodCastle::LevelUp(int iIndex, int iAddExp, int iEventType)
{
	...
	if(g_MasterLevelSystem.MasterLevelUp(&gObj[iIndex], (__int64&)iAddExp,1,0) != 0) //season3 add-on
	{
		return 0;
	}
	...
	if ( gObj[iIndex].Level >= ZtConfig.ZtCustom.MaxLevel )
	{
	...
	if ( gObj[iIndex].Type == OBJ_USER )
	{
		while ( iCAL_EXP > 0 )
		{
			if ( iCAL_EXP > 0 )
			{
				...
				gObjUserSetExp(&gObj[iIndex],iCAL_EXP);	//Panda Use
...
void CBloodCastle::DropChaosGem(int iIndex) //00552850
{
...
#if(SYSTEM_ACHIEVEMENTS)
	g_Achievements.CompleteBC(iIndex);
#endif
	...
	////Configs
	//int Zt_BCDropType	= GetPrivateProfileInt("BloodCastle","BCDropType",12,"..\\Data\\ZtData\\Events.ini");
	//int Zt_BCDropID		= GetPrivateProfileInt("BloodCastle","BCDropID",15,"..\\Data\\ZtData\\Events.ini");
	//int Zt_BCDropLevel	= GetPrivateProfileInt("BloodCastle","BCDropLevel",0,"..\\Data\\ZtData\\Events.ini");
	//int Zt_BCDropSkill	= GetPrivateProfileInt("BloodCastle","BCDropSkill",0,"..\\Data\\ZtData\\Events.ini");
	//int Zt_BCDropLuck	= GetPrivateProfileInt("BloodCastle","BCDropLuck",0,"..\\Data\\ZtData\\Events.ini");
	//int Zt_BCDropOpt	= GetPrivateProfileInt("BloodCastle","BCDropOpt",0,"..\\Data\\ZtData\\Events.ini");
	//int Zt_BCDropExcOpt	= GetPrivateProfileInt("BloodCastle","BCDropExcOpt",0,"..\\Data\\ZtData\\Events.ini");
	//int Zt_BCDropAncOpt	= GetPrivateProfileInt("BloodCastle","BCDropAncOpt",0,"..\\Data\\ZtData\\Events.ini");



	//Zt_BCDropLuck_DRYNEA
	int Exe1 = 0;
	int Anc1 = 0;

#ifdef BC_LVL_DROP
	//if(g_ZtLicense.CheckUser(eZtUB::drynea) || g_ZtLicense.CheckUser(eZtUB::Local2) || g_ZtLicense.CheckUser(eZtUB::Local))
	//{
	//	switch(gObj[iIndex].MapNumber)
	//	{
	//	case MAP_INDEX_BLOODCASTLE1:
	//		{
	//			if ( ZtConfig.Event.Zt_BCDropExcOpt_DRYNEA[1] > 0 )
	//			Exe1 = GenExcOpt(ZtConfig.Event.Zt_BCDropExcOpt_DRYNEA[1]);

	//			if ( ZtConfig.Event.Zt_BCDropAncOpt_DRYNEA[1] == 5 || ZtConfig.Event.Zt_BCDropAncOpt_DRYNEA[1] == 10 )
	//			Anc1 = ZtConfig.Event.Zt_BCDropAncOpt_DRYNEA[1];

	//			int iType = ItemGetNumberMake(ZtConfig.Event.Zt_BCDropType_DRYNEA[1], ZtConfig.Event.Zt_BCDropID_DRYNEA[1]);

	//			ItemSerialCreateSend(gObj[iIndex].m_Index, (BYTE)iMapNumber, (BYTE)gObj[iIndex].X, (BYTE)gObj[iIndex].Y, iType, 
	//			(BYTE)ZtConfig.Event.Zt_BCDropLevel_DRYNEA[1], 0, (BYTE)ZtConfig.Event.Zt_BCDropSkill_DRYNEA[1], (BYTE)ZtConfig.Event.Zt_BCDropLuck_DRYNEA[1], 
	//			(BYTE)ZtConfig.Event.Zt_BCDropOpt_DRYNEA[1], iMaxHitUser, (BYTE)Exe1, (BYTE)Anc1);
	//		}
	//		break;
	//	case MAP_INDEX_BLOODCASTLE2:
	//		{
	//			if ( ZtConfig.Event.Zt_BCDropExcOpt_DRYNEA[2] > 0 )
	//			Exe1 = GenExcOpt(ZtConfig.Event.Zt_BCDropExcOpt_DRYNEA[2]);

	//			if ( ZtConfig.Event.Zt_BCDropAncOpt_DRYNEA[2] == 5 || ZtConfig.Event.Zt_BCDropAncOpt_DRYNEA[2] == 10 )
	//			Anc1 = ZtConfig.Event.Zt_BCDropAncOpt_DRYNEA[2];

	//			int iType = ItemGetNumberMake(ZtConfig.Event.Zt_BCDropType_DRYNEA[2], ZtConfig.Event.Zt_BCDropID_DRYNEA[2]);

	//			ItemSerialCreateSend(gObj[iIndex].m_Index, (BYTE)iMapNumber, (BYTE)gObj[iIndex].X, (BYTE)gObj[iIndex].Y, iType, 
	//			(BYTE)ZtConfig.Event.Zt_BCDropLevel_DRYNEA[2], 0, (BYTE)ZtConfig.Event.Zt_BCDropSkill_DRYNEA[2], (BYTE)ZtConfig.Event.Zt_BCDropLuck_DRYNEA[2], 
	//			(BYTE)ZtConfig.Event.Zt_BCDropOpt_DRYNEA[2], iMaxHitUser, (BYTE)Exe1, (BYTE)Anc1);
	//		}
	//		break;
	//	case MAP_INDEX_BLOODCASTLE3:
	//		{
	//			if ( ZtConfig.Event.Zt_BCDropExcOpt_DRYNEA[3] > 0 )
	//			Exe1 = GenExcOpt(ZtConfig.Event.Zt_BCDropExcOpt_DRYNEA[3]);

	//			if ( ZtConfig.Event.Zt_BCDropAncOpt_DRYNEA[3] == 5 || ZtConfig.Event.Zt_BCDropAncOpt_DRYNEA[3] == 10 )
	//			Anc1 = ZtConfig.Event.Zt_BCDropAncOpt_DRYNEA[3];

	//			int iType = ItemGetNumberMake(ZtConfig.Event.Zt_BCDropType_DRYNEA[3], ZtConfig.Event.Zt_BCDropID_DRYNEA[3]);

	//			ItemSerialCreateSend(gObj[iIndex].m_Index, (BYTE)iMapNumber, (BYTE)gObj[iIndex].X, (BYTE)gObj[iIndex].Y, iType, 
	//			(BYTE)ZtConfig.Event.Zt_BCDropLevel_DRYNEA[3], 0, (BYTE)ZtConfig.Event.Zt_BCDropSkill_DRYNEA[3], (BYTE)ZtConfig.Event.Zt_BCDropLuck_DRYNEA[3], 
	//			(BYTE)ZtConfig.Event.Zt_BCDropOpt_DRYNEA[3], iMaxHitUser, (BYTE)Exe1, (BYTE)Anc1);
	//		}
	//		break;
	//	case MAP_INDEX_BLOODCASTLE4:
	//		{
	//			if ( ZtConfig.Event.Zt_BCDropExcOpt_DRYNEA[4] > 0 )
	//			Exe1 = GenExcOpt(ZtConfig.Event.Zt_BCDropExcOpt_DRYNEA[4]);

	//			if ( ZtConfig.Event.Zt_BCDropAncOpt_DRYNEA[4] == 5 || ZtConfig.Event.Zt_BCDropAncOpt_DRYNEA[4] == 10 )
	//			Anc1 = ZtConfig.Event.Zt_BCDropAncOpt_DRYNEA[4];

	//			int iType = ItemGetNumberMake(ZtConfig.Event.Zt_BCDropType_DRYNEA[4], ZtConfig.Event.Zt_BCDropID_DRYNEA[4]);

	//			ItemSerialCreateSend(gObj[iIndex].m_Index, (BYTE)iMapNumber, (BYTE)gObj[iIndex].X, (BYTE)gObj[iIndex].Y, iType, 
	//			(BYTE)ZtConfig.Event.Zt_BCDropLevel_DRYNEA[4], 0, (BYTE)ZtConfig.Event.Zt_BCDropSkill_DRYNEA[4], (BYTE)ZtConfig.Event.Zt_BCDropLuck_DRYNEA[4], 
	//			(BYTE)ZtConfig.Event.Zt_BCDropOpt_DRYNEA[4], iMaxHitUser, (BYTE)Exe1, (BYTE)Anc1);
	//		}
	//		break;
	//	case MAP_INDEX_BLOODCASTLE5:
	//		{
	//			if ( ZtConfig.Event.Zt_BCDropExcOpt_DRYNEA[5] > 0 )
	//			Exe1 = GenExcOpt(ZtConfig.Event.Zt_BCDropExcOpt_DRYNEA[5]);

	//			if ( ZtConfig.Event.Zt_BCDropAncOpt_DRYNEA[5] == 5 || ZtConfig.Event.Zt_BCDropAncOpt_DRYNEA[5] == 10 )
	//			Anc1 = ZtConfig.Event.Zt_BCDropAncOpt_DRYNEA[5];

	//			int iType = ItemGetNumberMake(ZtConfig.Event.Zt_BCDropType_DRYNEA[5], ZtConfig.Event.Zt_BCDropID_DRYNEA[5]);

	//			ItemSerialCreateSend(gObj[iIndex].m_Index, (BYTE)iMapNumber, (BYTE)gObj[iIndex].X, (BYTE)gObj[iIndex].Y, iType, 
	//			(BYTE)ZtConfig.Event.Zt_BCDropLevel_DRYNEA[5], 0, (BYTE)ZtConfig.Event.Zt_BCDropSkill_DRYNEA[5], (BYTE)ZtConfig.Event.Zt_BCDropLuck_DRYNEA[5], 
	//			(BYTE)ZtConfig.Event.Zt_BCDropOpt_DRYNEA[5], iMaxHitUser, (BYTE)Exe1, (BYTE)Anc1);
	//		}
	//		break;
	//	case MAP_INDEX_BLOODCASTLE6:
	//		{
	//			if ( ZtConfig.Event.Zt_BCDropExcOpt_DRYNEA[6] > 0 )
	//			Exe1 = GenExcOpt(ZtConfig.Event.Zt_BCDropExcOpt_DRYNEA[6]);

	//			if ( ZtConfig.Event.Zt_BCDropAncOpt_DRYNEA[6] == 5 || ZtConfig.Event.Zt_BCDropAncOpt_DRYNEA[6] == 10 )
	//			Anc1 = ZtConfig.Event.Zt_BCDropAncOpt_DRYNEA[6];

	//			int iType = ItemGetNumberMake(ZtConfig.Event.Zt_BCDropType_DRYNEA[6], ZtConfig.Event.Zt_BCDropID_DRYNEA[6]);

	//			ItemSerialCreateSend(gObj[iIndex].m_Index, (BYTE)iMapNumber, (BYTE)gObj[iIndex].X, (BYTE)gObj[iIndex].Y, iType, 
	//			(BYTE)ZtConfig.Event.Zt_BCDropLevel_DRYNEA[6], 0, (BYTE)ZtConfig.Event.Zt_BCDropSkill_DRYNEA[6], (BYTE)ZtConfig.Event.Zt_BCDropLuck_DRYNEA[6], 
	//			(BYTE)ZtConfig.Event.Zt_BCDropOpt_DRYNEA[6], iMaxHitUser, (BYTE)Exe1, (BYTE)Anc1);
	//		}
	//		break;
	//	case MAP_INDEX_BLOODCASTLE7:
	//		{
	//			if ( ZtConfig.Event.Zt_BCDropExcOpt_DRYNEA[7] > 0 )
	//			Exe1 = GenExcOpt(ZtConfig.Event.Zt_BCDropExcOpt_DRYNEA[7]);

	//			if ( ZtConfig.Event.Zt_BCDropAncOpt_DRYNEA[7] == 5 || ZtConfig.Event.Zt_BCDropAncOpt_DRYNEA[7] == 10 )
	//			Anc1 = ZtConfig.Event.Zt_BCDropAncOpt_DRYNEA[7];

	//			int iType = ItemGetNumberMake(ZtConfig.Event.Zt_BCDropType_DRYNEA[7], ZtConfig.Event.Zt_BCDropID_DRYNEA[7]);

	//			ItemSerialCreateSend(gObj[iIndex].m_Index, (BYTE)iMapNumber, (BYTE)gObj[iIndex].X, (BYTE)gObj[iIndex].Y, iType, 
	//			(BYTE)ZtConfig.Event.Zt_BCDropLevel_DRYNEA[7], 0, (BYTE)ZtConfig.Event.Zt_BCDropSkill_DRYNEA[7], (BYTE)ZtConfig.Event.Zt_BCDropLuck_DRYNEA[7], 
	//			(BYTE)ZtConfig.Event.Zt_BCDropOpt_DRYNEA[7], iMaxHitUser, (BYTE)Exe1, (BYTE)Anc1);
	//		}
	//		break;
	//	case MAP_INDEX_BLOODCASTLE8:
	//		{
	//			if ( ZtConfig.Event.Zt_BCDropExcOpt_DRYNEA[8] > 0 )
	//			Exe1 = GenExcOpt(ZtConfig.Event.Zt_BCDropExcOpt_DRYNEA[8]);

	//			if ( ZtConfig.Event.Zt_BCDropAncOpt_DRYNEA[8] == 5 || ZtConfig.Event.Zt_BCDropAncOpt_DRYNEA[8] == 10 )
	//			Anc1 = ZtConfig.Event.Zt_BCDropAncOpt_DRYNEA[8];

	//			int iType = ItemGetNumberMake(ZtConfig.Event.Zt_BCDropType_DRYNEA[8], ZtConfig.Event.Zt_BCDropID_DRYNEA[8]);

	//			ItemSerialCreateSend(gObj[iIndex].m_Index, (BYTE)iMapNumber, (BYTE)gObj[iIndex].X, (BYTE)gObj[iIndex].Y, iType, 
	//			(BYTE)ZtConfig.Event.Zt_BCDropLevel_DRYNEA[8], 0, (BYTE)ZtConfig.Event.Zt_BCDropSkill_DRYNEA[8], (BYTE)ZtConfig.Event.Zt_BCDropLuck_DRYNEA[8], 
	//			(BYTE)ZtConfig.Event.Zt_BCDropOpt_DRYNEA[8], iMaxHitUser, (BYTE)Exe1, (BYTE)Anc1);
	//		}
	//		break;
	//	}
	//}
	//else
	{
		if (!gBloodCastleRewardItem.Main(gObj[iIndex].m_Index))
		{
			if ( ZtConfig.Event.Zt_BCDropExcOpt > 0 )
			Exe1 = GenExcOpt(ZtConfig.Event.Zt_BCDropExcOpt);

			if ( ZtConfig.Event.Zt_BCDropAncOpt == 5 || ZtConfig.Event.Zt_BCDropAncOpt == 10 )
			Anc1 = ZtConfig.Event.Zt_BCDropAncOpt;

			int iType = ItemGetNumberMake(ZtConfig.Event.Zt_BCDropType, ZtConfig.Event.Zt_BCDropID);

			ItemSerialCreateSend(gObj[iIndex].m_Index, (BYTE)iMapNumber, (BYTE)gObj[iIndex].X, (BYTE)gObj[iIndex].Y, iType, 
			(BYTE)ZtConfig.Event.Zt_BCDropLevel, 0, (BYTE)ZtConfig.Event.Zt_BCDropSkill, (BYTE)ZtConfig.Event.Zt_BCDropLuck, 
			(BYTE)ZtConfig.Event.Zt_BCDropOpt, iMaxHitUser, (BYTE)Exe1, (BYTE)Anc1);
		}
	}
	...
	for(int i = 0; i < ZtConfig.Event.Zt_BCRewardLevelUp; i++)
	{
		__int64 exp = gLevelExperience[gObj[iIndex].Level];
		gObj[iIndex].Experience = exp;
		gObjLevelUp(&gObj[iIndex], exp, gObj[iIndex].Class, 0);
	}
	#endif
...
bool CBloodCastle::CheckAngelKingExist(int iBridgeIndex) //005535E0
{
	...
	for ( int i=0;i<OBJ_STARTUSERINDZT;i++)
	{
