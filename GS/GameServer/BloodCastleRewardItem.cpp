...
{
	this->Enable = GetPrivateProfileInt("ZtTeam","Enable",0,BC_REWARD_ITEM_DIR);
	this->m_iRewardItemCount = GetPrivateProfileInt("ZtTeam","RewardItemCount",0,BC_REWARD_ITEM_DIR);
