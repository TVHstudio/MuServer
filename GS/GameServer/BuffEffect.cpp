...
#ifdef DEBUG_CODE
	LogAddC(1,"btBuffIndex: %d",btBuffIndex);
#endif
...
LPBUFF_EFFECT_DATA CBuffEffect::GetBuffDataFromItemCode(WORD wItemCode)
{
	LPBUFF_EFFECT_DATA lpBuffData = 0;

#ifdef DEBUG_CODE
	LogAddC(1,"wItemCode: %d",wItemCode);
#endif
