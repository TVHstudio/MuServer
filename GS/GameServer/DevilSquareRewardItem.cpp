...
void cDevilSquareRewardItem::Load()
{
	...
	this->Enable = GetPrivateProfileInt("ZtTeam","Enable",0,DS_REWARD_ITEM_DIR);
	this->m_iRewardItemCount = GetPrivateProfileInt("ZtTeam","RewardItemCount",0,DS_REWARD_ITEM_DIR);
	for (int j = 1; j < 8; j++)
	{
