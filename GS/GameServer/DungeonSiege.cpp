...
void CDungeonSiege::Load()
{
	...
	{
		this->Read(gDirPath.GetNewPath("ZtData\\Events\\DungeonSiege.ini"));
	}
...
{
	this->bEnable					= GetPrivateProfileInt("ZtTeam", "Enable", 0, filename);
	this->iNpcClass					= GetPrivateProfileInt("ZtTeam", "NpcClass", 0, filename);
	this->iNpcMap					= GetPrivateProfileInt("ZtTeam", "NpcMap", 0, filename);
	this->iNpcX						= GetPrivateProfileInt("ZtTeam", "NpcX", 0, filename);
	this->iNpcY						= GetPrivateProfileInt("ZtTeam", "NpcY", 0, filename);
	this->iEventStartDay			= GetPrivateProfileInt("ZtTeam", "EventStartDay", 0, filename);
	this->iEventStartHour			= GetPrivateProfileInt("ZtTeam", "EventStartHour", 0, filename);
	this->iEventeStartMinut			= GetPrivateProfileInt("ZtTeam", "EventeStartMinut", 0, filename);
	this->iEventDurationStage1		= GetPrivateProfileInt("ZtTeam", "EventDurationStage1", 0, filename);
	this->iEventDurationStage2		= GetPrivateProfileInt("ZtTeam", "EventDurationStage2", 0, filename);
	this->iEventDurationWait1		= GetPrivateProfileInt("ZtTeam", "EventDurationWait1", 0, filename);
	this->iEventDurationWait2		= GetPrivateProfileInt("ZtTeam", "EventDurationWait2", 0, filename);
	this->m_EventMapNumber			= GetPrivateProfileInt("ZtTeam", "EventMapNumber", 0, filename);
	this->m_EventStage1WaitX		= GetPrivateProfileInt("ZtTeam", "EventStage1WaitX", 0, filename);
	this->m_EventStage1WaitY		= GetPrivateProfileInt("ZtTeam", "EventStage1WaitY", 0, filename);
	this->m_EventStage1KillX		= GetPrivateProfileInt("ZtTeam", "EventStage1KillX", 0, filename);
	this->m_EventStage1KillY		= GetPrivateProfileInt("ZtTeam", "EventStage1KillY", 0, filename);
	this->m_EventStage2WaitX		= GetPrivateProfileInt("ZtTeam", "EventStage2WaitX", 0, filename);
	this->m_EventStage2WaitY		= GetPrivateProfileInt("ZtTeam", "EventStage2WaitY", 0, filename);
	this->m_EventStage2KillX		= GetPrivateProfileInt("ZtTeam", "EventStage2KillX", 0, filename);
	this->m_EventStage2KillY		= GetPrivateProfileInt("ZtTeam", "EventStage2KillY", 0, filename);
	this->m_EventPlayerDieMap		= GetPrivateProfileInt("ZtTeam", "EventPlayerDieMap", 0, filename);
	this->m_EventPlayerDieX			= GetPrivateProfileInt("ZtTeam", "EventPlayerDieX", 0, filename);
	this->m_EventPlayerDieY			= GetPrivateProfileInt("ZtTeam", "EventPlayerDieY", 0, filename);
	this->m_BuffEnable				= GetPrivateProfileInt("ZtTeam", "BuffEnable", 0, filename);
	this->m_BuffPlusAttackPercent	= GetPrivateProfileInt("ZtTeam", "BuffPlusAttackPercent", 0, filename);
	this->m_BuffPlusDefencePercent	= GetPrivateProfileInt("ZtTeam", "BuffPlusDefencePercent", 0, filename);
	this->m_RewardEnable			= GetPrivateProfileInt("ZtTeam", "RewardEnable", 0, filename);
	this->m_RewardItemEnable		= GetPrivateProfileInt("ZtTeam", "RewardItemEnable", 0, filename);
	this->m_RewardItemType			= GetPrivateProfileInt("ZtTeam", "RewardItemType", 0, filename);
	this->m_RewardItemIndex			= GetPrivateProfileInt("ZtTeam", "RewardItemIndex", 0, filename);
	this->m_RewardItemLevel			= GetPrivateProfileInt("ZtTeam", "RewardItemLevel", 0, filename);
	this->m_RewardWCoinC			= GetPrivateProfileInt("ZtTeam", "RewardWCoinC", 0, filename);
	this->m_RewardWcoinP			= GetPrivateProfileInt("ZtTeam", "RewardWcoinP", 0, filename);
	this->m_RewardWgoinG			= GetPrivateProfileInt("ZtTeam", "RewardWgoinG", 0, filename);
	this->m_RewardCredit			= GetPrivateProfileInt("ZtTeam", "RewardCredit", 0, filename);
	this->m_FinalScoreForVictory	= GetPrivateProfileInt("ZtTeam", "FinalScoreForVictory", 0, filename);
	this->m_MinPlayerGuildReg		= GetPrivateProfileInt("ZtTeam", "MinPlayerGuildReg", 0, filename);
	this->m_NpcTeleportMinusScore	= GetPrivateProfileInt("ZtTeam", "NpcTeleportMinusScore", 0, filename);
	GetPrivateProfileString("ZtTeam", "EventName", "Dungeon Siege", this->m_EventName, sizeof(this->m_EventName), filename);
}
...
void CDungeonSiege::RewardSiege(int aIndex)
{
	...
	{
		lpUser->ZtCred += this->m_RewardCredit;
	}
...
bool CDungeonSiege::DeleteGuildUser(int aIndex)
{
	...
	//Владельцам запретит?распускать гильду
	if(lpUser->GuildNumber > 0 && this->bCaptured)
	{
		if(lpUser->GuildName[0] == this->szLordGuild[0])
		{
