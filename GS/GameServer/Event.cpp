	...
	if ( GoldMedalItemBag->GetBagCount() > 0 )
	{
		if ( (rand()%20) < g_ItemDropRateForGoldMedal )
		{
				 ...
				 type == ITEMGET(12,143))
			{
				...
				Option2 = 0;
				Option3 = 0;
				level = GoldMedalItemBag->GetLevel(DropItemNum);
				ExOption = 0;
			}
	...
	if ( SilverMedalItemBag->GetBagCount() > 0 )
	{
		if ( (rand()%20) < g_ItemDropRateForSilverMedal )
		{
				 ...
				 type == ITEMGET(12,143))
			{
				...
				Option2 = 0;
				Option3 = 0;
				level = SilverMedalItemBag->GetLevel(DropItemNum);
				ExOption = 0;
			}
	...
	if ( FireCrackerItemBag->GetBagCount() > 0 )
	{
		if ( (rand()%10) < g_ItemDropRateForgFireCracker )
		{
				 ...
				 type == ITEMGET(12,143))
			{
				...
				Option2 = 0;
				Option3 = 0;
				level = FireCrackerItemBag->GetLevel(DropItemNum);
			}
	...
	if ( RingEventItemBag->GetBagCount() > 0 )
	{
		if ( (rand()%10) < 9 )
		{
				 ...
				 type == ITEMGET(12,143))
			{
				...
				Option2 = 0;
				Option3 = 0;
				level = RingEventItemBag->GetLevel(DropItemNum);
			}
	...
	if ( FriendShipItemBag->GetBagCount() > 0 ) //season 3.0 fixed
	{
		if ( true )
		{
				 ...
				 type == ITEMGET(12,143))
			{
				...
				Option2 = 0;
				Option3 = 0;
				level = FriendShipItemBag->GetLevel(DropItemNum);
			}
...
void RingOfHeroBoxOpen(LPOBJ lpObj)
{
	...
	if ( RingOfHeroBoxItemBag->GetBagCount() > 0 && (rand()%10) < 9)
	{
				...
				type == ITEMGET(12,143))
		{
			...
			Option2 = 0;
			Option3 = 0;
			level = RingOfHeroBoxItemBag->GetLevel(DropItemNum);
		}
...
//Season 5 New Box
//void ShiningJewelryCaseItemBagOpen(LPOBJ lpObj, BYTE btMapNumber, BYTE cX, BYTE cY)
//{
//	ShiningJewelryCase->DropShiningJewelryCase(lpObj->m_Index, btMapNumber, cX, cY);
//}
//void ElegantJewelryCaseItemBagOpen(LPOBJ lpObj, BYTE btMapNumber, BYTE cX, BYTE cY)
//{
//	ElegantJewelryCase->DropElegantJewelryCase(lpObj->m_Index, btMapNumber, cX, cY);
//}
//void SteelJewelryCaseItemBagOpen(LPOBJ lpObj, BYTE btMapNumber, BYTE cX, BYTE cY)
//{
//	SteelJewelryCase->DropSteelJewelryCase(lpObj->m_Index, btMapNumber, cX, cY);
//}
//void OldJewelryCaseItemBagOpen(LPOBJ lpObj, BYTE btMapNumber, BYTE cX, BYTE cY)
//{
//	OldJewelryCase->DropOldJewelryCase(lpObj->m_Index, btMapNumber, cX, cY);
//}
