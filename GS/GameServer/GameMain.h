...
extern CItemBagZt * StarOfXMasItemBag;
...
extern CItemBagZt * KundunEventItemBag;

//#if(GS_CASTLE==1)
extern CItemBagZt * CastleHuntZoneBossItemBag;
extern CItemBagZt * CastleItemMixItemBag;
//#endif

extern CItemBagZt * HiddenTreasureBoxItemBag;
extern CItemBagZt * RedRibbonBoxEventItemBag;
extern CItemBagZt * GreenRibbonBoxEventItemBag;
extern CItemBagZt * BlueRibbonBoxEventItemBag;
extern CItemBagZt * PinkChocolateBoxEventItemBag;
extern CItemBagZt * RedChocolateBoxEventItemBag;
extern CItemBagZt * BlueChocolateBoxEventItemBag;
extern CItemBagZt * LightPurpleCandyBoxEventItemBag;
extern CItemBagZt * VermilionCandyBoxEventItemBag;
extern CItemBagZt * DeepBlueCandyBoxEventItemBag;
extern CItemBagZt * CrywolfDarkElfItemBag;
extern CItemBagZt * CrywolfBossMonsterItemBag;

//#if(GS_CASTLE==0)
extern CItemBagZt * KanturuMayaHandItemBag;
extern CItemBagZt * KanturuNightmareItemBag;
//#endif

extern CItemBagZt * SilverChestItemBag;	//Season 5 DoppelGanger
extern CItemBagZt * GoldenChestItemBag;	//Season 5 DoppelGanger

//Season 5 New Box
//extern CItemBagZt * ShiningJewelryCase;	
//extern CItemBagZt * ElegantJewelryCase;	
//extern CItemBagZt * SteelJewelryCase;	
//extern CItemBagZt * OldJewelryCase;	

extern CItemBagZt * HallowinDayEventItemBag;
...
extern int  ZtDbPort;
extern int  RankingPort;
extern int  EventPort;
...
extern wsJoinServerCli wsZtDbCli;
...
//Common Next
extern int ZtParty3ExpPercent;
extern int ZtParty4ExpPercent;
extern int ZtParty5ExpPercent;
extern int ZtPartyExpPercentOther;
extern int ZtParty2ExpSetPercent;
extern int ZtParty3ExpSetPercent;
extern int ZtParty4ExpSetPercent;
extern int ZtParty5ExpSetPercent;
extern int ZtParty1ExpSetPercent;
#if _NEW_PARTY_SYSTEM_ == TRUE
extern int g_MaxPartyMember;
extern int ZtParty6ExpPercent;
extern int ZtParty7ExpPercent;
extern int ZtParty8ExpPercent;
extern int ZtParty9ExpPercent;
extern int ZtParty10ExpPercent;
extern int ZtParty6ExpSetPercent;
extern int ZtParty7ExpSetPercent;
extern int ZtParty8ExpSetPercent;
extern int ZtParty9ExpSetPercent;
extern int ZtParty10ExpSetPercent;
#endif

extern int ExDropZenParty;
extern int AllianceMinPlayers;

extern int ZtExcellentAncient;
extern int ZtExcellentSocket;
extern int ZtAncientSocket;
extern int ZtAddJoHtoAnc;
extern int Zt_ItemsDurationTime;
extern int	Zt_LifeRate;
extern int	Zt_SoulRate;
extern int	Zt_SoulRateLuck;
...
extern int  gSilverMedalDropLevelMonsterMin;
extern int  gSilverMedalDropLevelMonsterMax;
extern int  gGoldMedalDropLevelMonsterMin;
extern int  gGoldMedalDropLevelMonsterMax;

#if(LICENSE_UKRAINE)
extern int gSelectServerSecondCount;
extern int gSwitchCharacterSecondCount;
#endif
//-----
