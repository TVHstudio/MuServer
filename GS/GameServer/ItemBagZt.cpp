...
void CItemBagZt::Init(char* name)
{
	this->m_bLoad = FALSE;
...
void CItemBagZt::LoadItem(char* script_file)
{
	int Token;
		...
		if ( Token == 1 )
		{
			...
			if ( st == 0 )
			{
				while ( true )
				{
					...
					{
						MsgBox("ZtEvent ItemBag LoadFail [%s]", script_file);
						return;
					}
...
BYTE CItemBagZt::GetLevel(int n)
{
...
#if(FIX_CRASH==TRUE)
	if(this->BagObject[n].m_minLevel < 0 )
	{
		return 0;
	}
...
BOOL CItemBagZt::IsEnableEventItemDrop(int aIndex)
{
...
BOOL CItemBagZt::DropEventItem(int aIndex)
{
...
BOOL CItemBagZt::DropItem(int aIndex)
{
	if ( this->m_bLoad == FALSE )
	{
		return FALSE;
...
BYTE CItemBagZt::GetMinLevel(int n)
{
	if ( n<0 || n > MAX_ITEMBAG_ATTR-1 )
		return 0;
...
BYTE CItemBagZt::GetMaxLevel(int n)
{
	if ( n<0 || n > MAX_ITEMBAG_ATTR-1 )
		return 0;
...
BOOL CItemBagZt::PickItem(CItem & objItem, int & nItemIndex)
{
	if ( this->m_bLoad == FALSE )
		return FALSE;
...
BOOL CItemBagZt::DropRedRibbonBoxEventItem(int aIndex)
{
	if ( this->m_bLoad == FALSE )
		return FALSE;
...
BOOL CItemBagZt::DropGreenRibbonBoxEventItem(int aIndex)
{
	if ( this->m_bLoad == FALSE )
		return FALSE;
...
BOOL CItemBagZt::DropBlueRibbonBoxEventItem(int aIndex)
{
	if ( this->m_bLoad == FALSE )
		return FALSE;
...
BOOL CItemBagZt::DropPinkChocolateBoxEventItem(int aIndex)
{
	if ( this->m_bLoad == FALSE )
		return FALSE;
...
BOOL CItemBagZt::DropRedChocolateBoxEventItem(int aIndex)
{
	if ( this->m_bLoad == FALSE )
		return FALSE;
...
BOOL CItemBagZt::DropBlueChocolateBoxEventItem(int aIndex)
{
	if ( this->m_bLoad == FALSE )
		return FALSE;
...
BOOL CItemBagZt::DropLightPurpleCandyBoxEventItem(int aIndex)
{
	if ( this->m_bLoad == FALSE )
		return FALSE;
...
BOOL CItemBagZt::DropVermilionCandyBoxEventItem(int aIndex)
{
	if ( this->m_bLoad == FALSE )
		return FALSE;
...
BOOL CItemBagZt::DropDeepBlueCandyBoxEventItem(int aIndex)
{
	if ( this->m_bLoad == FALSE )
		return FALSE;
...
BOOL CItemBagZt::DropHallowinEventItem(LPOBJ lpObj)
{
	if ( this->m_bLoad == FALSE )
		return FALSE;
...
BOOL CItemBagZt::DropKundunEventItem(int aIndex, BYTE btMapNumber, BYTE cX, BYTE cY)
{
	if ( this->m_bLoad == FALSE )
	{
		return FALSE;
...
//#if(GS_CASTLE==1)
BOOL CItemBagZt::DropCastleHuntZoneBossReward(int aIndex, BYTE btMapNumber, BYTE cX, BYTE cY) //Identical
{
	if ( this->m_bLoad == FALSE )
		return FALSE;
...
BOOL CItemBagZt::DropCrywolfDarkElfItem(int aIndex, BYTE btMapNumber, BYTE cX, BYTE cY)
{
	if ( this->m_bLoad == FALSE )
		return FALSE;
...
BOOL CItemBagZt::DropCrywolfBossMonsterItem(int aIndex, BYTE btMapNumber, BYTE cX, BYTE cY)
{
	if ( this->m_bLoad == FALSE )
		return FALSE;
...
//#if(GS_CASTLE==0)
BOOL CItemBagZt::DropKanturuMayaHandItem(int aIndex, BYTE btMapNumber, BYTE cX, BYTE cY)
{
	if ( this->m_bLoad == FALSE )
		return FALSE;
...
BOOL CItemBagZt::DropKanturuNightmareItem(int aIndex, BYTE btMapNumber, BYTE cX, BYTE cY)
{
	if ( this->m_bLoad == FALSE )
		return FALSE;
...
BOOL CItemBagZt::DropSilverChestItem(int aIndex, BYTE btMapNumber, BYTE cX, BYTE cY)
{
	if ( this->m_bLoad == FALSE )
		return FALSE;
	...
	if ( this->GetBagCount() > 0 )
	{
		...
		LogAddTD("[ DOUBLEGOER ][ Reward ] Silver Chest Drop [%s][%s] : (%d)(%d/%d) Item:(%s)%d Level:%d op1:%d op2:%d op3:%d ExOp:%d",
			lpObj->AccountID, lpObj->Name, btMapNumber, X, Y, ItemAttribute[iType].Name,
			iType, iLevel, iOption1, iOption2, iOption3, iExOption);
...
//Season 5 DoppelGanger
BOOL CItemBagZt::DropGoldenChestItem(int aIndex, BYTE btMapNumber, BYTE cX, BYTE cY)
{
	if ( this->m_bLoad == FALSE )
		return FALSE;
	...
	if ( this->GetBagCount() > 0 )
	{
		...
		LogAddTD("[ DOUBLEGOER ][ Reward ] Golden Chest Drop [%s][%s] : (%d)(%d/%d) Item:(%s)%d Level:%d op1:%d op2:%d op3:%d ExOp:%d",
			lpObj->AccountID, lpObj->Name, btMapNumber, X, Y, ItemAttribute[iType].Name,
			iType, iLevel, iOption1, iOption2, iOption3, iExOption);
