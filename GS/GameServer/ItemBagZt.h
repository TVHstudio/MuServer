...
//#endif
	...
	//Season 5 New Box
	//BOOL DropShiningJewelryCase(int aIndex, BYTE btMapNumber, BYTE cX, BYTE cY);
	//BOOL DropElegantJewelryCase(int aIndex, BYTE btMapNumber, BYTE cX, BYTE cY);
	//BOOL DropSteelJewelryCase(int aIndex, BYTE btMapNumber, BYTE cX, BYTE cY);
	//BOOL DropOldJewelryCase(int aIndex, BYTE btMapNumber, BYTE cX, BYTE cY);
...
private:
	...
	CItemBagAttrZt BagObject[MAX_ITEMBAG_ATTR];	// 19C
};
