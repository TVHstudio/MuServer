...
#ifdef NEWWINGS_2_5
			 !IS_NEWWINGS_2_5(gObj[iUserIndex].pInventory[7].m_Type) &&
#endif
#ifdef NEWWINGS_4
			 !IS_NEWWINGS_4(gObj[iUserIndex].pInventory[7].m_Type) &&
#endif
#ifdef NEWWINGS_5
			 !IS_NEWWINGS_5(gObj[iUserIndex].pInventory[7].m_Type) &&
#endif
#ifdef NEWWINGS_6
			 !IS_NEWWINGS_6(gObj[iUserIndex].pInventory[7].m_Type) &&
#endif
...
void CKanturu::UserMonsterCountCheck()
{
	...
	for ( int iAllUserCount=OBJ_STARTUSERINDZT;iAllUserCount<OBJMAX;iAllUserCount++)
	{
	...
	for ( int iAllMonsterCount=0;iAllMonsterCount<OBJ_STARTUSERINDZT;iAllMonsterCount++)
	{
