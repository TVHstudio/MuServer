...
//			this->SetEx(number, iSkillUseType, iSkillBrand, iKillCount, RequireStatus);
//			//this->SetMasterLevelSkillInfo(number, SkillRank, SkillGroup, rMLPoint, rAG, rShield, Duration, rStrength, rDexterity);
//			DefMagicInf[number].Set(number, 0);
//		}
//	}
//	// ----
//	LogAdd(lMsg.Get(MSGGET(1, 200)), "Skill");
	...
	while ( true )
	{
		...
		if ( Token == 1 )
		{
			...
			Token = WzMemScript.GetToken();
			RequireClass[6] = WzMemScript.GetNumber(); //RF
...
void CMagicDamage::Set(char* name, int skill, int damage,  int rlevel,  int mana,  int bp,  int dis, int Attr,  int iSkillType, BYTE* ReqClass, int rEnergy, int rLeadership, int rdelay) //0048ED40
{
	...
	//if ( skill == 41 )	// Twisting Slash
	//{
	//	this->m_RequireLevel[skill] = ZtConfig.Skills.TwistingSlashLevel;//80;
	//}
	//else if ( skill == 42 )	// Rageful Blow
	//{
	//	this->m_RequireLevel[skill] = ZtConfig.Skills.RagefulBlowLevel;//170;
	//}
	//else if ( skill == 43 )	// Death Stab
	//{
	//	this->m_RequireLevel[skill] = ZtConfig.Skills.DeathStabLevel;//160;
	//}
	//else if ( skill == 47 )	// Impale
	//{
	//	this->m_RequireLevel[skill] = ZtConfig.Skills.ImpaleLevel;//28;
	//}
	//else if ( skill == 48 )	// Inner Strength
	//{
	//	this->m_RequireLevel[skill] = ZtConfig.Skills.InnerStrengthLevel;//120;
	//}
	//else if ( skill == 52 )	// Penetration
	//{
	//	this->m_RequireLevel[skill] = ZtConfig.Skills.PenetrationLevel;//130;
	//}
...
#if(DEBUG_CODE)
	LogAddC(2,"skill: %d, Cclass: %d",skill,Cclass);
#endif
