...
int CMixSystem::ChaosBoxMix(LPOBJ lpObj, int & Result2, int & Result3)
{
	...
	if(WingCharmItemNum > -1) //season4.5 add-on
	{
		...
		case 85:
			...
			break;
		case 86:
			if(ZtConfig.ZtCustom.SwitchChar == 2)
			{
				Result3 = 0;
			}
			else
...
void CMixSystem::DefaultChaosMix(LPOBJ lpObj)
{
	...
	else 
	{
		if ( lpObj->ChaosSuccessRate > 0 )
		{
			...
			if ( (rand()%100) <= (lpObj->ChaosSuccessRate-1) ) 
			{
				...
				if ( MixResult2 == 1 )
				{
					...
					int WingType = rand()%MaxRandomMix;
					int WingNum = 0;
					...
					g_Achievements.SuccessChaosMix(lpObj->m_Index);
#endif
		...
		if ( fail == TRUE )
		{
			...
			lpObj->ChaosLock = FALSE;
#if(SYSTEM_ACHIEVEMENTS)
			g_Achievements.FailedChaosMix(lpObj->m_Index);
#endif
		}
		else
		{
...
BOOL CMixSystem::PlusItemLevelChaosMix(LPOBJ lpObj, int mixType)
{
	...
	int Plus13ItemCount = 0;	//Season 5 +15 Items
	int Plus14ItemCount = 0;	//Season 5 +15 Items
	int Plus15ItemCount = 0;	//Season 5 +15 Items
	...
	//Season 5 +15 Items
	else if ( Plus13ItemCount == 1 && ChaosGemCount == 1 && BlessGemCount == 5 && SoulGemCount == 5 && Plus9ItemCount == 0 && Plus10ItemCount == 0 && Plus11ItemCount == 0 && Plus14ItemCount == 0)
	{
		MixType = 49;
	...
	else if ( Plus14ItemCount == 1 && ChaosGemCount == 1 && BlessGemCount == 6 && SoulGemCount == 6 && Plus9ItemCount == 0 && Plus10ItemCount == 0 && Plus11ItemCount == 0 && Plus15ItemCount == 0)
	{
		MixType = 50;
...
#ifdef NEWWINGS_2_5
	if( IS_NEWWINGS_2_5(lpObj->pChaosBox[PlusItemPos].m_Type) )
	{
		btMixLevel = 1;
	}
#endif
...
#ifdef NEWWINGS_4
	if( IS_NEWWINGS_4(lpObj->pChaosBox[PlusItemPos].m_Type) )
	{
		btMixLevel = 1;
	}
#endif
...
#ifdef NEWWINGS_5
	if( IS_NEWWINGS_5(lpObj->pChaosBox[PlusItemPos].m_Type) )
	{
		btMixLevel = 1;
	}
#endif
#ifdef NEWWINGS_6
	if( IS_NEWWINGS_6(lpObj->pChaosBox[PlusItemPos].m_Type) )
	{
		btMixLevel = 1;
	}
#endif
	if ( lpObj->pChaosBox[PlusItemPos].m_Level == 9 )
	{
		...
		{
			//int ZtMixNormal10SuccessRate = GetPrivateProfileInt("ChaosMix","MixNormal10SuccessRate",60,"..\\Data\\ZtData\\CommonServer.ini");
			lpObj->ChaosSuccessRate = ZtConfig.CommonServer.ZtMixNormal10SuccessRate;
		}
		else if(btMixLevel == 2) //season4.5 add-on
		{
			//int ZtMix380AncExc10SuccessRate = GetPrivateProfileInt("ChaosMix","Mix380AncExc10SuccessRate",50,"..\\Data\\ZtData\\CommonServer.ini");
			lpObj->ChaosSuccessRate = ZtConfig.CommonServer.ZtMix380AncExc10SuccessRate;
		}
		else if(btMixLevel == 3) //season4.5 add-on
		{
			//int ZtMixSocket10SuccessRate = GetPrivateProfileInt("ChaosMix","MixSocket10SuccessRate",40,"..\\Data\\ZtData\\CommonServer.ini");
			lpObj->ChaosSuccessRate = ZtConfig.CommonServer.ZtMixSocket10SuccessRate;
		}
	}
	else if ( lpObj->pChaosBox[PlusItemPos].m_Level == 10) //season4 changed
	{
		if(btMixLevel == 1) //season4.5 add-on
		{
			//int ZtMixNormal11SuccessRate = GetPrivateProfileInt("ChaosMix","MixNormal11SuccessRate",60,"..\\Data\\ZtData\\CommonServer.ini");
			lpObj->ChaosSuccessRate = ZtConfig.CommonServer.ZtMixNormal11SuccessRate;
		}
		else if(btMixLevel == 2) //season4.5 add-on
		{
			//int ZtMix380AncExc11SuccessRate = GetPrivateProfileInt("ChaosMix","Mix380AncExc11SuccessRate",50,"..\\Data\\ZtData\\CommonServer.ini");
			lpObj->ChaosSuccessRate = ZtConfig.CommonServer.ZtMix380AncExc11SuccessRate;
		}
		else if(btMixLevel == 3) //season4.5 add-on
		{
			//int ZtMixSocket11SuccessRate = GetPrivateProfileInt("ChaosMix","MixSocket11SuccessRate",40,"..\\Data\\ZtData\\CommonServer.ini");
			lpObj->ChaosSuccessRate = ZtConfig.CommonServer.ZtMixSocket11SuccessRate;
		}
	}
	else if (lpObj->pChaosBox[PlusItemPos].m_Level == 11) //season4 changed
	{
		if(btMixLevel == 1) //season4.5 add-on
		{
			//int ZtMixNormal12SuccessRate = GetPrivateProfileInt("ChaosMix","MixNormal12SuccessRate",60,"..\\Data\\ZtData\\CommonServer.ini");
			lpObj->ChaosSuccessRate = ZtConfig.CommonServer.ZtMixNormal12SuccessRate;
		}
		else if(btMixLevel == 2) //season4.5 add-on
		{
			//int ZtMix380AncExc12SuccessRate = GetPrivateProfileInt("ChaosMix","Mix380AncExc12SuccessRate",50,"..\\Data\\ZtData\\CommonServer.ini");
			lpObj->ChaosSuccessRate = ZtConfig.CommonServer.ZtMix380AncExc12SuccessRate;
		}
		else if(btMixLevel == 3) //season4.5 add-on
		{
			//int ZtMixSocket12SuccessRate = GetPrivateProfileInt("ChaosMix","MixSocket12SuccessRate",40,"..\\Data\\ZtData\\CommonServer.ini");
			lpObj->ChaosSuccessRate = ZtConfig.CommonServer.ZtMixSocket12SuccessRate;
		}
	}
	else if ( lpObj->pChaosBox[PlusItemPos].m_Level == 12) //season4 changed
	{
		if(btMixLevel == 1) //season4.5 add-on
		{
			//int ZtMixNormal13SuccessRate = GetPrivateProfileInt("ChaosMix","MixNormal13SuccessRate",55,"..\\Data\\ZtData\\CommonServer.ini");
			lpObj->ChaosSuccessRate = ZtConfig.CommonServer.ZtMixNormal13SuccessRate;
		}
		else if(btMixLevel == 2) //season4.5 add-on
		{
			//int ZtMix380AncExc13SuccessRate = GetPrivateProfileInt("ChaosMix","Mix380AncExc13SuccessRate",50,"..\\Data\\ZtData\\CommonServer.ini");
			lpObj->ChaosSuccessRate = ZtConfig.CommonServer.ZtMix380AncExc13SuccessRate;
		}
		else if(btMixLevel == 3) //season4.5 add-on
		{
			//int ZtMixSocket13SuccessRate = GetPrivateProfileInt("ChaosMix","MixSocket13SuccessRate",35,"..\\Data\\ZtData\\CommonServer.ini");
			lpObj->ChaosSuccessRate = ZtConfig.CommonServer.ZtMixSocket13SuccessRate;
		}
	}
	else if ( lpObj->pChaosBox[PlusItemPos].m_Level == 13) //Season 5 +15 Items
	{
		if(btMixLevel == 1) 
		{
			lpObj->ChaosSuccessRate = ZtConfig.CommonServer.ZtMixNormal14SuccessRate;
		}
		else if(btMixLevel == 2)
		{
			lpObj->ChaosSuccessRate = ZtConfig.CommonServer.ZtMix380AncExc14SuccessRate;
		}
		else if(btMixLevel == 3) 
		{
			lpObj->ChaosSuccessRate = ZtConfig.CommonServer.ZtMixSocket14SuccessRate;
		}
	}
	else if ( lpObj->pChaosBox[PlusItemPos].m_Level == 14) //Season 5 +15 Items
	{
		if(btMixLevel == 1) 
		{
			lpObj->ChaosSuccessRate = ZtConfig.CommonServer.ZtMixNormal15SuccessRate;
		}
		else if(btMixLevel == 2)
		{
			lpObj->ChaosSuccessRate = ZtConfig.CommonServer.ZtMix380AncExc15SuccessRate;
		}
		else if(btMixLevel == 3) 
		{
			lpObj->ChaosSuccessRate = ZtConfig.CommonServer.ZtMixSocket15SuccessRate;
		}
	}
	else
	{
	...
	{
		//int ZtMixLuckOptRateAdd = GetPrivateProfileInt("ChaosMix","MixLuckOptRateAdd",20,"..\\Data\\ZtData\\CommonServer.ini");
		lpObj->ChaosSuccessRate += ZtConfig.CommonServer.ZtMixLuckOptRateAdd;
	}

	if ( lpObj->ChaosSuccessRate > ZtConfig.CommonServer.ZtMixMaxSuccessRate )
	{
		//int ZtMixMaxSuccessRate = GetPrivateProfileInt("ChaosMix","MixMaxSuccessRate",75,"..\\Data\\ZtData\\CommonServer.ini");
		lpObj->ChaosSuccessRate = ZtConfig.CommonServer.ZtMixMaxSuccessRate;
	}
...
#if(LICENSE_UKRAINE)
		MessaageAllGlobal("%s Mix %s +%d Success", lpObj->Name, Item.GetName(), Item.m_Level);
#endif
...
#if(LICENSE_UKRAINE)
		MessaageAllGlobal("%s Mix %s +%d Failed", lpObj->Name, lpObj->pChaosBox[PlusItemPos].GetName(), FailLevel);
#endif
...
BOOL CMixSystem::PegasiaChaosMix(LPOBJ lpObj)
{
	...
	//int ExDinorantMixRate = GetPrivateProfileInt("ChaosMix","DinorantMixRate",70,"..\\Data\\ZtData\\CommonServer.ini");
	lpObj->ChaosSuccessRate = ZtConfig.CommonServer.ZtDinorantMixRate;	// Succes Rate for Dinorant
	lpObj->ChaosSuccessRate += iCharmOfLuckCount;
...
BOOL CMixSystem::WingChaosMix(LPOBJ lpObj)
{
	...
	//int ZtWing2MaxSuccessRate = GetPrivateProfileInt("ChaosMix","Wing2MaxSuccessRate",90,"..\\Data\\ZtData\\CommonServer.ini");
	if(lpObj->ChaosSuccessRate > ZtConfig.CommonServer.ZtWing2MaxSuccessRate)
	{
		lpObj->ChaosSuccessRate = ZtConfig.CommonServer.ZtWing2MaxSuccessRate;
	}
	...
	if ( (rand()%100) < lpObj->ChaosSuccessRate )
	{
		...
		if ( iSleeveOfLord != 0 )
		{
			...
			if(ZtConfig.ZtCustom.SwitchChar == 1 || ZtConfig.ZtCustom.SwitchChar == 2)
			{
				iItemType		= 13;
				iItemSubType	= 30;
			}
		...
		else
		{
			...
			if(iRand == 4 && ZtConfig.ZtCustom.SwitchChar != 2)//Conflict //See DangeR
			{
				iItemSubType = 42;
			}
			else
			{
				iRand = rand()%4;
				iItemSubType = iRand + 3;//twister slash
			}
		}
...
void CMixSystem::DarkHorseChaosMix(LPOBJ lpObj)
{
	...
	//int ExDarkHorseMixSuccessRate = GetPrivateProfileInt("ChaosMix","DarkHorseMixSuccessRate",60,"..\\Data\\ZtData\\CommonServer.ini");
	lpObj->ChaosSuccessRate = ZtConfig.CommonServer.ZtDarkHorseMixSuccessRate;
	lpObj->ChaosSuccessRate += iCharmOfLuckCount;
...
void CMixSystem::DarkSpiritChaosMix(LPOBJ lpObj)
{
	...
	//int ExDarkSpiritMixSuccessRate = GetPrivateProfileInt("ChaosMix","DarkSpiritMixSuccessRate",60,"..\\Data\\ZtData\\CommonServer.ini");
	lpObj->ChaosSuccessRate = ZtConfig.CommonServer.ZtDarkSpiritMixSuccessRate;
	lpObj->ChaosSuccessRate += iCharmOfLuckCount;
...
void CMixSystem::ThirdWingMix1(LPOBJ lpObj)
{
	...
	//int ExFeatherofCondorMixMaxPercent = GetPrivateProfileInt("ChaosMix","FeatherofCondorMixMaxPercent",60,"..\\Data\\ZtData\\CommonServer.ini");
	if(lpObj->ChaosSuccessRate > ZtConfig.CommonServer.ZtFeatherofCondorMixMaxPercent)
	{
		lpObj->ChaosSuccessRate = ZtConfig.CommonServer.ZtFeatherofCondorMixMaxPercent;
	}
...
{	
	...
	//int ZtWingLv3MixMaxPercent = GetPrivateProfileInt("ChaosMix","WingLv3MixMaxPercent",40,"..\\Data\\ZtData\\CommonServer.ini");
	if(lpObj->ChaosSuccessRate > ZtConfig.CommonServer.ZtWingLv3MixMaxPercent)
	{
		lpObj->ChaosSuccessRate = ZtConfig.CommonServer.ZtWingLv3MixMaxPercent;
	}
	else if( lpObj->ChaosSuccessRate < 1)
	{
		lpObj->ChaosSuccessRate = 1;
	...
	if ( (rand()%100) < lpObj->ChaosSuccessRate )
	{
		...
		if(ZtConfig.ZtCustom.SwitchChar == 1)
		{
			CharItemCount = 6;
		}
		else if(ZtConfig.ZtCustom.SwitchChar == 2)
		{
			CharItemCount = 5;
		}

		int loc18 = rand()%CharItemCount;	//1.01.00 updated
...
void CMixSystem::ThirdWingMixItemDown2(CItem * lpItem)
{
	...
	lpItem->m_Option3 = 0;
	lpItem->Convert(lpItem->m_Type, lpItem->m_Option1, lpItem->m_Option2, lpItem->m_Option3, lpItem->m_NewOption, lpItem->m_SetOption, lpItem->m_ItemOptionEx, lpItem->m_SocketOption, lpItem->m_SocketOptionIndex, 0, 3);
}
...
void CMixSystem::SetItemChaosMix(LPOBJ lpObj)
{
	...
	if ( (rand()%100) < lpObj->ChaosSuccessRate )
	{
		...
		Item.Convert(lpObj->pChaosBox[MixSetItemIndex].m_Type, lpObj->pChaosBox[MixSetItemIndex].m_Option1, lpObj->pChaosBox[MixSetItemIndex].m_Option2,
			...
			lpObj->pChaosBox[MixSetItemIndex].m_SetOption, lpObj->pChaosBox[MixSetItemIndex].m_ItemOptionEx, lpObj->pChaosBox[MixSetItemIndex].m_SocketOption, lpObj->pChaosBox[MixSetItemIndex].m_SocketOptionIndex, 0, CURRENT_DB_VERSION);
...
void CMixSystem::CherryBlossomMix(LPOBJ lpObj) //005BA390
{
	...
	for (int n=0;n<CHAOS_BOX_SIZE;n++) // loc8 -> ebp 20
	{
		...
		if(CherryBlossomData.iBranchId == 0)
		{
			...
			{
				CherryBlossomData.btBranchCount = 255;
...
void CMixSystem::SocketSeedExtract(LPOBJ lpObj) //0062A5B0 identical
{
	...
	iChaosTaxMoney = (int)((__int64)g_iSeedZttractMoney * (__int64)g_CastleSiegeSync.GetTaxRateChaos(lpObj->m_Index) / (__int64)100);
	...
	iMixMoney = g_iSeedZttractMoney + iChaosTaxMoney;
...
void CMixSystem::SocketSetSeedSphere(LPOBJ lpObj, BYTE SocketSlot) //0062B4A0 identical
{
	...
	Item.Convert(pSocketItem->m_Type, pSocketItem->m_Option1, pSocketItem->m_Option2, pSocketItem->m_Option3, pSocketItem->m_NewOption,
				pSocketItem->m_SetOption, pSocketItem->m_ItemOptionEx, pSocketItem->m_SocketOption, pSocketItem->m_SocketOptionIndex, 0, CURRENT_DB_VERSION);
...
void CMixSystem::SecromiconMix(LPOBJ lpObj)	//Season 5 ImperialFort
{
	PMSG_CHAOSMIXRESULT pMsg;
	PHeadSetB((LPBYTE)&pMsg.h, 0x86, sizeof(PMSG_CHAOSMIXRESULT));
	...
	if(first == 1 && second == 1 && third == 1 && fourth == 1 && fifth == 1 && sixth == 1)
	{
		...
		LogAdd("[SecromiconMix] (%s)(%s) Success ItemID: %d", lpObj->AccountID, lpObj->Name, ITEMGET(14,109));
...
{	
	...
	int RateMix	= ZtConfig.CommonServer.Wing2_5MaxSuccessRate;
	int NeedError = 0;
	int MixLuckRate = 40;
	int PlusProcent = 0;
...
{	
	...
	int RateMix	= ZtConfig.CommonServer.Wing4MaxSuccessRate;
	int NeedError = 0;
	int MixLuckRate = 30;
	int PlusProcent = 0;
...
{	
	...
	//if(false)//if(!ZtConfig.CommonServer.Mix4Wings)	//To Continue
	//{
	//	pMsg.Result = CB_INCORRECT_MIX_ITEMS;
	//	DataSend(lpObj->m_Index, (LPBYTE)&pMsg, pMsg.h.size);
	//	lpObj->ChaosLock = FALSE;
	...
	int RateMix	= ZtConfig.CommonServer.Wing5MaxSuccessRate;
	int NeedError = 0;
	int MixLuckRate = 30;
	int PlusProcent = 0;
	int NeedAncItem = 0;
...
//#endif
//#ifdef _WINGS_5LVL_
void CMixSystem::MixWings6rd(LPOBJ lpObj)
{	
	PMSG_CHAOSMIXRESULT pMsg;
	...
	for ( int n=0;n<CHAOS_BOX_SIZE;n++) //loc16
	{
		if ( lpObj->pChaosBox[n].IsItem() == TRUE )
		{
			if ( lpObj->pChaosBox[n].m_Type == ITEMGET(12,189) ||
				 lpObj->pChaosBox[n].m_Type == ITEMGET(12,190) ||
				 lpObj->pChaosBox[n].m_Type == ITEMGET(12,191) ||
				 lpObj->pChaosBox[n].m_Type == ITEMGET(12,192) ||
				 lpObj->pChaosBox[n].m_Type == ITEMGET(12,193) ||
				 lpObj->pChaosBox[n].m_Type == ITEMGET(12,194) )
			{
				if( this->CheckItemCondition(&lpObj->pChaosBox[n],9,0,0,1,0,0) != FALSE )
				{
					Need5lvlWing++;
	...
	if(NeedExlItem < 1 || NeedCondor != 1 || NeedJewelOfChaos != 1 || Need5lvlWing != 1 || NeedJewelOfCreatoion != 1 || 
	   Need30Bless != 2 || Need30Soul != 2 || NeedError > 0 || NeedAncItem != 1)
	{
		pMsg.Result = CB_INCORRECT_MIX_ITEMS;
		DataSend(lpObj->m_Index, (LPBYTE)&pMsg, pMsg.h.size);
		lpObj->ChaosLock = FALSE;
	...
	LogChaosItem(lpObj, "WingLevel6_Mix");
	LogAddTD("[Wings 6 Lvl Mix] Chaos Mix Start");
	...
	if ( RateMix > MixPercent)
	{
		...
		if(loc18 == 0)
		{
			ItemType = ITEMGET(12,195);
		}
		else if( loc18 == 1)
		{
			ItemType = ITEMGET(12,196);
		}
		...
		LogAddTD("[6rd Wings Mix] [%s][%s] CBMix Success %d Money : %d-%d, CharmRate : %d",
			lpObj->AccountID, lpObj->Name, MixPercent,	lpObj->Money, NeedMoney);
#if(SYSTEM_ACHIEVEMENTS)
		g_Achievements.SuccessChaosMix(lpObj->m_Index);
#endif
	...
	else
	{
		...
		LogAddTD("[6rd Wings Mix] [%s][%s] CBMix Fail %d Money : %d-%d",
			lpObj->AccountID, lpObj->Name, MixPercent,	lpObj->Money, NeedMoney);
		lpObj->ChaosLock = FALSE;
#if(SYSTEM_ACHIEVEMENTS)
		g_Achievements.FailedChaosMix(lpObj->m_Index);
