...
#ifdef NEWWINGS_2_5
			 !IS_NEWWINGS_2_5(lpObj->pInventory[7].m_Type) &&
#endif
#ifdef NEWWINGS_4
			 !IS_NEWWINGS_4(lpObj->pInventory[7].m_Type) &&
#endif
#ifdef NEWWINGS_5
			 !IS_NEWWINGS_5(lpObj->pInventory[7].m_Type) &&
#endif
#ifdef NEWWINGS_6
			 !IS_NEWWINGS_6(lpObj->pInventory[7].m_Type) &&
#endif
...
BOOL CMoveCommand::Move(LPOBJ lpObj, LPSTR mapname)
{
	...
	if(gGENS)
	{
		if( gGensSystem.IsMoveMapBattleZone(loc6) )
		{
