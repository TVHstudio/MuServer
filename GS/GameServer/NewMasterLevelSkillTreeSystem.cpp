...
//	lua_State* L = this->m_Lua.GetLua();
	...
	{
		//g_Generic_Call(L, "FN_LuaGetPercent", "i>d", i, &fValue);
		fValue = 1 + ((((((((i) - 30) ^ 3) + 25000) / 499) / 50) * 100) / 12);
		this->m_fValue[1][i] = this->RoundValue(fValue,2);
		
		//g_Generic_Call(L,"FN_LuaGetPercent2","i>d",i,&fValue);
		fValue = 0.8 + (((((((i - 30) ^ 3) + 25000) / 499) / 6)));
		this->m_fValue[2][i] = this->RoundValue(fValue,2);

		//g_Generic_Call(L,"FN_LuaGetSkillDamageMin","i>d",i,&fValue);
		fValue = (0.85 + (((((((i - 30) ^ 3) + 25000) / 499) / 6)))) * 6;
		this->m_fValue[3][i] = this->RoundValue(fValue,2);

		//g_Generic_Call(L,"FN_LuaGetSkillDamageMiddle","i>d",i,&fValue);
		fValue = (0.9 + (((((((i - 30) ^ 3) + 25000) / 499) / 6)))) * 8;
		this->m_fValue[4][i] = this->RoundValue(fValue,2);

		//g_Generic_Call(L,"FN_LuaGetSkillDamageMax","i>d",i,&fValue);
		fValue = (0.95 + (((((((i - 30) ^ 3) + 25000) / 499) / 6)))) * 10;
		this->m_fValue[5][i] = this->RoundValue(fValue,2);

		//g_Generic_Call(L,"FN_LuaGetMonsterKill","i>d",i,&fValue);
		fValue =  52 / (1 + (((((((i - 30) ^ 3) + 25000) / 499) / 6))));
		this->m_fValue[6][i] = this->RoundValue(fValue,2);

		//g_Generic_Call(L,"FN_LuaGetPercent3","i>d",i,&fValue);
		fValue =  (1 + (((((((i - 30) ^ 3) + 25000) / 499) / 6)))) * 1.5;
		this->m_fValue[7][i] = this->RoundValue(fValue,2);

		//g_Generic_Call(L,"FN_LuaGetMaxAG","i>d",i,&fValue);
		fValue = (1 + (((((((i - 30) ^ 3) + 25000) / 499) / 50) * 100) / 12)) * 23;
		this->m_fValue[8][i] = this->RoundValue(fValue,2);

		//g_Generic_Call(L,"FN_LuaGetMaxLifeMana","i>d",i,&fValue);
		fValue = (1 + (((((((i - 30) ^ 3) + 25000) / 499) / 50) * 100) / 12)) * 85;
		this->m_fValue[9][i] = this->RoundValue(fValue,2);

		//g_Generic_Call(L,"FN_LuaGetAttack","i>d",i,&fValue);
		fValue = (0.8 + (((((((i - 30) ^ 3) + 25000) / 499) / 50) * 100) / 12)) * 8;
		this->m_fValue[10][i] = this->RoundValue(fValue,2);

		//g_Generic_Call(L,"FN_LuaGetSDMonsterKill","i>d",i,&fValue);
		fValue = 11 / (1 + (((((((i - 30) ^ 3) + 25000) / 499) / 50) * 100) / 12));
		this->m_fValue[11][i] = this->RoundValue(fValue,2);

		//g_Generic_Call(L,"FN_LuaGetBlockingRate","i>d",i,&fValue);
		fValue = (1 + (((((((i - 30) ^ 3) + 25000) / 499) / 50) * 100) / 12)) * 85 * 6;
		this->m_fValue[12][i] = this->RoundValue(fValue,2);

		//g_Generic_Call(L,"FN_LuaGetAttackSuccessRate","i>d",i,&fValue);
		fValue = (1 + (((((((i - 30) ^ 3) + 25000) / 499) / 50) * 100) / 12)) * 85 * 5;
		this->m_fValue[13][i] = this->RoundValue(fValue,2);

		//g_Generic_Call(L,"FN_LuaGetManAttackRate","i>d",i,&fValue);
		fValue = (1 + (((((((i - 30) ^ 3) + 25000) / 499) / 50) * 100) / 12)) * 85 * 8;
		this->m_fValue[14][i] = this->RoundValue(fValue,2);

		//g_Generic_Call(L,"FN_LuaGetPercent4","i>d",i,&fValue);
		fValue = (1 + (((((((i - 30) ^ 3) + 25000) / 499) / 6)))) * 15;
		this->m_fValue[15][i] = this->RoundValue(fValue,2);

		//g_Generic_Call(L,"FN_LuaGetIncreaseBlocking","i>d",i,&fValue);
		fValue = (1 + (((((((i - 30) ^ 3) + 25000) / 499) / 6)))) * 50;
		this->m_fValue[16][i] = this->RoundValue(fValue,2);

		//g_Generic_Call(L,"FN_LuaGetIncreaseStat","i>d",i,&fValue);
		fValue = (1 + (((((((i - 30) ^ 3) + 25000) / 499) / 6)))) * 10;
		this->m_fValue[17][i] = this->RoundValue(fValue,2);

		//g_Generic_Call(L,"FN_LuaGetDecreaseMana","i>d",i,&fValue);
		fValue = (1 + (((((((i - 30) ^ 3) + 25000) / 499) / 6)))) * 6;
		this->m_fValue[18][i] = this->RoundValue(fValue,2);

		//g_Generic_Call(L,"FN_LuaGetChangeBlocking","i>d",i,&fValue);
		fValue = 50 / (1 + (((((((i - 30) ^ 3) + 25000) / 499) / 6)))) + 20;
		this->m_fValue[19][i] = this->RoundValue(fValue,2);

		//g_Generic_Call(L,"FN_LuaGetControlAttack","i>d",i,&fValue);
		fValue = 40 / (1 + (((((((i - 30) ^ 3) + 25000) / 499) / 6)))) + 5;
		this->m_fValue[20][i] = this->RoundValue(fValue,2);

		//g_Generic_Call(L,"FN_LuaGetManaIncRate","i>d",i,&fValue);
		fValue = (2 + (((((((i - 30 ) ^ 3) + 25000) / 499 ) / 6)))) * 1.5;
		this->m_fValue[21][i] = this->RoundValue(fValue,2);

		//g_Generic_Call(L,"FN_LuaGetSkillDamageMin2","i>d",i,&fValue);
		fValue = (0.8 + (((((((i - 30) ^ 3) + 25000) / 499) / 6)))) * 5;
		this->m_fValue[22][i] = this->RoundValue(fValue,2);
		...
		//g_Generic_Call(L,"FN_LuaGetPercent5","i>d",i,&fValue);
		fValue = (0.95 + ( ( ( ( (((i - 30) ^ 3) + 25000) / 499) / 6)))) * 7.8;
		this->m_fValue[24][i] = this->RoundValue(fValue,2);
		...
		//g_Generic_Call(L,"FN_LuaGetBlockingRate_2","i>d",i,&fValue);
		fValue = (1 + ( ( ( ( ( ( (i - 30) ^ 3) + 25000) / 499) / 50) * 100) / 12)) * 85 * 2.5;
		this->m_fValue[29][i] = this->RoundValue(fValue,2);

		//g_Generic_Call(L,"FN_LuaGetAttackRate_2","i>d",i,&fValue);
		fValue = (1 + ( ( ( ( ( ( (i - 30) ^ 3) + 25000) / 499) / 50) * 100) / 12) ) * 85 * 2;
		this->m_fValue[30][i] = this->RoundValue(fValue,2);

		//g_Generic_Call(L,"FN_LuaGetManAttack_2","i>d",i,&fValue);
		fValue = (1 + ( ( ( ( ( ( (i - 30) ^ 3) + 25000) / 499) / 50) * 100) / 12)) * 85 * 3.2;
		this->m_fValue[31][i] = this->RoundValue(fValue,2);

		//g_Generic_Call(L,"FN_LuaGetMaxSD_2","i>d",i,&fValue);
		fValue = (1 + ( ( ( ( ( ((i - 30) ^ 3) + 25000) / 499) / 50) * 100) / 12)) * 85 * 3;
		this->m_fValue[33][i] = this->RoundValue(fValue,2);

		//g_Generic_Call(L,"FN_LuaGetMaxLifeMana_2","i>d",i,&fValue);
		fValue = (1 + ( ( ( ( ( ( (i - 30) ^ 3) + 25000) / 499) / 50) * 100) / 12)) * 45;
		this->m_fValue[34][i] = this->RoundValue(fValue,2);

		//g_Generic_Call(L,"FN_LuaGetIncBlocking_2","i>d",i,&fValue);
		fValue = (1 + ( ( ( ( ( ( (i - 30) ^ 3) + 25000) / 499) / 6) ) ) ) * 28;
		this->m_fValue[35][i] = this->RoundValue(fValue,2);

		//g_Generic_Call(L,"FN_LuaGetIncStat_2","i>d",i,&fValue);
		fValue = (1 + ( ( ( ( ( ( (i - 30) ^ 3) + 25000) / 499) / 6) ) ) ) * 8;
		this->m_fValue[36][i] = this->RoundValue(fValue,2);

		//g_Generic_Call(L,"FN_LuaGetMaxAG_2","i>d",i,&fValue);
		fValue = (1 + ( ( ( ( ( ( (i - 30) ^ 3) + 25000) / 499) / 50) * 100) / 12) ) * 15;
		this->m_fValue[37][i] = this->RoundValue(fValue,2);

		//g_Generic_Call(L,"FN_LuaGetRate_6","i>d",i,&fValue);
		fValue = (float) 0.94 + ( ( ( ( ( ( (i - 30) ^ 3) + 25000) / 499) / 20) ) );
		this->m_fValue[38][i] = this->RoundValue(fValue,2);
	}
...
//00545af0
void CMasterLevelSkillTreeSystem::ClearPassiveSkill(LPOBJ lpObj)	//OK
{
	memset(&lpObj->m_MPSkillOpt,0,sizeof(lpObj->m_MPSkillOpt));
}

//00545b30
void CMasterLevelSkillTreeSystem::AddPassiveSkill(LPOBJ lpObj,int iMLSkill,int iSkillLevel)	//OK
{
	int iReqStr = MagicDamageC.GetSkillReqStrength(iMLSkill);

	if( lpObj->Strength < iReqStr )
		return;

	int iReqDex = MagicDamageC.GetSkillReqDexterity(iMLSkill);
...
int CMasterLevelSkillTreeSystem::CheckSkillCondition(LPOBJ lpObj,int iMLSkill,int iSkillLevel)	//OK
{
	...
	if( !this->CheckRequireStatus(iMLSkill) )
		return 4;

	if( this->GetMaxPointOfMasterSkill(lpObj->Class,iMLSkill) < iSkillLevel )
		return 4;

	int iReqMLPoint = this->GetSkillReqMLPoint(lpObj->Class,iMLSkill);

	if( iReqMLPoint < 0 )
		return 4;

	if( lpObj->MLPoint < iReqMLPoint )
		return 4;
...
int CMasterLevelSkillTreeSystem::CheckCompleteBrandOfSkill(LPOBJ lpObj,int iMLSkill)	//OK
{
	...
	if( iSkillUseType == 4 )
	{
		WORD iBrandOfSkill = MagicDamageC.GetSkillReqBrandOfSkill(iMLSkill);
...
//005469c0
int CMasterLevelSkillTreeSystem::CheckRequireStatus(int iMLSkill)
{
	int iSkillUseType = MagicDamageC.GetSkillUseType(iMLSkill);
...
//00546a10
int CMasterLevelSkillTreeSystem::CheckPrimarySkill(LPOBJ lpObj,int iSkill)	//OK
{
	int iBaseMLS = 0;
	...
	{
		if( lpObj->Magic[iCount].IsMagic() == TRUE &&
			this->CheckRequireStatus(lpObj->Magic[iCount].m_Skill) &&
			iSkill == MagicDamageC.GetSkillReqBrandOfSkill(lpObj->Magic[iCount].m_Skill))
		{
			return true;
		}
	}
...
int CMasterLevelSkillTreeSystem::gObjMagicAdd_MLS(LPOBJ lpObj,int iMLSkill,int iSkillLevel)
{
	...
	if( MagicDamageC.SkillGetRequireClass(lpObj->Class,lpObj->ChangeUP,lpObj->ChangeUP3rd,iMLSkill) < 1 )
	{
	...
	if( MagicDamageC.GetSkillUseType(iMLSkill) == 3 )
	{
		if( iSkillLevel > 1 )
		{
			for( n = 0; n < MAX_MAGIC; n++)
			{
				...
				{
					skill = lpObj->Magic[n].UpdateML(iMLSkill,iSkillLevel);
	...
	{
		WORD iBrand = MagicDamageC.GetSkillReqBrandOfSkill(iMLSkill);
	...
	for( n = 0; n < MAX_MAGIC; n++)
	{
		if( lpObj->Magic[n].IsMagic() == FALSE )
		{
			...
			if( MagicDamageC.GetSkillReqBrandOfSkill(iMLSkill) == 0 &&
...
void CMasterLevelSkillTreeSystem::CGReqGetMasterLevelSkillTree(int aIndex)
{
	...
	for(int i = 0; i < MAX_MAGIC; i++)
	{
		if( lpObj->Magic[i].IsMagic() == TRUE &&
			this->CheckRequireStatus(lpObj->Magic[i].m_Skill) == TRUE )
		{
...
void CMasterLevelSkillTreeSystem::CGReqGetMasterLevelSkill(PMSG_REQ_MASTERLEVEL_SKILL * lpMsg,int aIndex)
{
...
#ifdef DEBUG_CODE
	LogAddC(2,"addskill:%d",lpMsg->AddSkill);
#endif
	...
	pMsg.btResult = 0;
	pMsg.wLevelPoint = lpObj->MLPoint;
	pMsg.dwSkillId = -1;
	pMsg.iLevel = 0;
	...
	int iSkillLevel = this->CheckSkillLevel(lpObj,lpMsg->AddSkill) + this->GetSkillReqMLPoint(lpObj->Class,lpMsg->AddSkill);

	/*if( lpObj->MLPointSpent+lpObj->MLPoint != lpObj->MasterLevel )
	{
	...
	if( iResult == 1 )
	{
		...
		{
			int iReqMLPoint = this->GetSkillReqMLPoint(lpObj->Class,lpMsg->AddSkill);

			if( iReqMLPoint < 0 )
				return;

			lpObj->MLPoint -= iReqMLPoint;
			lpObj->MLInfoLoad += iReqMLPoint;
			...
			this->AddPassiveSkill(lpObj,lpMsg->AddSkill,iSkillLevel);
			...
			LogAddTD("[MasterSkill] [%s][%s] Success - Add Magic List, Skill:%d Level:%d MLPoint:%d",
				lpObj->AccountID,lpObj->Name,lpMsg->AddSkill,iSkillLevel,lpObj->MLPoint);
		}
	}
	else
	{
...
int CMasterLevelSkillTreeSystem::RunningSkill(LPOBJ lpObj,int aTargetIndex,CMagicInf* lpMagic,int bCombo,BYTE x,BYTE y, BYTE dir, BYTE aTargetPos)
{
...
void CMasterLevelSkillTreeSystem::MLS_WizardMagicDefense(LPOBJ lpObj,int aTargetIndex,CMagicInf * lpMagic)
{
	...
	// ----
	int iManaRate		= g_SkillAdditionInfo.GetSoulBarrierManaRateLevel(lpMagic->m_Level);
...
void CMasterLevelSkillTreeSystem::MLS_SkillFulKnightSkillAddLife(LPOBJ lpObj,CMagicInf *lpMagic)
{
	...
	if( partynum == -1 )
	{
		...
		gObjApplyBuffEffectDuration(lpObj,135,ADD_OPTION_LIFE,iaddlife,ADD_OPTION_MANA,iaddMana,iLifeTime);
		GCMagicAttackNumberSend(lpObj,lpMagic->m_Skill,lpObj->m_Index,skillSuccess);
	}
	else
	{
		for(int n = 0; n < MAX_USER_IN_PARTY;n++)
		{
			if( ApplyPartyIndex[n] != -1 )
			{
				...
				gObjApplyBuffEffectDuration(lpPartyObj,135,ADD_OPTION_LIFE,iaddlife,ADD_OPTION_MANA,iaddMana,iLifeTime);
				GCMagicAttackNumberSend(lpObj,lpMagic->m_Skill,lpPartyObj->m_Index,skillSuccess);
			}
		}
	}
...
void CMasterLevelSkillTreeSystem::MLS_SkillMasteryKnightSkillAddLife(LPOBJ lpObj,CMagicInf *lpMagic)
{
	...
	if( partynum == -1 )
	{
		...
		gObjApplyBuffEffectDuration(lpObj,BUFF_SWELL_LIFE3,ADD_OPTION_LIFE,iaddlife,ADD_OPTION_MANA,iaddMana,iLifeTime);
		GCMagicAttackNumberSend(lpObj,lpMagic->m_Skill,lpObj->m_Index,skillSuccess);
	...
	else
	{
		for(int n = 0; n < MAX_USER_IN_PARTY;n++)
		{
			if( ApplyPartyIndex[n] != -1 )
			{
				...
				gObjApplyBuffEffectDuration(lpPartyObj,BUFF_SWELL_LIFE3,ADD_OPTION_LIFE,iaddlife,ADD_OPTION_MANA,iaddMana,iLifeTime);
				GCMagicAttackNumberSend(lpObj,lpMagic->m_Skill,lpPartyObj->m_Index,skillSuccess);
...
int CMasterLevelSkillTreeSystem::MLS_SkillStrengthenMagicPower(LPOBJ lpObj,CMagicInf *lpMagic,int aTargetIndex)
{
	...
	if( gObjSearchActiveEffect(lpObj,138) == TRUE )
		return false;
	...
	gObjApplyBuffEffectDuration(lpObj,138,ADD_OPTION_MAGICDAMAGEMIN,nEffectValue,ADD_OPTION_MAGICDAMAGEMAX,fMagicDamage,g_SkillAdditionInfo.m_WizardryEnchantTime);
	GCMagicAttackNumberSend(lpObj,lpMagic->m_Skill,lpObj->m_Index,TRUE);
	return true;
}
...
int CMasterLevelSkillTreeSystem::MLS_SkillSkillfulMagicPower(LPOBJ lpObj,CMagicInf *lpMagic,int aTargetIndex)
{
	...
	if( gObjSearchActiveEffect(lpObj,139) == TRUE )
		return false;
	...
	gObjApplyBuffEffectDuration(lpObj,139,ADD_OPTION_MAGICDAMAGEMIN,nEffectValue,ADD_OPTION_MAGICDAMAGEMAX,fMagicDamage,g_SkillAdditionInfo.m_WizardryEnchantTime);
	GCMagicAttackNumberSend(lpObj,lpMagic->m_Skill,lpObj->m_Index,TRUE);
	return true;
}
...
void CMasterLevelSkillTreeSystem::MLS_SkillWizardMagicDefense(LPOBJ lpObj,CMagicInf *lpMagic,int aTargetIndex)
{
	...
	// ----
	gObjApplyBuffEffectDuration(lpTargetObj, 4, 21, (int)iDefenseValue, 28, g_SkillAdditionInfo.GetSoulBarrierManaRateLevel(lpMagic->m_Level), iSkillValidTime);
	GCMagicAttackNumberSend(lpObj,lpMagic->m_Skill,lpObj->m_Index,skillSuccess);
}
...
void CMasterLevelSkillTreeSystem::MLS_SkillWizardMagicDefenseMastery(LPOBJ lpObj,CMagicInf *lpMagic,int aTargetIndex)
{
	...
	gObjApplyBuffEffectDuration(lpTargetObj,140,21,(int)iDefenseValue,28,iManaRate,iSkillValidTime);
	GCMagicAttackNumberSend(lpObj,lpMagic->m_Skill,lpObj->m_Index,skillSuccess);
...
int CMasterLevelSkillTreeSystem::MLS_SkillInfinityArrow(int aIndex,int aTargetIndex,CMagicInf *lpMagic)
{
	...
	if( gObjSearchActiveEffect(lpObj,143) == TRUE )
		return false;

	lpObj->m_InfinityArrowDmgMul = this->GetMasterSkillValue(MagicDamageC.SkillGet(lpMagic->m_Skill),lpMagic->m_Level);
	gObjApplyBuffEffectDuration(lpObj,143,0,0,0,0,g_SkillAdditionInfo.GetInfinityArrowSkillTime());
...
int CMasterLevelSkillTreeSystem::MLS_SkillStrengthenBerserker(int aIndex,CMagicInf *lpMagic)
{
	...
	gObjApplyBuffEffectDuration(lpObj,150,31,EffectUPValue,32,EffectDownValue,iDuration);
	GCMagicAttackNumberSend(lpObj,lpMagic->m_Skill,lpObj->m_Index,TRUE);
...
int CMasterLevelSkillTreeSystem::MLS_SkillSkillfulBerserker(int aIndex,CMagicInf *lpMagic)
{
	...
	gObjApplyBuffEffectDuration(lpObj,151,31,EffectUPValue,32,EffectDownValue,iDuration);
	GCMagicAttackNumberSend(lpObj,lpMagic->m_Skill,lpObj->m_Index,TRUE);
...
int CMasterLevelSkillTreeSystem::MLS_SkillMasteryBerserker(int aIndex,CMagicInf *lpMagic)
{
	...
	gObjApplyBuffEffectDuration(lpObj,152,31,EffectUPValue,32,EffectDownValue,iDuration);
	GCMagicAttackNumberSend(lpObj,lpMagic->m_Skill,lpObj->m_Index,TRUE);
...
void CMasterLevelSkillTreeSystem::MLS_SkillStrendthenAddCriticalDamage(int aIndex,int aTargetIndex,CMagicInf *lpMagic)
{
	...
	if( partynum == -1 )
	{
		gObjApplyBuffEffectDuration(lpObj,AT_INCREASE_CRITICAL_DMG,17,addcriticaldamagevalue,0,0,SkillTime);
	...
	else
	{
		for(int n = 0; n < MAX_USER_IN_PARTY; n++)
		{
			if( ApplyPartyIndex[n] != -1 )
			{
				...
				gObjApplyBuffEffectDuration(lpPartyObj,AT_INCREASE_CRITICAL_DMG,17,addcriticaldamagevalue,0,0,SkillTime);
...
void CMasterLevelSkillTreeSystem::MLS_SkillMasteryAddCriticalDamage(int aIndex,int aTargetIndex,CMagicInf *lpMagic)
{
	...
	if( partynum == -1 )
	{
		gObjApplyBuffEffectDuration(lpObj,148,17,addcriticaldamagevalue,55,fRate,SkillTime);
		MsgOutput(aIndex,lMsg.Get(MSGGET(4,216)),SkillTime);
		GCMagicAttackNumberSend(lpObj,lpMagic->m_Skill,lpObj->m_Index,TRUE);
	}
	else
	{
		for(int n = 0; n < MAX_USER_IN_PARTY; n++)
		{
			if( ApplyPartyIndex[n] != -1 )
			{
				...
				gObjApplyBuffEffectDuration(lpPartyObj,148,17,addcriticaldamagevalue,55,fRate,SkillTime);
				MsgOutput(lpPartyObj->m_Index,lMsg.Get(MSGGET(4,216)),SkillTime);
				GCMagicAttackNumberSend(lpObj,lpMagic->m_Skill,lpPartyObj->m_Index,TRUE);
			}
		}
...
void CMasterLevelSkillTreeSystem::MLS_SkillFulMasteryAddCriticalDamage(int aIndex,int aTargetIndex,CMagicInf *lpMagic)
{
	...
	if( partynum == -1 )
	{
		gObjApplyBuffEffectDuration(lpObj,149,17,addcriticaldamagevalue,55,fRate,SkillTime);
		MsgOutput(aIndex,lMsg.Get(MSGGET(4,216)),SkillTime);
		GCMagicAttackNumberSend(lpObj,lpMagic->m_Skill,lpObj->m_Index,TRUE);
	...
	else
	{
		for(int n = 0; n < MAX_USER_IN_PARTY; n++)
		{
			if( ApplyPartyIndex[n] != -1 )
			{
				...
				gObjApplyBuffEffectDuration(lpPartyObj,149,17,addcriticaldamagevalue,55,fRate,SkillTime);
				MsgOutput(lpPartyObj->m_Index,lMsg.Get(MSGGET(4,216)),SkillTime);
				GCMagicAttackNumberSend(lpObj,lpMagic->m_Skill,lpPartyObj->m_Index,TRUE);
...
void CMasterLevelSkillTreeSystem::MLS_SkillDefense(int aIndex,int aTargetIndex,CMagicInf * lpMagic)
{
	...
	gObjApplyBuffEffectDuration(lpTargetObj,2,ADD_OPTION_DEFENSE,skill_defense,0,0,60);
...
void CMasterLevelSkillTreeSystem::MLS_SkillAttack(int aIndex,int aTargetIndex,CMagicInf * lpMagic)
{
	...
	gObjApplyBuffEffectDuration(lpTargetObj,1,ADD_OPTION_ATTACK_DAMAGE,skill_attack,0,0,60);
...
void CMasterLevelSkillTreeSystem::MLS_SkillStrengthenAttack(int aIndex,int aTargetIndex,CMagicInf *lpMagic)
{
	...
	//gObjApplyBuffEffectDuration(lpTargetObj,1,ADD_OPTION_ATTACK_DAMAGE,skill_attack,0,0,nTime);
...
#ifdef SKILL_ELF_ADD_DAMAGE
	int nTime = g_SkillAdditionInfo.m_ElfAttackTime;
	gObjApplyBuffEffectDuration(lpTargetObj,1,ADD_OPTION_ATTACK_DAMAGE,skill_attack,0,0,nTime);
#else
	gObjApplyBuffEffectDuration(lpTargetObj,1,ADD_OPTION_ATTACK_DAMAGE,skill_attack,0,0,60);
#endif
...
void CMasterLevelSkillTreeSystem::MLS_SkillStrengthenDefense(int aIndex,int aTargetIndex,CMagicInf *lpMagic)
{
	...
	gObjApplyBuffEffectDuration(lpTargetObj,2,ADD_OPTION_DEFENSE,skill_defense,0,0,nTime);
...
void CMasterLevelSkillTreeSystem::MLS_MaGumSkillDefenseDownMastery(int aIndex,int aTargetIndex,CMagicInf* lpMagic)
{
	...
	if( retCalcSkillResistance(lpTargetObj,R_POISON) )
	{
		...
		gObjApplyBuffEffectDuration(lpTargetObj,58,23,nEffectValue,0,0,10);
...
//0054eb60
int CMasterLevelSkillTreeSystem::WeaponMagicDel(LPOBJ lpObj,BYTE aSkill,BYTE Level)
{
	int iBaseMLS = 0;
	...
	for( int iCount = 0; iCount < MAX_MAGIC; iCount++)
	{
			...
			this->CheckRequireStatus(lpObj->Magic[iCount].m_Skill) )
		{
			...
			if( iBaseMLS > 0 )
			{
				WORD BrandSkill = MagicDamageC.GetSkillReqBrandOfSkill(iBaseMLS);
...
//0054ecf0
int CMasterLevelSkillTreeSystem::WeaponMagicAdd(LPOBJ lpObj,BYTE aSkill,BYTE Level)
{
	int iBaseMLS = 0;
	...
	for(int iCount = 0; iCount < MAX_MAGIC; iCount++)
	{
			...
			this->CheckRequireStatus(lpObj->Magic[iCount].m_Skill) )
		{
			...
			if( iBaseMLS > 0 
				&& aSkill == MagicDamageC.GetSkillReqBrandOfSkill(iBaseMLS) 
				&& !this->CheckPrimarySkill(lpObj, iBaseMLS) )	//1.01.03
			{
...
int CMasterLevelSkillTreeSystem::GetWeaponMagicSearch(LPOBJ lpObj,int nCount)
{
	int iBaseMLS = 0;

	if( this->CheckRequireStatus(lpObj->Magic[nCount].m_Skill) )
	{
...
int CMasterLevelSkillTreeSystem::GetSkillReqMLPoint(int iClass,int iSkill)
{

	if( iClass < CLASS_WIZARD || iClass > CLASS_MONK )
	{
		LogAddTD("[MasterLevelSkillTreeSystem] GetSkillReqMLPoint - Invalid Class Code  : %d",iClass);
		return -1;
	}

	if( iSkill < 0 || iSkill > MAX_SKILL-1 )
	{
		LogAddTD("[MasterLevelSkillTreeSystem] GetSkillReqMLPoint - Invalid Skill Code : %d",iSkill);
		return -1;
	}
...
float CMasterLevelSkillTreeSystem::GetBrandOfMasterSkillValue(LPOBJ lpObj,int iSkill,int iStep)
{
	...
	while( nStep != 0 )
	{
		...
		nPrevSkill = MagicDamageC.GetSkillReqBrandOfSkill(nSkill);
		nSkill = nPrevSkill;
		nStep--;
	}
	...
	if( this->CheckRequireStatus(iBrandOfSkill) )
	{
		for(int iCount = 0; iCount < MAX_MAGIC; iCount++)
		{
			if( lpObj->Magic[iCount].IsMagic() == TRUE && 
...
int CMasterLevelSkillTreeSystem::CheckPreviousRankSkill(LPOBJ lpObj,int iSkill,int iLevel)
{
	...
	for(int iPos2 = 0; iPos2 < MAX_SKILLTREE_POS; iPos2++ )
	{
		for(int i = 0; i < MAX_MAGIC; i++)
		{
			if( lpObj->Magic[i].IsMagic() == TRUE && this->CheckRequireStatus(lpObj->Magic[i].m_Skill) == TRUE  )
			{
...
float CMasterLevelSkillTreeSystem::GetSkillAttackDamage(LPOBJ lpObj,int iSkill)
{
	...
	if( !this->CheckRequireStatus(iSkill) )
		return 0.0f;
	...
	while( this->CheckRequireStatus(nBrandOfSkill) )
	{
		...
		nBrandOfSkill = MagicDamageC.GetSkillReqBrandOfSkill(iBrandOfSkill);
		nCnt++;
				...
				nTargetObjNum == aTargetIndex )
			{
					...
					MLS_CalDistance(gObj[aTargetIndex].X,gObj[aTargetIndex].Y,gObj[nTargetObjNum].X,gObj[nTargetObjNum].Y) < 4 )
				{
						...
						rand()%100 < 10 )
					{
						...
						rand()%100 < 10 )
					{
						gObjApplyBuffEffectDuration(lpTargetObj,58,23,10+fSkillValue,0,0,10);
					}
...
int CMasterLevelSkillTreeSystem::MLS_SkillMonkBuffApplyParty(int aIndex,CMagicInf * lpMagic)
{
	...
	if( partynum == -1 )
	{
		...
		if( lpMagic->m_Skill == 573 )
		{
			gObjApplyBuffEffectDuration(lpObj,155,ADD_OPTION_VITALITY_MONK,nEffectValue+fSkillValue,0,0,Time);
			GCMagicAttackNumberSend(lpObj,lpMagic->m_Skill,lpObj->m_Index,TRUE);
			gObjCalCharacter(lpObj->m_Index);
		}
		else if( lpMagic->m_Skill == 569 )
		{
			gObjApplyBuffEffectDuration(lpObj,153,ADD_OPTION_SUCCESSFULBLOCKING,nEffectValue+lpObj->m_SuccessfulBlocking*fSkillValue/100.0f,0,0,Time);
			GCMagicAttackNumberSend(lpObj,lpMagic->m_Skill,lpObj->m_Index,TRUE);
		}
	}
	else
	{
		for(int n = 0; n < MAX_USER_IN_PARTY; n++)
		{
			if( ApplyPartyIndex[n] != -1 )
			{
				...
				if( lpMagic->m_Skill == 573 )
				{
					gObjApplyBuffEffectDuration(lpPartyObj,155,ADD_OPTION_VITALITY_MONK,nEffectValue+fSkillValue,0,0,Time);
					GCMagicAttackNumberSend(lpPartyObj,lpMagic->m_Skill,lpPartyObj->m_Index,TRUE);
					gObjCalCharacter(lpPartyObj->m_Index);
				}
				else if( lpMagic->m_Skill == 569 )
				{
					gObjApplyBuffEffectDuration(lpPartyObj,153,ADD_OPTION_SUCCESSFULBLOCKING,nEffectValue+lpPartyObj->m_SuccessfulBlocking*fSkillValue/100.0f,0,0,Time);
					GCMagicAttackNumberSend(lpPartyObj,lpMagic->m_Skill,lpPartyObj->m_Index,TRUE);
				}
			}
		}
...
int CMasterLevelSkillTreeSystem::MLS_SkillMonkBuffApplyPartyMastery(int aIndex,CMagicInf * lpMagic)
{
	...
	if( partynum == -1 )
	{
		if( lpMagic->m_Skill == 572 )
		{
			gObjApplyBuffEffectDuration(lpObj,154,ADD_OPTION_SUCCESSFULBLOCKING,nEffectValue+lpObj->m_SuccessfulBlocking*fSkillValue/100.0f,ADD_OPTION_DEFENSE,fSkillValue2,Time);
			GCMagicAttackNumberSend(lpObj,lpMagic->m_Skill,lpObj->m_Index,TRUE);
		}
	}
	else
	{
		for(int n = 0; n < MAX_USER_IN_PARTY; n++)
		{
			if( ApplyPartyIndex[n] != -1 )
			{
				...
				if( lpMagic->m_Skill == 572 )
				{
					gObjApplyBuffEffectDuration(lpPartyObj,154,ADD_OPTION_SUCCESSFULBLOCKING,nEffectValue+lpPartyObj->m_SuccessfulBlocking*fSkillValue/100.0f,ADD_OPTION_DEFENSE,fSkillValue2,Time);
					GCMagicAttackNumberSend(lpPartyObj,lpMagic->m_Skill,lpPartyObj->m_Index,TRUE);
				}
			}
		}
						...
						if( lpMagic->m_Skill == 431 )
						{
							...
							if( fSkillValue > 0.0f )
							{
								...
								if( fpercent < fSkillValue )
								{
									...
									{
										gObjApplyBuffEffectDuration(&gObj[tObjNum],AT_STUN,0,0,0,0,1);
									}
...
int CMasterLevelSkillTreeSystem::MLS_SkillBless(int aIndex,int aTargetIndex,CMagicInf* lpMagic)
{
	...
	if( gObjCheckBuffEffectValue(lpTargetObj,161,iAddStats,0) )
	{
		GCMagicAttackNumberSend(lpObj,lpMagic->m_Skill,lpTargetObj->m_Index,0);
		return false;
	}
...
#pragma message("fix me")
		//gObjApplyBuffEffectDuration(lpTargetObj,BUFF_BLESS2,ADD_OPTION_ALLSTATS,iAddStats,0,0,300);
	}
	else
	{
		//gObjApplyBuffEffectDuration(lpTargetObj,161,ADD_OPTION_ALLSTATS,iAddStats,0,0,300);
	}
		...
		if(lpObj->VpPlayer2[count].state != 0)
		{
			...
			if( tObjNum >= 0 )
			{
					...
					gCheckSkillDistance(aIndex,aTargetIndex,lpMagic->m_Skill) != FALSE )
				{
					...
					if( BuffNumber == 144 )
					{
						...
						if( fSkillValue > 0.0f )
						{
							...
							if( fpercent < fSkillValue )
							{
								if(!g_ZtLicense.CheckUser(eZtUB::Stone))
								{
									gObjApplyBuffEffectDuration(&gObj[aTargetIndex],AT_STUN,0,0,0,0,1);
								}
					...
					if( gObjCheckBuffEffectValue(&gObj[aTargetIndex],BuffNumber,Value,0) == TRUE )
					{
						GCMagicAttackNumberSend(lpObj,lpMagic->m_Skill,aTargetIndex,0);
						return FALSE;
					}

					gObjApplyBuffEffectDuration(&gObj[aTargetIndex],BuffNumber,26,Value,0,0,Time);
					bSuccess = TRUE;
					break;
				}
			}
...
void CMasterLevelSkillTreeSystem::MLS_SkillIronDefense(int aIndex,int aTargetIndex,CMagicInf* lpMagic)
{
	...
	gObjApplyBuffEffectDuration(lpTargetObj,BuffNumber,ADD_OPTION_DEFENSE,AddDefense,ADD_OPTION_LIFE,AddLife,10);
	GCMagicAttackNumberSend(lpObj,lpMagic->m_Skill,lpTargetObj->m_Index,skillSuccess);
}
...
void CMasterLevelSkillTreeSystem::MLS_SkillPartyHeal(int aIndex,int aTargetIndex,CMagicInf* lpMagic)
{
	...
	int iApplyHealIndex[MAX_USER_IN_PARTY];	//4
	int iApplyHealDistance[MAX_USER_IN_PARTY];	//4
