...
void NewsBoard::ReadMainData(char * File)
{
	...
	this->m_ShowOnLogin	= GetPrivateProfileIntA("ZtTeam", "ShowOnLogin", 0, File);
}
// -------------------------------------------------------------------------------
...
{
	this->Init();
	this->ReadListData(gDirPath.GetNewPath("ZtData\\NewsList.txt"));
	this->ReadMainData(gDirPath.GetNewPath("ZtData\\NewsMain.ini"));
}
// -------------------------------------------------------------------------------
