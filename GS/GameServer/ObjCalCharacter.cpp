...
void gObjCalCharacter(int aIndex)
{
	...
	if ( lpObj->Class == CLASS_ELF )
	{
		...
		if((Right->m_Type >= ITEMGET(4,0) && Right->m_Type < ITEMGET(5,0)) || 
		   (Left->m_Type >= ITEMGET(4,0) && Left->m_Type < ITEMGET(5,0)))
		{
			if ( (Right->IsItem() != FALSE && Right->m_IsValidItem == false) || (Left->IsItem() != FALSE && Left->m_IsValidItem == false) )
			{
				//int DamageMax_Bow_StrDexRight = GetPrivateProfileInt("Fairy_Elf","DamageMax_Bow_StrDexRight",4,"..\\Data\\ZtData\\Character.ini");
				//int DamageMin_Bow_StrDexRight = GetPrivateProfileInt("Fairy_Elf","DamageMin_Bow_StrDexRight",7,"..\\Data\\ZtData\\Character.ini");
				//int DamageMax_Bow_StrDexLeft = GetPrivateProfileInt("Fairy_Elf","DamageMax_Bow_StrDexLeft",4,"..\\Data\\ZtData\\Character.ini");
				//int DamageMin_Bow_StrDexLeft = GetPrivateProfileInt("Fairy_Elf","DamageMin_Bow_StrDexLeft",7,"..\\Data\\ZtData\\Character.ini");
				lpObj->m_AttackDamageMinRight = (Dexterity + Strength ) / ZtConfig.Character.ELFDamageMin_Bow_StrDexRight;	//7
				lpObj->m_AttackDamageMaxRight = (Dexterity + Strength ) / ZtConfig.Character.ELFDamageMax_Bow_StrDexRight;	//4
				lpObj->m_AttackDamageMinLeft = (Dexterity + Strength ) / ZtConfig.Character.ELFDamageMin_Bow_StrDexLeft;		//7
				lpObj->m_AttackDamageMaxLeft = (Dexterity + Strength ) / ZtConfig.Character.ELFDamageMax_Bow_StrDexLeft;		//4
			}
			else
			{
				//int DamageMax_NoBow_StrRight = GetPrivateProfileInt("Fairy_Elf","DamageMax_NoBow_StrRight",8,"..\\Data\\ZtData\\Character.ini");
				//int DamageMax_NoBow_DexRight = GetPrivateProfileInt("Fairy_Elf","DamageMax_NoBow_DexRight",4,"..\\Data\\ZtData\\Character.ini");
				//int DamageMin_NoBow_StrRight = GetPrivateProfileInt("Fairy_Elf","DamageMin_NoBow_StrRight",14,"..\\Data\\ZtData\\Character.ini");
				//int DamageMin_NoBow_DexRight = GetPrivateProfileInt("Fairy_Elf","DamageMin_NoBow_DexRight",7,"..\\Data\\ZtData\\Character.ini");

				//int DamageMax_NoBow_StrLeft = GetPrivateProfileInt("Fairy_Elf","DamageMax_NoBow_StrLeft",8,"..\\Data\\ZtData\\Character.ini");
				//int DamageMax_NoBow_DexLeft = GetPrivateProfileInt("Fairy_Elf","DamageMax_NoBow_DexLeft",4,"..\\Data\\ZtData\\Character.ini");
				//int DamageMin_NoBow_StrLeft = GetPrivateProfileInt("Fairy_Elf","DamageMin_NoBow_StrLeft",14,"..\\Data\\ZtData\\Character.ini");
				//int DamageMin_NoBow_DexLeft = GetPrivateProfileInt("Fairy_Elf","DamageMin_NoBow_DexLeft",7,"..\\Data\\ZtData\\Character.ini");

				lpObj->m_AttackDamageMinRight = (Dexterity / ZtConfig.Character.ELFDamageMin_NoBow_DexRight) + (Strength / ZtConfig.Character.ELFDamageMin_NoBow_StrRight);
				lpObj->m_AttackDamageMaxRight = (Dexterity / ZtConfig.Character.ELFDamageMax_NoBow_DexRight) + (Strength / ZtConfig.Character.ELFDamageMax_NoBow_StrRight );
				lpObj->m_AttackDamageMinLeft = (Dexterity / ZtConfig.Character.ELFDamageMin_NoBow_DexLeft) + (Strength / ZtConfig.Character.ELFDamageMin_NoBow_StrLeft);
				lpObj->m_AttackDamageMaxLeft = (Dexterity / ZtConfig.Character.ELFDamageMax_NoBow_DexLeft) + (Strength / ZtConfig.Character.ELFDamageMax_NoBow_StrLeft );
			}
		}
		else
		{
			//int DamageMax_DexStrRight = GetPrivateProfileInt("Fairy_Elf","DamageMax_DexStrRight",4,"..\\Data\\ZtData\\Character.ini");
			//int DamageMin_DexStrRight = GetPrivateProfileInt("Fairy_Elf","DamageMin_DexStrRight",7,"..\\Data\\ZtData\\Character.ini");
			//int DamageMax_DexStrLeft = GetPrivateProfileInt("Fairy_Elf","DamageMax_DexStrLeft",4,"..\\Data\\ZtData\\Character.ini");
			//int DamageMin_DexStrLeft = GetPrivateProfileInt("Fairy_Elf","DamageMin_DexStrLeft",7,"..\\Data\\ZtData\\Character.ini");

			lpObj->m_AttackDamageMinRight = (Dexterity + Strength) / ZtConfig.Character.ELFDamageMin_DexStrRight;	// 7
			lpObj->m_AttackDamageMaxRight = (Dexterity + Strength) / ZtConfig.Character.ELFDamageMax_DexStrRight;	// 4
			lpObj->m_AttackDamageMinLeft = (Dexterity + Strength) / ZtConfig.Character.ELFDamageMin_DexStrLeft;	// 7
			lpObj->m_AttackDamageMaxLeft = (Dexterity + Strength) / ZtConfig.Character.ELFDamageMax_DexStrLeft;	// 4
		}
	
		if (g_ZtLicense.CheckUser(eZtUB::ulasevich) || g_ZtLicense.CheckUser(eZtUB::ulasevich2))
		{
			int iAttackDamageStrengthMin = 0;
			int iAttackDamageStrengthMax = 0;
			int iAttackDamageDexterityMin = 0;
			int iAttackDamageDexterityMax = 0;
			int iAttackDamageVitalityMin = 0;
			int iAttackDamageVitalityMax = 0;
			int iAttackDamageEnergyMin = 0;
			int iAttackDamageEnergyMax = 0;

			if(ZtConfig.Character.AEAttackDamageStrengthMin > 0)
			{
				iAttackDamageStrengthMin = Strength / ZtConfig.Character.AEAttackDamageStrengthMin;
			}

			if(ZtConfig.Character.AEAttackDamageStrengthMax > 0)
			{
				iAttackDamageStrengthMax = Strength / ZtConfig.Character.AEAttackDamageStrengthMax;
			}

			if(ZtConfig.Character.AEAttackDamageDexterityMin > 0)
			{
				iAttackDamageDexterityMin = Dexterity / ZtConfig.Character.AEAttackDamageDexterityMin;
			}
			
			if(ZtConfig.Character.AEAttackDamageDexterityMax > 0)
			{
				iAttackDamageDexterityMax = Dexterity / ZtConfig.Character.AEAttackDamageDexterityMax;
			}		

			if(ZtConfig.Character.AEAttackDamageVitalityMin > 0)
			{
				iAttackDamageVitalityMin = Vitality / ZtConfig.Character.AEAttackDamageVitalityMin;
			}	

			if(ZtConfig.Character.AEAttackDamageVitalityMax > 0)
			{
				iAttackDamageVitalityMax = Vitality / ZtConfig.Character.AEAttackDamageVitalityMax;
			}	
			
			if(ZtConfig.Character.AEAttackDamageEnergyMin > 0)
			{
				iAttackDamageEnergyMin = Energy / ZtConfig.Character.AEAttackDamageEnergyMin;
			}	

			if(ZtConfig.Character.AEAttackDamageEnergyMax > 0)
			{
				iAttackDamageEnergyMax = Energy / ZtConfig.Character.AEAttackDamageEnergyMax;
			}	

			int iAttackDamageMin = iAttackDamageStrengthMin + iAttackDamageDexterityMin + iAttackDamageVitalityMin + iAttackDamageEnergyMin;
			int iAttackDamageMax = iAttackDamageStrengthMax + iAttackDamageDexterityMax + iAttackDamageVitalityMax + iAttackDamageEnergyMax;

			lpObj->m_AttackDamageMinRight = iAttackDamageMin;
			lpObj->m_AttackDamageMaxRight = iAttackDamageMax;
			lpObj->m_AttackDamageMinLeft = iAttackDamageMin;
			lpObj->m_AttackDamageMaxLeft = iAttackDamageMax;
		}
	...
	{
		//int DamageMax_StrRight = GetPrivateProfileInt("Dark_Knight","DamageMax_StrRight",4,"..\\Data\\ZtData\\Character.ini");
		//int DamageMin_StrRight = GetPrivateProfileInt("Dark_Knight","DamageMin_StrRight",6,"..\\Data\\ZtData\\Character.ini");
		//int DamageMax_StrLeft = GetPrivateProfileInt("Dark_Knight","DamageMax_StrLeft",4,"..\\Data\\ZtData\\Character.ini");
		//int DamageMin_StrLeft = GetPrivateProfileInt("Dark_Knight","DamageMin_StrLeft",6,"..\\Data\\ZtData\\Character.ini");

		lpObj->m_AttackDamageMinRight = Strength / ZtConfig.Character.DKDamageMin_StrRight;	// 6
		lpObj->m_AttackDamageMaxRight = Strength / ZtConfig.Character.DKDamageMax_StrRight;	// 4
		lpObj->m_AttackDamageMinLeft = Strength / ZtConfig.Character.DKDamageMin_StrLeft;	// 6
		lpObj->m_AttackDamageMaxLeft = Strength / ZtConfig.Character.DKDamageMax_StrLeft;	// 4
	...
	{
		//int DamageMax_StrRight = GetPrivateProfileInt("Magic_Gladiator","DamageMax_StrRight",4,"..\\Data\\ZtData\\Character.ini");
		//int DamageMax_EneRight = GetPrivateProfileInt("Magic_Gladiator","DamageMax_EneRight",8,"..\\Data\\ZtData\\Character.ini");
		//int DamageMin_StrRight = GetPrivateProfileInt("Magic_Gladiator","DamageMin_StrRight",6,"..\\Data\\ZtData\\Character.ini");
		//int DamageMin_EneRight = GetPrivateProfileInt("Magic_Gladiator","DamageMin_EneRight",12,"..\\Data\\ZtData\\Character.ini");

		//int DamageMax_StrLeft = GetPrivateProfileInt("Magic_Gladiator","DamageMax_StrLeft",4,"..\\Data\\ZtData\\Character.ini");
		//int DamageMax_EneLeft = GetPrivateProfileInt("Magic_Gladiator","DamageMax_EneLeft",8,"..\\Data\\ZtData\\Character.ini");
		//int DamageMin_StrLeft = GetPrivateProfileInt("Magic_Gladiator","DamageMin_StrLeft",6,"..\\Data\\ZtData\\Character.ini");
		//int DamageMin_EneLeft = GetPrivateProfileInt("Magic_Gladiator","DamageMin_EneLeft",12,"..\\Data\\ZtData\\Character.ini");

		lpObj->m_AttackDamageMinRight = (Strength / ZtConfig.Character.MGDamageMin_StrRight) + (Energy / ZtConfig.Character.MGDamageMin_EneRight);
		lpObj->m_AttackDamageMaxRight = (Strength / ZtConfig.Character.MGDamageMax_StrRight) + (Energy / ZtConfig.Character.MGDamageMax_EneRight);
		lpObj->m_AttackDamageMinLeft = (Strength / ZtConfig.Character.MGDamageMin_StrLeft) + (Energy / ZtConfig.Character.MGDamageMin_EneLeft);
		lpObj->m_AttackDamageMaxLeft = (Strength / ZtConfig.Character.MGDamageMax_StrLeft) + (Energy / ZtConfig.Character.MGDamageMax_EneLeft);
	...
	{
		//int DamageMax_StrRight = GetPrivateProfileInt("Dark_Lord","DamageMax_StrRight",5,"..\\Data\\ZtData\\Character.ini");
		//int DamageMax_EneRight = GetPrivateProfileInt("Dark_Lord","DamageMax_EneRight",10,"..\\Data\\ZtData\\Character.ini");
		//int DamageMin_StrRight = GetPrivateProfileInt("Dark_Lord","DamageMin_StrRight",7,"..\\Data\\ZtData\\Character.ini");
		//int DamageMin_EneRight = GetPrivateProfileInt("Dark_Lord","DamageMin_EneRight",14,"..\\Data\\ZtData\\Character.ini");

		//int DamageMax_StrLeft = GetPrivateProfileInt("Dark_Lord","DamageMax_StrLeft",5,"..\\Data\\ZtData\\Character.ini");
		//int DamageMax_EneLeft = GetPrivateProfileInt("Dark_Lord","DamageMax_EneLeft",10,"..\\Data\\ZtData\\Character.ini");
		//int DamageMin_StrLeft = GetPrivateProfileInt("Dark_Lord","DamageMin_StrLeft",7,"..\\Data\\ZtData\\Character.ini");
		//int DamageMin_EneLeft = GetPrivateProfileInt("Dark_Lord","DamageMin_EneLeft",14,"..\\Data\\ZtData\\Character.ini");

		lpObj->m_AttackDamageMinRight = (Strength / ZtConfig.Character.DLDamageMin_StrRight) + (Energy / ZtConfig.Character.DLDamageMin_EneRight);
		lpObj->m_AttackDamageMaxRight = (Strength / ZtConfig.Character.DLDamageMax_StrRight) + (Energy / ZtConfig.Character.DLDamageMax_EneRight);
		lpObj->m_AttackDamageMinLeft = (Strength / ZtConfig.Character.DLDamageMin_StrLeft) + (Energy / ZtConfig.Character.DLDamageMin_EneLeft);
		lpObj->m_AttackDamageMaxLeft = (Strength / ZtConfig.Character.DLDamageMax_StrLeft) + (Energy / ZtConfig.Character.DLDamageMax_EneLeft);
	...
	{
		//int DamageMax_StrRight = GetPrivateProfileInt("Summoner","DamageMax_StrRight",4,"..\\Data\\ZtData\\Character.ini");
		//int DamageMin_StrRight = GetPrivateProfileInt("Summoner","DamageMin_StrRight",7,"..\\Data\\ZtData\\Character.ini");
		//int DamageMax_StrLeft = GetPrivateProfileInt("Summoner","DamageMax_StrLeft",4,"..\\Data\\ZtData\\Character.ini");
		//int DamageMin_StrLeft = GetPrivateProfileInt("Summoner","DamageMin_StrLeft",7,"..\\Data\\ZtData\\Character.ini");

		lpObj->m_AttackDamageMinRight = ((Strength + Dexterity) / ZtConfig.Character.SUMDamageMin_StrRight);	// 7
		lpObj->m_AttackDamageMaxRight = ((Strength + Dexterity) / ZtConfig.Character.SUMDamageMax_StrRight);	// 4
		lpObj->m_AttackDamageMinLeft = ((Strength + Dexterity) / ZtConfig.Character.SUMDamageMin_StrLeft);	// 7
		lpObj->m_AttackDamageMaxLeft = ((Strength + Dexterity) / ZtConfig.Character.SUMDamageMax_StrLeft);	// 4
	}
	else if (lpObj->Class == CLASS_WIZARD)
	{
		//int DamageMax_StrRight = GetPrivateProfileInt("Dark_Wizard","DamageMax_StrRight",4,"..\\Data\\ZtData\\Character.ini");
		//int DamageMin_StrRight = GetPrivateProfileInt("Dark_Wizard","DamageMin_StrRight",6,"..\\Data\\ZtData\\Character.ini");
		//int DamageMax_StrLeft = GetPrivateProfileInt("Dark_Wizard","DamageMax_StrLeft",4,"..\\Data\\ZtData\\Character.ini");
		//int DamageMin_StrLeft = GetPrivateProfileInt("Dark_Wizard","DamageMin_StrLeft",6,"..\\Data\\ZtData\\Character.ini");

		lpObj->m_AttackDamageMinRight = (Strength / ZtConfig.Character.DWDamageMin_StrRight);
		lpObj->m_AttackDamageMaxRight = (Strength / ZtConfig.Character.DWDamageMax_StrRight);
		lpObj->m_AttackDamageMinLeft = (Strength / ZtConfig.Character.DWDamageMin_StrLeft);
		lpObj->m_AttackDamageMaxLeft = (Strength / ZtConfig.Character.DWDamageMax_StrLeft);
	...
	{
		lpObj->m_AttackDamageMinRight	= Vitality / ZtConfig.Character.RFDamageMin_VitRight /*15*/ + Strength / ZtConfig.Character.RFDamageMin_StrRight;
		lpObj->m_AttackDamageMaxRight	= Vitality / ZtConfig.Character.RFDamageMax_VitRight + Strength / ZtConfig.Character.RFDamageMax_StrRight;
		lpObj->m_AttackDamageMinLeft	= Vitality / ZtConfig.Character.RFDamageMin_VitLeft + Strength / ZtConfig.Character.RFDamageMin_StrLeft;
		lpObj->m_AttackDamageMaxLeft	= Vitality / ZtConfig.Character.RFDamageMax_VitLeft + Strength / ZtConfig.Character.RFDamageMax_StrLeft;
	...
	{
		//int MagicDamageMax = GetPrivateProfileInt("Summoner","MagicDamageMax",4,"..\\Data\\ZtData\\Character.ini");
		//int MagicDamageMin = GetPrivateProfileInt("Summoner","MagicDamageMin",9,"..\\Data\\ZtData\\Character.ini");

		lpObj->m_MagicDamageMin = Energy / ZtConfig.Character.SUMMagicDamageMin;	// 9
		lpObj->m_MagicDamageMax = Energy / ZtConfig.Character.SUMMagicDamageMax;	// 4

		lpObj->m_iSummonerBookSpellDamageMin = Energy / ZtConfig.Character.SUMMagicDamageMin;	// Energy / 9
		lpObj->m_iSummonerBookSpellDamageMax = Energy / ZtConfig.Character.SUMMagicDamageMax;	// (Energy / 4) + 0.015
		...
		{
			lpObj->m_MagicDamageMin += (Strength / ZtConfig.Character.SUMDamageMin_StrRight);
			lpObj->m_MagicDamageMax += (Strength / ZtConfig.Character.SUMDamageMax_StrRight);

			lpObj->m_iSummonerBookSpellDamageMin += (Strength / ZtConfig.Character.SUMDamageMin_StrRight);
			lpObj->m_iSummonerBookSpellDamageMax += (Strength / ZtConfig.Character.SUMDamageMax_StrRight);
		}
	}

	if(lpObj->Class == CLASS_MAGUMSA) //season4 add-on
	{
		//int MagicDamageMax = GetPrivateProfileInt("Magic_Gladiator","MagicDamageMax",4,"..\\Data\\ZtData\\Character.ini");
		//int MagicDamageMin = GetPrivateProfileInt("Magic_Gladiator","MagicDamageMin",9,"..\\Data\\ZtData\\Character.ini");

		lpObj->m_MagicDamageMin = Energy / ZtConfig.Character.MGMagicDamageMin;
		lpObj->m_MagicDamageMax = Energy / ZtConfig.Character.MGMagicDamageMax;
	...
	{
		//int MagicDamageMax = GetPrivateProfileInt("Dark_Wizard","MagicDamageMax",4,"..\\Data\\ZtData\\Character.ini");
		//int MagicDamageMin = GetPrivateProfileInt("Dark_Wizard","MagicDamageMin",9,"..\\Data\\ZtData\\Character.ini");

		lpObj->m_MagicDamageMin = Energy / ZtConfig.Character.DWMagicDamageMin;
		lpObj->m_MagicDamageMax = Energy / ZtConfig.Character.DWMagicDamageMax;

		if(g_ZtLicense.CheckUser(eZtUB::MuPrime))
		{
			lpObj->m_MagicDamageMin += (Strength / ZtConfig.Character.DWDamageMin_StrRight);
			lpObj->m_MagicDamageMax += (Strength / ZtConfig.Character.DWDamageMax_StrRight);
		}
	...
	{
		#if(FIX_MG_WIZDMG)
		if (lpObj->pInventory[0].m_Type >= ITEMGET(0,00) && lpObj->pInventory[0].m_Type < ITEMGET(1,00))
		{
...
#if(CUSTOM_FLAGS)
	if ((lpObj->pInventory[10].IsItem() == TRUE && lpObj->pInventory[10].m_Type == ITEMGET(13, 20) && lpObj->pInventory[10].m_Level == 3 && lpObj->pInventory[10].m_Durability > 0.0f) || (lpObj->pInventory[11].IsItem() == TRUE && lpObj->pInventory[11].m_Type == ITEMGET(13, 20) && lpObj->pInventory[11].m_Level == 3 && lpObj->pInventory[11].m_Durability > 0.0f))
	{
		lpObj->m_AttackDamageMinRight += lpObj->m_AttackDamageMinRight * ZtConfig.CommonServer.Ringstrength / 100;
		lpObj->m_AttackDamageMaxRight += lpObj->m_AttackDamageMaxRight * ZtConfig.CommonServer.Ringstrength / 100;
		lpObj->m_AttackDamageMinLeft += lpObj->m_AttackDamageMinLeft * ZtConfig.CommonServer.Ringstrength / 100;
		lpObj->m_AttackDamageMaxLeft += lpObj->m_AttackDamageMaxLeft * ZtConfig.CommonServer.Ringstrength / 100;
		lpObj->m_MagicDamageMin += lpObj->m_MagicDamageMin * ZtConfig.CommonServer.Ringstrength / 100;
		lpObj->m_MagicDamageMax += lpObj->m_MagicDamageMax * ZtConfig.CommonServer.Ringstrength / 100;
		lpObj->m_AttackSpeed += ZtConfig.CommonServer.Ringstrength;
		lpObj->m_MagicSpeed += ZtConfig.CommonServer.Ringstrength;
		lpObj->m_ShowLag = 1;
	}
#endif
	...
	if ( lpObj->Class == CLASS_ELF )
	{
		//int SuccessfulBlocking = GetPrivateProfileInt("Fairy_Elf","SuccessfulBlocking",4,"..\\Data\\ZtData\\Character.ini");
		lpObj->m_SuccessfulBlocking = Dexterity / ZtConfig.Character.ELFSuccessfulBlocking;	// 4
	}
	else if ( lpObj->Class == CLASS_DARKLORD )
	{
		//int SuccessfulBlocking = GetPrivateProfileInt("Dark_Lord","SuccessfulBlocking",7,"..\\Data\\ZtData\\Character.ini");
		lpObj->m_SuccessfulBlocking = Dexterity / ZtConfig.Character.DLSuccessfulBlocking;	// 7
	}
	else if ( lpObj->Class == CLASS_SUMMONER ) //Not much but its alot
	{
		//int SuccessfulBlocking = GetPrivateProfileInt("Summoner","SuccessfulBlocking",4,"..\\Data\\ZtData\\Character.ini");
		lpObj->m_SuccessfulBlocking = Dexterity / ZtConfig.Character.SUMSuccessfulBlocking;	 // 4
	}
	else if ( lpObj->Class == CLASS_WIZARD )
	{
		//int SuccessfulBlocking = GetPrivateProfileInt("Dark_Wizard","SuccessfulBlocking",3,"..\\Data\\ZtData\\Character.ini");
		lpObj->m_SuccessfulBlocking = Dexterity / ZtConfig.Character.DWSuccessfulBlocking;	 // 3
	}
	else if ( lpObj->Class == CLASS_KNIGHT )
	{
		//int SuccessfulBlocking = GetPrivateProfileInt("Dark_Knight","SuccessfulBlocking",3,"..\\Data\\ZtData\\Character.ini");
		lpObj->m_SuccessfulBlocking = Dexterity / ZtConfig.Character.DKSuccessfulBlocking;	 // 3
	}
	else if ( lpObj->Class == CLASS_MAGUMSA )
	{
		//int SuccessfulBlocking = GetPrivateProfileInt("Magic_Gladiator","SuccessfulBlocking",3,"..\\Data\\ZtData\\Character.ini");
		lpObj->m_SuccessfulBlocking = Dexterity / ZtConfig.Character.MGSuccessfulBlocking;	 // 3
	}
#ifdef MONK
	else if( lpObj->Class == CLASS_MONK )
	{
		lpObj->m_SuccessfulBlocking = Dexterity / ZtConfig.Character.RFSuccessfulBlocking;
	}
#endif
	else
	{
	...
	if ( lpObj->Class == CLASS_ELF )
	{
		//int Defense = GetPrivateProfileInt("Fairy_Elf","Defense",10,"..\\Data\\ZtData\\Character.ini");
		lpObj->m_Defense = Dexterity / ZtConfig.Character.ELFDefense;
	}
	else if ( lpObj->Class == CLASS_KNIGHT )
	{
		//int Defense = GetPrivateProfileInt("Dark_Knight","Defense",3,"..\\Data\\ZtData\\Character.ini");
		lpObj->m_Defense = Dexterity / ZtConfig.Character.DKDefense;
	}
	else if ( lpObj->Class == CLASS_DARKLORD )
	{
		//int Defense = GetPrivateProfileInt("Dark_Lord","Defense",7,"..\\Data\\ZtData\\Character.ini");
		lpObj->m_Defense = Dexterity / ZtConfig.Character.DLDefense;
	}
	else if ( lpObj->Class == CLASS_SUMMONER ) //strong like BK
	{
		//int Defense = GetPrivateProfileInt("Summoner","Defense",3,"..\\Data\\ZtData\\Character.ini");
		lpObj->m_Defense = Dexterity / ZtConfig.Character.SUMDefense;
	}
	else if ( lpObj->Class == CLASS_MAGUMSA ) //MG
	{
		//int Defense = GetPrivateProfileInt("Magic_Gladiator","Defense",4,"..\\Data\\ZtData\\Character.ini");
		lpObj->m_Defense = Dexterity / ZtConfig.Character.MGDefense;
	}
	else if ( lpObj->Class == CLASS_WIZARD ) //DW
	{
		//int Defense = GetPrivateProfileInt("Dark_Wizard","Defense",4,"..\\Data\\ZtData\\Character.ini");
		lpObj->m_Defense = Dexterity / ZtConfig.Character.DWDefense;
	}
#ifdef MONK
	else if( lpObj->Class == CLASS_MONK )
	{
		lpObj->m_Defense = Dexterity / ZtConfig.Character.RFDefense;
	}
#endif
	else
	{
	...
	if ( lpObj->pInventory[8].IsItem() != FALSE )
	{
		if ( lpObj->pInventory[8].m_Type == ITEMGET(13,37) && lpObj->pInventory[8].m_Durability > 0.0f ) // Golden Fenrir (Season 2.5 add-on)
		{
			if ( lpObj->pInventory[8].IsFenrirSpecial() != FALSE )
			{
				...
				{
					lpObj->AddLife += ZtConfig.PrideMu.AddLife; 
					lpObj->AddMana += ZtConfig.PrideMu.AddMana; 


					lpObj->m_AttackDamageMinRight += ZtConfig.PrideMu.AttackDamageMin;
					lpObj->m_AttackDamageMaxRight += ZtConfig.PrideMu.AttackDamageMax;

					lpObj->m_AttackDamageMinLeft += ZtConfig.PrideMu.AttackDamageMin;
					lpObj->m_AttackDamageMaxLeft += ZtConfig.PrideMu.AttackDamageMax;

					lpObj->m_MagicDamageMax += ZtConfig.PrideMu.MagicDamageMax;
					lpObj->m_MagicDamageMin += ZtConfig.PrideMu.MagicDamageMin;
				}
#endif
			}
				...
				g_ZtLicense.CheckUser(eZtUB::ulasevich) || g_ZtLicense.CheckUser(eZtUB::ulasevich2))
			{
				...
				{
					lpObj->m_AttackDamageMinRight += ( lpObj->m_AttackDamageMinRight * ZtConfig.Pet.BlackFenrirProcDamage ) / 100; 
					lpObj->m_AttackDamageMaxRight += ( lpObj->m_AttackDamageMaxRight * ZtConfig.Pet.BlackFenrirProcDamage ) / 100; 
					lpObj->m_AttackDamageMinLeft += ( lpObj->m_AttackDamageMinLeft * ZtConfig.Pet.BlackFenrirProcDamage ) / 100; 
					lpObj->m_AttackDamageMaxLeft += ( lpObj->m_AttackDamageMaxLeft * ZtConfig.Pet.BlackFenrirProcDamage ) / 100; 
					lpObj->m_MagicDamageMax += ( lpObj->m_MagicDamageMax * ZtConfig.Pet.BlackFenrirProcDamage ) / 100; 
					lpObj->m_MagicDamageMin += ( lpObj->m_MagicDamageMin * ZtConfig.Pet.BlackFenrirProcDamage ) / 100; 
					lpObj->DamageMinus += ZtConfig.Pet.BlackFenrirProcAbsurd;
					lpObj->AddLife += ( lpObj->MaxLife * ZtConfig.Pet.BlackFenrirProcLife ) / 100; 
				}
				else if ( lpObj->pInventory[8].IsFenrirDecLastAttackDamage() != FALSE )	// Blue Fenrir
				{
					lpObj->m_AttackDamageMinRight += ( lpObj->m_AttackDamageMinRight * ZtConfig.Pet.BlueFenrirProcDamage ) / 100; 
					lpObj->m_AttackDamageMaxRight += ( lpObj->m_AttackDamageMaxRight * ZtConfig.Pet.BlueFenrirProcDamage ) / 100; 
					lpObj->m_AttackDamageMinLeft += ( lpObj->m_AttackDamageMinLeft * ZtConfig.Pet.BlueFenrirProcDamage ) / 100; 
					lpObj->m_AttackDamageMaxLeft += ( lpObj->m_AttackDamageMaxLeft * ZtConfig.Pet.BlueFenrirProcDamage ) / 100; 
					lpObj->m_MagicDamageMax += ( lpObj->m_MagicDamageMax * ZtConfig.Pet.BlueFenrirProcDamage ) / 100; 
					lpObj->m_MagicDamageMin += ( lpObj->m_MagicDamageMin * ZtConfig.Pet.BlueFenrirProcDamage ) / 100; 
					lpObj->DamageMinus += ZtConfig.Pet.BlueFenrirProcAbsurd;
					lpObj->AddLife += ( lpObj->MaxLife * ZtConfig.Pet.BlueFenrirProcLife ) / 100; 				 
				}
				else if ( lpObj->pInventory[8].IsFenrirSpecial() != FALSE )	// Illusion Fenrir
				{
					lpObj->m_AttackDamageMinRight += ( lpObj->m_AttackDamageMinRight * ZtConfig.Pet.GoldFenrirProcDamage ) / 100; 
					lpObj->m_AttackDamageMaxRight += ( lpObj->m_AttackDamageMaxRight * ZtConfig.Pet.GoldFenrirProcDamage ) / 100; 
					lpObj->m_AttackDamageMinLeft += ( lpObj->m_AttackDamageMinLeft * ZtConfig.Pet.GoldFenrirProcDamage ) / 100; 
					lpObj->m_AttackDamageMaxLeft += ( lpObj->m_AttackDamageMaxLeft * ZtConfig.Pet.GoldFenrirProcDamage ) / 100; 
					lpObj->m_MagicDamageMax += ( lpObj->m_MagicDamageMax * ZtConfig.Pet.GoldFenrirProcDamage ) / 100; 
					lpObj->m_MagicDamageMin += ( lpObj->m_MagicDamageMin * ZtConfig.Pet.GoldFenrirProcDamage ) / 100; 
					lpObj->DamageMinus += ZtConfig.Pet.GoldFenrirProcAbsurd;
					lpObj->AddLife += ( lpObj->MaxLife * ZtConfig.Pet.GoldFenrirProcLife ) / 100; 				
				}
				else	//red 
				{
					lpObj->m_AttackDamageMinRight += ( lpObj->m_AttackDamageMinRight * ZtConfig.Pet.RedFenrirProcDamage ) / 100; 
					lpObj->m_AttackDamageMaxRight += ( lpObj->m_AttackDamageMaxRight * ZtConfig.Pet.RedFenrirProcDamage ) / 100; 
					lpObj->m_AttackDamageMinLeft += ( lpObj->m_AttackDamageMinLeft * ZtConfig.Pet.RedFenrirProcDamage ) / 100; 
					lpObj->m_AttackDamageMaxLeft += ( lpObj->m_AttackDamageMaxLeft * ZtConfig.Pet.RedFenrirProcDamage ) / 100; 
					lpObj->m_MagicDamageMax += ( lpObj->m_MagicDamageMax * ZtConfig.Pet.RedFenrirProcDamage ) / 100; 
					lpObj->m_MagicDamageMin += ( lpObj->m_MagicDamageMin * ZtConfig.Pet.RedFenrirProcDamage ) / 100; 
					lpObj->DamageMinus += ZtConfig.Pet.RedFenrirProcAbsurd;
					lpObj->AddLife += ( lpObj->MaxLife * ZtConfig.Pet.RedFenrirProcLife ) / 100; 
				}
	...
	{
		//int Zt_PandaRingAttack = GetPrivateProfileInt("PandaRing","AttackDamage",30,"..\\Data\\ZtData\\Pets.ini");
		//int Zt_PandaRingAttack = ZtConfig.Pet.Zt_PandaRingAttack;
		lpObj->m_AttackDamageMaxLeft += ZtConfig.Pet.Zt_PandaRingAttack;
		lpObj->m_AttackDamageMinLeft += ZtConfig.Pet.Zt_PandaRingAttack;
		lpObj->m_AttackDamageMaxRight += ZtConfig.Pet.Zt_PandaRingAttack;
		lpObj->m_AttackDamageMinRight += ZtConfig.Pet.Zt_PandaRingAttack;
		lpObj->m_MagicDamageMin += ZtConfig.Pet.Zt_PandaRingAttack;
		lpObj->m_MagicDamageMax += ZtConfig.Pet.Zt_PandaRingAttack;
	}
	...
	{
		//int Zt_PandaDef = GetPrivateProfileInt("Panda","Defense",50,"..\\Data\\ZtData\\Pets.ini");
		lpObj->m_Defense += ZtConfig.Pet.Zt_PandaDef;
	}
	...
	g_PremiumSystemZt.UserCalculatorPlus(aIndex);
#endif
	...
	if(g_ZtLicense.user.WinQuest) gWinQuestSystem.CharOptions(aIndex);
	...
	{
		int AddProcentDamage = ZtConfig.CommonServer.m_NoobDamage;
		...
		int AddProcentDefence = ZtConfig.CommonServer.m_NoobDefence;
	...
	{
		int AddProcentDamage = ZtConfig.m_iNewBuffPremiumDamage;
		...
		int AddProcentDefence = ZtConfig.m_iNewBuffPremiumDefence;
	...
	{
		int AddProcentDamage = ZtConfig.m_iNewBuffGuildDamage;
		...
		int AddProcentDefence = ZtConfig.m_iNewBuffGuildDefence;
	...
	{
		int AddProcentDamage = ZtConfig.m_iNewBuffPartyDamage;
		...
		int AddProcentDefence = ZtConfig.m_iNewBuffPartyDefence;
