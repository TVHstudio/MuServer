...
void PartyBonus::Load()
{
	...
	this->Enable = GetPrivateProfileInt("ZtTeam","Enable",0,PartyBonus_DIR);
	
	this->nearbycount1	= GetPrivateProfileInt("ZtTeam","nearbycount1",100,PartyBonus_DIR);
	this->nearbycount2	= GetPrivateProfileInt("ZtTeam","nearbycount2",100,PartyBonus_DIR);
	this->nearbycount3  = GetPrivateProfileInt("ZtTeam","nearbycount3",100,PartyBonus_DIR);
	this->nearbycount4  = GetPrivateProfileInt("ZtTeam","nearbycount4",100,PartyBonus_DIR);
	this->nearbycount5	= GetPrivateProfileInt("ZtTeam","nearbycount5",100,PartyBonus_DIR);
