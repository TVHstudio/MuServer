...
struct PMSG_ANS_PERIODITEMZT_INSERT
{
	PBMSG_HEAD2 head;
	DWORD dwUserGuid;
	WORD wUserIndex;
...
struct PMSG_REQ_PERIODITEMZT_INSERT
{
	PBMSG_HEAD2 head;
	DWORD dwUserGuid;
	WORD wUserIndex;
...
struct PMSG_ANS_PERIODITEMZT_DELETE
{
	PBMSG_HEAD2 head;
	DWORD dwUserGuid;
	WORD wUserIndex;
...
struct PMSG_REQ_PERIODITEMZT_DELETE
{
	PBMSG_HEAD2 head;
	DWORD dwUserGuid;
	WORD wUserIndex;
...
struct PMSG_ANS_PERIODITEMZT_LIST
{
	PBMSG_HEAD2 head;
	DWORD dwUserGuid;
	WORD wUserIndex;
...
struct PMSG_REQ_PERIODITEMZT_SELECT
{
	PBMSG_HEAD2 head;
	DWORD dwUserGuid;
	WORD wUserIndex;
...
struct PMSG_ANS_PERIODITEMZT_LIST_COUNT
{
	PBMSG_HEAD2 head;
	WORD wUserIndex;
	BYTE btResult;
...
struct PMSG_ANS_PERIODITEMZT_EXPIRED_ITEMLIST
{
	PBMSG_HEAD2 head;
	WORD wUserIndex;
...
struct PMSG_ANS_PERIODITEMZT_SELECT
{
	PBMSG_HEAD2 head;
	DWORD dwUserGuid;
	WORD wUserIndex;
...
public:
	...
	void DGPeriodItemZtInsert(PMSG_ANS_PERIODITEMZT_INSERT* lpMsg);
	void DGPeriodItemZtDelete(PMSG_ANS_PERIODITEMZT_DELETE* lpMsg);
	void DGPeriodItemZtSelect(PMSG_ANS_PERIODITEMZT_SELECT* lpMsg);
	void DGPeriodItemZtExpiredItemList(PMSG_ANS_PERIODITEMZT_EXPIRED_ITEMLIST * lpMsg);
	void DGPeriodItemZtListCount(PMSG_ANS_PERIODITEMZT_LIST_COUNT* lpMsg);
	void DGPeriodItemZtList(PMSG_ANS_PERIODITEMZT_LIST* lpMsg);
...
extern CPeriodItemZt g_PeriodItemZt;
