...
class CProbabilityItemBagAttrZt : public CItemBagAttrZt
{
public:
	CProbabilityItemBagAttrZt() //season 4.5 changed
	{
...
private:
	...
	CProbabilityItemBagAttrZt BagObject[MAX_PROBABILITY_ITEMBAG_ATTR];	// 1CF
	int m_iEventItemDropRateZt[20];	// 680
