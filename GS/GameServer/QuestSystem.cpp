...
void NewS5Quest::ElfMonsterKillProc(LPOBJ lpObj, LPOBJ lpTargetObj)	//lpTargetObj - то?кт?убил
{
...
void NewS5Quest::GensMonsterKillProc(LPOBJ lpObj, LPOBJ lpTargetObj)	//lpTargetObj - то?кт?убил
{
