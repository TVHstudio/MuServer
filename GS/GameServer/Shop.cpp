...
BOOL ShopDataLoad() //Season 3.0 identical Season 2.5 identical gs-cs 56
{
	...
	if(g_ZtLicense.CheckUser(eZtUB::MedoniAndrei) || 
		g_ZtLicense.CheckUser(eZtUB::absolute) || 
		g_ZtLicense.CheckUser(eZtUB::MU2Play) || 
		g_ZtLicense.CheckUser(eZtUB::Local) ||
		g_ZtLicense.CheckUser(eZtUB::Stone) || g_ZtLicense.CheckUser(eZtUB::Sentinel) || g_ZtLicense.CheckUser(eZtUB::Artem) ||
		THINNAKORN_MAC == 1 ||
		...
		g_ZtLicense.CheckUser(eZtUB::TGBA_LLC) ||
	...
	{
		ShopC[20].LoadShopItemEx(gDirPath.GetNewPath("ZtData\\Donate\\00_DonateShop.txt"));
		ShopC[21].LoadShopItemEx(gDirPath.GetNewPath("ZtData\\Donate\\01_DonateShop.txt"));
		ShopC[22].LoadShopItemEx(gDirPath.GetNewPath("ZtData\\Donate\\02_DonateShop.txt"));
		ShopC[23].LoadShopItemEx(gDirPath.GetNewPath("ZtData\\Donate\\03_DonateShop.txt"));
		ShopC[24].LoadShopItemEx(gDirPath.GetNewPath("ZtData\\Donate\\04_DonateShop.txt"));
		ShopC[25].LoadShopItemEx(gDirPath.GetNewPath("ZtData\\Donate\\05_DonateShop.txt"));
		ShopC[26].LoadShopItemEx(gDirPath.GetNewPath("ZtData\\Donate\\06_DonateShop.txt"));
		ShopC[27].LoadShopItemEx(gDirPath.GetNewPath("ZtData\\Donate\\07_DonateShop.txt"));
		ShopC[28].LoadShopItemEx(gDirPath.GetNewPath("ZtData\\Donate\\08_DonateShop.txt"));
		ShopC[29].LoadShopItemEx(gDirPath.GetNewPath("ZtData\\Donate\\09_DonateShop.txt"));
		ShopC[30].LoadShopItemEx(gDirPath.GetNewPath("ZtData\\Donate\\10_DonateShop.txt"));
		ShopC[31].LoadShopItemEx(gDirPath.GetNewPath("ZtData\\Donate\\11_DonateShop.txt"));
		ShopC[32].LoadShopItemEx(gDirPath.GetNewPath("ZtData\\Donate\\12_DonateShop.txt"));
		ShopC[33].LoadShopItemEx(gDirPath.GetNewPath("ZtData\\Donate\\13_DonateShop.txt"));
		ShopC[34].LoadShopItemEx(gDirPath.GetNewPath("ZtData\\Donate\\14_DonateShop.txt"));
		ShopC[35].LoadShopItemEx(gDirPath.GetNewPath("ZtData\\Donate\\15_DonateShop.txt"));
		ShopC[36].LoadShopItemEx(gDirPath.GetNewPath("ZtData\\Donate\\16_DonateShop.txt"));
		ShopC[37].LoadShopItemEx(gDirPath.GetNewPath("ZtData\\Donate\\17_DonateShop.txt"));
		ShopC[38].LoadShopItemEx(gDirPath.GetNewPath("ZtData\\Donate\\18_DonateShop.txt"));
		ShopC[39].LoadShopItemEx(gDirPath.GetNewPath("ZtData\\Donate\\19_DonateShop.txt"));
		ShopC[40].LoadShopItemEx(gDirPath.GetNewPath("ZtData\\Donate\\20_DonateShop.txt"));
		ShopC[41].LoadShopItemEx(gDirPath.GetNewPath("ZtData\\Donate\\21_DonateShop.txt"));
		ShopC[42].LoadShopItemEx(gDirPath.GetNewPath("ZtData\\Donate\\22_DonateShop.txt"));
		ShopC[43].LoadShopItemEx(gDirPath.GetNewPath("ZtData\\Donate\\23_DonateShop.txt"));
		ShopC[44].LoadShopItemEx(gDirPath.GetNewPath("ZtData\\Donate\\24_DonateShop.txt"));
		ShopC[45].LoadShopItemEx(gDirPath.GetNewPath("ZtData\\Donate\\25_DonateShop.txt"));
	}
#endif
...
bool CShop::CheckBuyItemEx(int aIndex, int ItemPos, int &iStoreTaxMoney)
{
	...
	for(int i=0; i<this->ItemCount; i++)
	{
		...
		if(this->ShopEx[i].PayType == ePriceZen)
		{
			...
			{
				sprintf_s(szBuff,g_ZtText.GetText(231),iStoreTaxMoney);
		...
		else if(this->ShopEx[i].PayType == ePriceBonus)
		{
			...
			{
				sprintf_s(szBuff,g_ZtText.GetText(232),this->ShopEx[i].PayPrice);
				GCServerMsgStringSend(szBuff, lpUser->m_Index, 1);
				return false;
			}
		...
		else if(this->ShopEx[i].PayType == ePriceCredit)
		{
			...
			{
				if(this->ShopEx[i].PayPrice > lpUser->ZtCred)
				{
					sprintf_s(szBuff,g_ZtText.GetText(233),this->ShopEx[i].PayPrice);
					GCServerMsgStringSend(szBuff, lpUser->m_Index, 1);
					return false;
				}
				//lpUser->Credits -= this->ShopEx[i].PayPrice;
...
bool CShop::BuyItemEx(int aIndex, int ItemPos)
{
	...
	for(int i=0; i<this->ItemCount; i++)
	{
		...
		if(this->ShopEx[i].PayType == ePriceZen)
		{
			...
			{
				sprintf_s(szBuff,g_ZtText.GetText(234),this->ShopEx[i].PayPrice);
				GCServerMsgStringSend(szBuff, lpUser->m_Index, 1);
				return false;
			}
		...
		else if(this->ShopEx[i].PayType == ePriceBonus)
		{
			if(this->ShopEx[i].PayPrice > lpUser->GameShop.WCoinC)
			{
				sprintf_s(szBuff,g_ZtText.GetText(235),this->ShopEx[i].PayPrice);
				GCServerMsgStringSend(szBuff, lpUser->m_Index, 1);
				return false;
			}
			lpUser->GameShop.WCoinC -= this->ShopEx[i].PayPrice;
			sprintf_s(szBuff,g_ZtText.GetText(236),(int)lpUser->GameShop.WCoinC);
			GCServerMsgStringSend(szBuff, lpUser->m_Index, 1);
		...
		else if(this->ShopEx[i].PayType == ePriceCredit)
		{
			if(g_ZtLicense.CheckUser(eZtUB::NSGames))
			{
				...
				sprintf_s(szBuff,"[Buy] %d NSPoint",(int)lpUser->ZtCred);
				GCServerMsgStringSend(szBuff, lpUser->m_Index, 1);
				ZtUserDataSend(aIndex);
				#if(CREDIT_DONATE_LOG==TRUE)
				int iType = ITEMGET(this->ShopEx[i].ItemType, this->ShopEx[i].ItemIndex);
			...
			else
			{
				if(this->ShopEx[i].PayPrice > lpUser->ZtCred)
				{
					sprintf_s(szBuff,g_ZtText.GetText(237),this->ShopEx[i].PayPrice);
					GCServerMsgStringSend(szBuff, lpUser->m_Index, 1);
					return false;
				}
				lpUser->ZtCred -= this->ShopEx[i].PayPrice;
				...
				sprintf_s(szBuff,g_ZtText.GetText(238),(int)lpUser->ZtCred);
				GCServerMsgStringSend(szBuff, lpUser->m_Index, 1);
				ZtUserDataSend(aIndex);
				#if(CREDIT_DONATE_LOG==TRUE)
				int iType = ITEMGET(this->ShopEx[i].ItemType, this->ShopEx[i].ItemIndex);
...
void NewShopRecv(CG_NEW_CASH_SHOP* Recv, int aIndex)
{
	...
	if(g_ZtUser.InSafeZone(aIndex) == false)
	{
		return;
	}
