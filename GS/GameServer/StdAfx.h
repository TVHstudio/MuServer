...
#define ZTLICENSE_SELECT		1
#define ZTLICENSE_CUSTOM		0
#define ENABLE_DEBUG			0
#define ZTLICENSE_SERVER		0
#define ENABLE_HIDEWINDOW		0
#define ENABLE_DEV				0
#define ENABLE_FIX				1
#define CUSTOM_LIBRARY			0
#define ENABLE_GAMESERVER_DLL	1
// -------------------------------------------------------------------------------
...
#include <set>
#include <atltime.h>
#include <afx.h>//整个GS只需要一个 atl::ctime类他把整个afx导入了
#include <rpcdce.h>
...
#define CUSTOM_MONSTER_ZT		TRUE	//Расширитель настройки монстров
...
#define CUSTOM_ZT_TELEPORT_EVO	1
...
#define CUSTOM_ZT_QUEST_SYSTEM	1
...
#define ENABLE_AGMASTER			0
// -------------------------------------------------------------------------------
#define REFIX_DROPZEN			1			// << == 
#define BROTHER_PAYTELEPORT		1
// -------------------------------------------------------------------------------
// -> Date: Ultra coding 07-08.2019
// -------------------------------------------------------------------------------
#define ENABLE_MAPRULES			0	//Evomu
#define ENABLE_MAP_RULE			1	//Evomu
#define ENABLE_PVP_RULE			1
#define FIX_MG_WIZDMG			1
#define BR_TELEPORT_TIME		1
// -------------------------------------------------------------------------------
#define CHECK_MONSTERBUG		1
// -------------------------------------------------------------------------------
#define NEW_UPDATE_1019			1
#define UPDATE_GLOBALMU			1
// -------------------------------------------------------------------------------
#define CUSTOM_MAP_TELEPORT		1
#define CUSTOM_VALUE_MENU		1	//need dev
#define FIX_SELUPAN_REGEN		1
#define UPDATE_DEDMAKAR			1
#define FIX_VIEWE_MONSTER		0
#define FIX_MEDUSA_REGEN		1
#define DEV_PROTOCOL			0
#define CUSTOM_CAMERA_MOVE		1
#define FIX_OBJECT_VIEWE		0
//005AF1CD
#define PET_FENRIR_FIX			0
#define ENABLE_MOVE_DIS			0
#define	_ANTIHACK_				0
...
// -------------------------------------------------------------------------------
#define ENABLE_VOTER_ANONS		1	//25%
#define ENABLE_MULTI_CHAR		0	//20%

#define DEV_PACKET_ITEM			0
#define DEV_ITEM_LEVEL			0
#define DEV_MAX_BUFF_32			0
 
#define ENABLE_CHARLVL1000		1
#define ENABLE_GRAND_CREDIT		1
#define ENABLE_NSGAME_UPDATE	1

//26.05.2020
#define ENABLE_UPDATEVERSION	1
#define ENABLE_GRAND_NEEDITEM	1
//28.05.2020
#define ENABLE_PACK_MANAGER		1
//Click Derecho
#define MOVE_ITEM				0
#define WAITENI_CUSTOM			1
// ----------------------------------------------------------------------------------------------
#define ZTTEAM_GAMECLIENT_DEV	0
// ----------------------------------------------------------------------------------------------
#define ENABLE_INDEV_NETWORK	0
#define ENABLE_CAMERA_PARTY		1
#define ENABLE_FIX_MINIWINGS	1
