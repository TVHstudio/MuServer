...
{
	//this->Enable = g_ZtLicense.user.Rage;
	...
	g_ZtLicense.user.Rage = this->Enable;
}
...
void cSystemOfRage::FilterSkill(int aIndex, int SkillID)
{
	...
	//	lpObj->ZtFreePoints += this->rSkill[eSkill2].StartDamage;
	//}
	////Fix Debug
	////Strength
	//if(SkillID == eSkill13)
...
void cSystemOfRage::CGRageReset(int aIndex, PMSG_ANS_RESETRAGE* lpMsg)
{
	...
	{
		if(this->m_ResetRageCredit > lpUser->ZtCred)
		{
			return;
		}
		lpUser->ZtCred -= this->m_ResetRageCredit;
	}
