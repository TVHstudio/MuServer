...
void TeleportShop::Load()
{
	...
	//if( g_ZtLicense.CheckUser(feqan) == false)
	//{
	//	return;
	//}

	this->Enable = GetPrivateProfileInt("ZtTeam","Enable",0,TELEPORT_SHOP_DIR);
	this->EventTime = GetPrivateProfileInt("ZtTeam","EventTime",0,TELEPORT_SHOP_DIR) * 60;
	this->Teleport_NPC = GetPrivateProfileInt("ZtTeam","Teleport_NPC",379,TELEPORT_SHOP_DIR);
	this->Teleport_Map = GetPrivateProfileInt("ZtTeam","Teleport_Map",0,TELEPORT_SHOP_DIR);
	this->Teleport_X = GetPrivateProfileInt("ZtTeam","Teleport_X",0,TELEPORT_SHOP_DIR);
	this->Teleport_Y = GetPrivateProfileInt("ZtTeam","Teleport_Y",0,TELEPORT_SHOP_DIR);

	GetPrivateProfileString("ZtTeam", "MessageStart","MessageStart",this->MessageStart,100,TELEPORT_SHOP_DIR);
	GetPrivateProfileString("ZtTeam", "MessageEnd","MessageEnd",this->MessageEnd,100,TELEPORT_SHOP_DIR);
