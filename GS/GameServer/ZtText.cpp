...
{
	this->Init();
	this->Read(gDirPath.GetNewPath("ZtData\\ZtTextS.dat"));
	this->LoadText();
}
...
void CZtText::LoadText()
{
	...
	this->SetText(261, "[Need ZtCred]: %d");
...
void CZtText::SetText(int number, char* Text)
{
	...
	GetPrivateProfileString("ZtTeam", szTextNumber, Text, this->m_Text[number], 128, this->m_Path);
}
