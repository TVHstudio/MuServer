...
//	g_ServerInfoDisplayer.SetState(TRUE,gSObj[aIndex].SType);
	...
	else if( hdrid->messageID == 1 )
	{
		...
		{
		case 0x100:
			SGAnsCashPointEx(aIndex,(protocol::MSG_GTOS_USER_CASH_REQ_ZT *)aRecv);
			break;
		case 0x300:
			SGAndCashItemListEx(aIndex,(protocol::MSG_GTOS_ITEM_LIST_REQ_ZT *)aRecv);
			break;
		case 0x500:
			SGAnsCashItemUseEx(aIndex,(protocol::MSG_GTOS_ITEM_USE_REQ_ZT *)aRecv);
			break;
		case 0x700:
			SGAndCashGiftListEx(aIndex,(protocol::MSG_GTOS_GIFT_LIST_REQ_ZT *)aRecv);
			break;
		case 0x900:
			SGAnsBuyCashItemEx(aIndex,(protocol::MSG_GTOS_BUY_ITEM_REQ_ZT *)aRecv);
			break;
		case 0xB00:
			SGAnsUseCashItemNotifyEx(aIndex,(protocol::MSG_GTOS_USE_ITEM_NTF_ZT *)aRecv);
			break;
		case 0xD00:
			SGAnsGiftCashItemEx(aIndex,(protocol::MSG_GTOS_GIFT_ITEM_REQ_ZT *)aRecv);
			break;
		case 0xF00:
			SGUpdatePointInfo(aIndex,(protocol::MSG_GTOS_UPDATE_POINT_ZT *)aRecv);
			break;
		}
	}
...
{
	char szQuery[256];
	protocol::MSG_STOG_USER_CASH_ANS_ZT pMsg;
...
void SGAnsBuyCashItemEx(int aIndex,protocol::MSG_GTOS_BUY_ITEM_REQ_ZT *lpMsg)
{
	char szQuery[512];
	protocol::MSG_STOG_BUY_ITEM_ANS_ZT pMsg;
...
void SGAndCashItemListEx(int aIndex,protocol::MSG_GTOS_ITEM_LIST_REQ_ZT *lpMsg)
{
	char szQuery[256];

	protocol::MSG_STOG_ITEM_LIST_ANS_ZT pMsg;
...
void SGAnsCashItemUseEx(int aIndex,protocol::MSG_GTOS_ITEM_USE_REQ_ZT * lpMsg)
{
	char szQuery[1024];
	protocol::MSG_STOG_ITEM_USE_ANS_ZT pMsg;
...
void SGAndCashGiftListEx(int aIndex,protocol::MSG_GTOS_GIFT_LIST_REQ_ZT * lpMsg)
{
	char szQuery[256];
	protocol::MSG_STOG_GIFT_LIST_ANS_ZT pMsg;
...
void SGAnsGiftCashItemEx(int aIndex,protocol::MSG_GTOS_GIFT_ITEM_REQ_ZT *lpMsg)
{
	char szQuery[512];
	protocol::MSG_STOG_GIFT_ITEM_ANS_ZT pMsg;
