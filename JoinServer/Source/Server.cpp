...
//	bIsLog = GetPrivateProfileInt(INI_SECTION,"WriteLog",FALSE,INI_FILE);
...
#if(ENABLE_ZTDATASERVER)
	if(GetPrivateProfileInt(ZTDS_INISECTION,"Enabled",FALSE,INI_FILE) == TRUE)
	{
#if(ENABLE_NEW_WINDOW)
		ZtDBEnable = true;
#endif
	...
	if(JoinEnable)
	{
		g_WindowZt.UpdateStatusBar(0, "Join Server: Online");
	}
	else
	{
		g_WindowZt.UpdateStatusBar(0, "Join Server: Offline");
	}

	//if(DataEnable)
	//{
	//	g_WindowZt.UpdateStatusBar(1, "Data Server");
	//}
	//else
	//{
	//	g_WindowZt.UpdateStatusBar(1, "Data Server");
	...
	//if(Data2Enable)
	//{
	//	g_WindowZt.UpdateStatusBar(2, "Data Server 2");
	//}
	//else
	//{
	//	g_WindowZt.UpdateStatusBar(2, "Data Server 2");
	...
	if(ZtDBEnable)
	{
		g_WindowZt.UpdateStatusBar(1, "ZtDB Server: Online");
	}
	else
	{
		g_WindowZt.UpdateStatusBar(1, "ZtDB Server: Offline");
	}

	if(RankingEnable)
	{
		g_WindowZt.UpdateStatusBar(2, "Rank Server: Online");
	}
	else
	{
		g_WindowZt.UpdateStatusBar(2, "Rank Server: Offline");
	}

	if(EventEnable)
	{
		g_WindowZt.UpdateStatusBar(3, "Event Server: Online");
	}
	else
	{
		g_WindowZt.UpdateStatusBar(3, "Event Server: Offline");
	}

	//if(CashEnable)
	//{
	//	g_WindowZt.UpdateStatusBar(6, "Cash Shop");
	//}
	//else
	//{
	//	g_WindowZt.UpdateStatusBar(6, "Cash Shop");
