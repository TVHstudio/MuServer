...
#if(ENABLE_ZTDATASERVER)
#define ZTDS_INISECTION		"ZtDataServer"
#endif
...
extern ZTDS_INFO g_ZtDSInfo;
extern CQuery g_ZtDataServerDB;
...
struct ZTSDHP_UNION_RELATIONSHIP_LIST
{
	PWMSG_HEAD h;	//	
...
struct ZTSDHP_NOTIFICATION_RELATIONSHIP
{
	PWMSG_HEAD h;	//	
	unsigned char btFlag;	//	4
...
struct ZTSDHP_SERVERGROUP_GUILD_CHATTING_RECV
{
	PBMSG_HEAD h;	//	
	int iGuildNum;	//	4
...
struct ZTSDHP_SERVERGROUP_UNION_CHATTING_RECV
{
	PBMSG_HEAD h;	//	
	int iUnionNum;	//	4
	char szCharacterName[10];	//	8
...
struct ZTSDHP_GUILD_ASSIGN_STATUS_REQ
{
	PBMSG_HEAD h;
	WORD wUserIndex;	// 4
	BYTE btType;	// 6
...
struct ZTSDHP_GUILD_ASSIGN_STATUS_RESULT
{
	PBMSG_HEAD h;	//	
...
struct ZTSDHP_GUILD_ASSIGN_TYPE_REQ
{
	PBMSG_HEAD h;
	WORD wUserIndex;	// 4
	BYTE btGuildType;	// 6;
...
struct ZTSDHP_GUILD_ASSIGN_TYPE_RESULT
{
	PBMSG_HEAD h;	//	
	unsigned char btFlag;	//	3
	unsigned short wUserIndex;	//	4
...
struct ZTSDHP_RELATIONSHIP_JOIN_REQ 
{
...
struct ZTSDHP_RELATIONSHIP_JOIN_RESULT
{
	PBMSG_HEAD h;	//	
	unsigned char btFlag;	//	3
...
struct ZTSDHP_RELATIONSHIP_BREAKOFF_REQ 
{
  /*<thisrel this+0x0>*/ /*|0x3|*/ PBMSG_HEAD h;
  /*<thisrel this+0x4>*/ /*|0x2|*/ unsigned short wRequestUserIndex;
  /*<thisrel this+0x6>*/ /*|0x2|*/ unsigned short wTargetUserIndex;
...
struct ZTSDHP_RELATIONSHIP_BREAKOFF_RESULT
{
	PBMSG_HEAD h;	//	
	unsigned char btFlag;	//	3
	unsigned short wRequestUserIndex;	//	4
...
struct ZTSDHP_UNION_LIST_COUNT 
{
...
struct ZTSDHP_KICKOUT_UNIONMEMBER_REQ 
{
...
struct ZTSDHP_KICKOUT_UNIONMEMBER_RESULT
{
	PBMSG_HEAD2 h;	//	
	unsigned char btFlag;	//	4
